...
(function(exports) {
  ...
  var ui = (function () {
      var render = function (state) {
          var value = Data_Either.either(Data_Show.show(Data_Show.showString))(Data_Show.show(Data_Show.showString))(state);
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Mkpasswd") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Current value: " + value) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Regenerate.create)) ])([ Halogen_HTML_Core.text("Generate new Password") ]) ]);
      };
      var initialState = new Data_Either.Left("No password generated yet");
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
          initialState: Data_Function["const"](initialState),
          render: render,
          "eval": function (v) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Mkpasswd.mkpasswd(Mkpasswd.defaultPolicy)))(function (v1) {
