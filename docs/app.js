...
(function(exports) {
  ...
  var genericRouteHash = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Main line 148, column 8 - line 148, column 56: " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var genericFieldType = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Main line 50, column 8 - line 50, column 56: " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
  ...
  var classes = function ($100) {
      return Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)($100));
  };
  var mkpasswdUi = (function () {
      var resultView = function (value) {
          var $48 = Data_String_CodePoints.length(value) > 0;
          if ($48) {
      ...
      var policyFormRow = function (feildType) {
          return function (labelTxt) {
              return function (currentValue) {
                  ...
                  return Halogen_HTML_Elements.div([ classes([ "flex-none", "clearfix" ]) ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"](inpIdStr), classes([ "col", "col-3", "right-align", "align-baseline", "label" ]) ])([ Halogen_HTML_Core.text(labelTxt) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.id_(inpIdStr), classes([ "col", "col-8", "input" ]), Halogen_HTML_Properties.value(currentValue), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(UpdatePolicy.create(feildType))) ]) ]);
              };
          };
      };
              ...
              return function (v) {
                  var newPolicy = (function () {
                      if (f instanceof PasswdLength) {
                          var $50 = {};
                          for (var $51 in s.policy) {
                              if ({}.hasOwnProperty.call(s.policy, $51)) {
                                  $50[$51] = s["policy"][$51];
                              };
                          };
                          $50.length = v;
                      ...
                      if (f instanceof DegitsNum) {
                          var $53 = {};
                          for (var $54 in s.policy) {
                              if ({}.hasOwnProperty.call(s.policy, $54)) {
                                  $53[$54] = s["policy"][$54];
                              };
                          };
                          $53.degit = v;
                      ...
                      if (f instanceof UppercaseNum) {
                          var $56 = {};
                          for (var $57 in s.policy) {
                              if ({}.hasOwnProperty.call(s.policy, $57)) {
                                  $56[$57] = s["policy"][$57];
                              };
                          };
                          $56.uppercase = v;
                      ...
                      if (f instanceof LowercaseNum) {
                          var $59 = {};
                          for (var $60 in s.policy) {
                              if ({}.hasOwnProperty.call(s.policy, $60)) {
                                  $59[$60] = s["policy"][$60];
                              };
                          };
                          $59.lowercase = v;
                      ...
                      if (f instanceof SymbolNum) {
                          var $62 = {};
                          for (var $63 in s.policy) {
                              if ({}.hasOwnProperty.call(s.policy, $63)) {
                                  $62[$63] = s["policy"][$63];
                              };
                          };
                          $62.symbol = v;
                      ...
                      throw new Error("Failed pattern match at Main line 135, column 21 - line 140, column 67: " + [ f.constructor.name ]);
                  })();
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Mkpasswd.mkpasswd(v1.policy)))(function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          ...
                          throw new Error("Failed pattern match at Main line 121, column 15 - line 123, column 65: " + [ v2.constructor.name ]);
                      })())(function () {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      if (newValue instanceof Data_Either.Left) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $84.errMsg = newValue.value0;
                              return $84;
                          });
                      };
                      throw new Error("Failed pattern match at Main line 129, column 19 - line 131, column 67: " + [ newValue.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value2);
                  });
              });
          };
          throw new Error("Failed pattern match at Main line 117, column 11 - line 117, column 87: " + [ v.constructor.name ]);
      };
      var errorView = function (error) {
          var $91 = Data_String_CodePoints.length(error) > 0;
          if ($91) {
  ...
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.main([ style("height: 100%"), classes([ "flex", "flex-column" ]) ])([ Halogen_HTML_Elements.nav([ classes([ "border", "flex-none", "flex", "justify-center" ]) ])([ Halogen_HTML_Elements.a([ classes([ "flex-auto", "border", "p1", "center" ]), Halogen_HTML_Properties.href("#link/a") ])([ Halogen_HTML_Core.text("\u3064\u304f\u308b") ]), Halogen_HTML_Elements.a([ classes([ "flex-auto", "border", "p1", "center" ]), Halogen_HTML_Properties.href("#link/b") ])([ Halogen_HTML_Core.text("\u3057\u307e\u3046") ]) ]), Halogen_HTML.slot(MkpasswdSlot.value)(mkpasswdUi)(Data_Unit.unit)(Data_Void.absurd) ]);
      };
      var initialState = {
          route: LinkA.value
      };
      var $$eval = function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.log(Data_Show.show(showRouteHash)(v.value0))))(function () {
  ...
  var main = (function () {
      ...
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(ui)(Data_Unit.unit)(v))(function (v1) {
              return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Routing_Hash.matches(menuHash)(function (v2) {
                  return function (newHash) {
                      return Effect_Aff.launchAff_(v1.query(Halogen_Query.action(ChangeHash.create(newHash))));
                  };
              }));
          });
      }));
