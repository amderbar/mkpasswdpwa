...
(function(exports) {
  ...
  exports["ui"] = ui;
})(PS["Mkpasswd.Component.List"] = PS["Mkpasswd.Component.List"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Data_Array = PS["Data.Array"];
...
(function(exports) {
  ...
  var defaultLength = 9;
  var addappend = function (a) {
      return function (b) {
          return Control_Biapply.biapply(Data_Tuple.biapplyTuple)(Control_Biapply.biapply(Data_Tuple.biapplyTuple)(Control_Biapplicative.bipure(Data_Tuple.biapplicativeTuple)(Data_Semiring.add(Data_Semiring.semiringInt))(Data_Semigroup.append(Data_Semigroup.semigroupArray)))(a))(b);
      };
  };
  var sumPolicy = function (polArr) {
      return Data_Foldable.foldl(Data_Foldable.foldableArray)(addappend)(passwdPolicy(0)([  ]))(polArr);
  };
  ...
  var mkpasswd = function (len) {
      return function (pol) {
          var multiChoice = function (n) {
              return function (arr) {
                  return Data_Traversable.sequence(Data_Traversable.traversableArray)(Effect.applicativeEffect)(Data_Array.replicate(n)(Mkpasswd_Effect_Random.choice(arr)));
              };
          };
          var mkpasscode = function (p) {
              return Control_Bind.bindFlipped(Effect.bindEffect)(Mkpasswd_Effect_Random.shuffle)(Data_Functor.map(Effect.functorEffect)(function ($0) {
                  return Data_Array.catMaybes(Control_Bind.join(Control_Bind.bindArray)($0));
              })(Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect.applicativeEffect)(Data_Tuple.uncurry(multiChoice))(p)));
          };
          var fromCharCodeArray = function ($1) {
              return Data_String_CodeUnits.fromCharArray(Data_Array.mapMaybe(Data_Char.fromCharCode)($1));
          };
          var policy = Mkpasswd_Data_PasswdPolicy.normalize(len)(pol);
          return Data_Functor.map(Effect.functorEffect)(fromCharCodeArray)(mkpasscode(policy));
      };
  };
...
(function(exports) {
  ...
  var modifyFst = function (f) {
      return function ($0) {
          return Data_Tuple.swap(modifySnd(f)(Data_Tuple.swap($0)));
      };
  };
...
(function(exports) {
  ...
  var genericFeildType = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Mkpasswd.Component.Store line 32, column 8 - line 32, column 56: " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
  ...
  var ui = (function () {
      ...
      var $$eval = function (v) {
          if (v instanceof UpdateAccount) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $28.form = (function () {
                          var $25 = {};
                          for (var $26 in v1.form) {
                              if ({}.hasOwnProperty.call(v1.form, $26)) {
                                  $25[$26] = v1["form"][$26];
                              };
                          };
                          $25.account = v.value0;
          ...
          if (v instanceof UpdatePasswd) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $37.form = (function () {
                          var $34 = {};
                          for (var $35 in v1.form) {
                              if ({}.hasOwnProperty.call(v1.form, $35)) {
                                  $34[$35] = v1["form"][$35];
                              };
                          };
                          $34.passwd = v.value0;
          ...
          if (v instanceof UpdateNote) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $46.form = (function () {
                          var $43 = {};
                          for (var $44 in v1.form) {
                              if ({}.hasOwnProperty.call(v1.form, $44)) {
                                  $43[$44] = v1["form"][$44];
                              };
                          };
                          $43.note = v.value0;
          ...
          if (v instanceof Save) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new SavePasswd(v1.form)))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
              });
          };
...
})(PS["Mkpasswd.Component.Store"] = PS["Mkpasswd.Component.Store"] || {});
...
(function(exports) {
  ...
  var save = function (dictWriteForeign) {
      return function (key) {
          return function (d) {
              return Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.sessionStorage))(Web_Storage_Storage.setItem(key)(Simple_JSON.writeJSON(dictWriteForeign)(d)));
          };
      };
  };
...
(function(exports) {
  ...
  var Halogen_Query = PS["Halogen.Query"];
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Mkpasswd_Component_List = PS["Mkpasswd.Component.List"];
  var Mkpasswd_Component_Mkpasswd = PS["Mkpasswd.Component.Mkpasswd"];
  var Mkpasswd_Component_Store = PS["Mkpasswd.Component.Store"];
  var Mkpasswd_Data_Array = PS["Mkpasswd.Data.Array"];
  var Mkpasswd_Data_States = PS["Mkpasswd.Data.States"];
      ...
      var render = function (state) {
          return Halogen_HTML_Elements.main([ Mkpasswd_Halogen_Util.style("height: 100%"), Mkpasswd_Halogen_Util.classes([ "flex", "flex-column" ]) ])([ headerNav, (function () {
              if (state.route instanceof Mkpasswd_Routing.Index) {
                  return Halogen_HTML["slot'"](cpMkpasswd)(Data_Unit.unit)(Mkpasswd_Component_Mkpasswd.ui)(Data_Unit.unit)(Data_Void.absurd);
              };
              if (state.route instanceof Mkpasswd_Routing.List) {
                  return Halogen_HTML["slot'"](cpList)(Data_Unit.unit)(Mkpasswd_Component_List.ui)(state.storage)(Data_Void.absurd);
              };
              if (state.route instanceof Mkpasswd_Routing.New) {
                  return Halogen_HTML["slot'"](cpStore)(Data_Unit.unit)(Mkpasswd_Component_Store.ui)(Data_Maybe.Nothing.value)(Halogen_HTML_Events.input(Save.create));
              };
              if (state.route instanceof Mkpasswd_Routing.Store) {
                  return Halogen_HTML["slot'"](cpStore)(Data_Unit.unit)(Mkpasswd_Component_Store.ui)(Data_Array.index(state.storage)(state.route.value0))(Halogen_HTML_Events.input(Save.create));
              };
