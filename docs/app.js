          ...
          var policyFormRow = function (feildType) {
              return function (labelTxt) {
                  return function (currentValue) {
                      ...
                      return Halogen_HTML_Elements.div([ classes([ "flex-none", "clearfix" ]) ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"](inpIdStr), classes([ "col", "col-3", "right-align", "align-baseline", "label" ]) ])([ Halogen_HTML_Core.text(labelTxt) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.id_(inpIdStr), classes([ "col", "col-8", "input" ]), Halogen_HTML_Properties.value(currentValue), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(UpdatePolicy.create(feildType))) ]) ]);
                  };
              };
          };
