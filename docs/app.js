...
(function(exports) {
  ...
  var showFieldType = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Main line 34, column 1 - line 34, column 41: " + [ v.constructor.name ]);
  });
  var id = function (v) {
      return v;
  };
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Mkpasswd.mkpasswd(v1.policy)))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at Main line 70, column 5 - line 72, column 55: " + [ v2.constructor.name ]);
                  })())(function () {
                  ...
                  return function (v1) {
                      var newPolicy = (function () {
                          if (f instanceof PasswdLength) {
                              var $30 = {};
                              for (var $31 in s.policy) {
                                  if ({}.hasOwnProperty.call(s.policy, $31)) {
                                      $30[$31] = s["policy"][$31];
                                  };
                              };
                              $30.length = v1;
                          ...
                          if (f instanceof DegitsNum) {
                              var $33 = {};
                              for (var $34 in s.policy) {
                                  if ({}.hasOwnProperty.call(s.policy, $34)) {
                                      $33[$34] = s["policy"][$34];
                                  };
                              };
                              $33.degit = v1;
                          ...
                          if (f instanceof UppercaseNum) {
                              var $36 = {};
                              for (var $37 in s.policy) {
                                  if ({}.hasOwnProperty.call(s.policy, $37)) {
                                      $36[$37] = s["policy"][$37];
                                  };
                              };
                              $36.uppercase = v1;
                          ...
                          if (f instanceof LowercaseNum) {
                              var $39 = {};
                              for (var $40 in s.policy) {
                                  if ({}.hasOwnProperty.call(s.policy, $40)) {
                                      $39[$40] = s["policy"][$40];
                                  };
                              };
                              $39.lowercase = v1;
                          ...
                          if (f instanceof SymbolNum) {
                              var $42 = {};
                              for (var $43 in s.policy) {
                                  if ({}.hasOwnProperty.call(s.policy, $43)) {
                                      $42[$43] = s["policy"][$43];
                                  };
                              };
                              $42.symbol = v1;
                          ...
                          throw new Error("Failed pattern match at Main line 86, column 25 - line 91, column 71: " + [ f.constructor.name ]);
                      })();
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  ...
                  if (newValue instanceof Data_Either.Left) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $51.errMsg = newValue.value0;
                          return $51;
                      });
                  };
                  throw new Error("Failed pattern match at Main line 79, column 9 - line 81, column 57: " + [ newValue.constructor.name ]);
              })())(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value2);
              });
          });
      };
      throw new Error("Failed pattern match at Main line 66, column 1 - line 66, column 53: " + [ v.constructor.name ]);
  };
  var classes = function ($61) {
      return Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)($61));
  };
  ...
  var ui = (function () {
      var render = function (state) {
          var resultView = function (value) {
              var $58 = Data_String_CodePoints.length(value) > 0;
              if ($58) {
          ...
          var errorView = function (error) {
              var $59 = Data_String_CodePoints.length(error) > 0;
              if ($59) {
