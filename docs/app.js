...
(function(exports) {
  ...
  var modifyFst = function (f) {
      return function ($171) {
          return Data_Tuple.swap(modifySnd(f)(Data_Tuple.swap($171)));
      };
  };
  ...
  var genericFieldType = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Mkpasswd.Component.Mkpasswd line 70, column 8 - line 70, column 56: " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var ui = (function () {
      ...
      var resultView = function (v) {
          ...
          throw new Error("Failed pattern match at Mkpasswd.Component.Mkpasswd line 208, column 11 - line 209, column 11: " + [ v.constructor.name ]);
      };
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof UpdateLength) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at Mkpasswd.Component.Mkpasswd line 228, column 18 - line 230, column 71: " + [ newValue.constructor.name ]);
                  })())(function () {
          ...
          if (v instanceof UpdatePolicy) {
                      ...
                      return function (v1) {
                          var newPolicy = (function () {
                              if (f instanceof DegitsNum) {
                                  ...
                                  $83.degit = Data_Functor.map(Data_Tuple.functorTuple)(updateFst(v1))(s.policy.degit);
                                  return $83;
                              };
                              if (f instanceof UppercaseNum) {
                                  ...
                                  $86.uppercase = Data_Functor.map(Data_Tuple.functorTuple)(updateFst(v1))(s.policy.uppercase);
                                  return $86;
                              };
                              if (f instanceof LowercaseNum) {
                                  ...
                                  $89.lowercase = Data_Functor.map(Data_Tuple.functorTuple)(updateFst(v1))(s.policy.lowercase);
                                  return $89;
                              };
                              if (f instanceof SymbolNum) {
                                  ...
                                  $92.symbol = Data_Functor.map(Data_Tuple.functorTuple)(updateFst(v1))(s.policy.symbol);
                                  return $92;
                              };
                              throw new Error("Failed pattern match at Mkpasswd.Component.Mkpasswd line 245, column 35 - line 249, column 97: " + [ f.constructor.name ]);
                          })();
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              var $95 = {};
                              for (var $96 in v2) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at Mkpasswd.Component.Mkpasswd line 237, column 19 - line 239, column 72: " + [ newValue.constructor.name ]);
                  })())(function () {
                      ...
                      return function (v1) {
                          var newPolicy = (function () {
                              if (f instanceof DegitsNum) {
                                  ...
                                  $109.degit = updateFst(v1)(s.policy.degit);
                                  return $109;
                              };
                              if (f instanceof UppercaseNum) {
                                  var $112 = {};
                                  ...
                                  $112.uppercase = updateFst(v1)(s.policy.uppercase);
                                  return $112;
                              };
                              if (f instanceof LowercaseNum) {
                                  var $115 = {};
                                  ...
                                  $115.lowercase = updateFst(v1)(s.policy.lowercase);
                                  return $115;
                              };
                              if (f instanceof SymbolNum) {
                                  var $118 = {};
                                  ...
                                  $118.symbol = updateFst(v1)(s.policy.symbol);
                                  return $118;
                              };
                              throw new Error("Failed pattern match at Mkpasswd.Component.Mkpasswd line 259, column 32 - line 263, column 92: " + [ f.constructor.name ]);
                          })();
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              var $121 = {};
                              for (var $122 in v2) {
          ...
          if (v instanceof UpdateCharUse) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var ns = Data_Functor.map(Data_Tuple.functorTuple)(Data_Functor.map(Data_Tuple.functorTuple)(modifyAt(v.value1)(updateFst(v.value2))))(v1.policy.symbol);
          ...
          if (v instanceof UpdateCharUseAll) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var ns = Data_Functor.map(Data_Tuple.functorTuple)(Data_Functor.map(Data_Tuple.functorTuple)(Data_Functor.map(Data_Functor.functorArray)(updateFst(v.value1))))(v1.policy.symbol);
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      var $143 = {};
                      for (var $144 in v2) {
                      ...
                      $143.custom = updateSnd(v.value1)(v1.custom);
                      return $143;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value2);
                  });
          ...
          if (v instanceof OpenCustom) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $150.custom = updateFst(true)(v1.custom);
                      return $150;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
          ...
          throw new Error("Failed pattern match at Mkpasswd.Component.Mkpasswd line 217, column 11 - line 217, column 63: " + [ v.constructor.name ]);
      };
      var errorView = function (v) {
          ...
          throw new Error("Failed pattern match at Mkpasswd.Component.Mkpasswd line 212, column 11 - line 213, column 11: " + [ v.constructor.name ]);
      };
