...
(function(exports) {
  ...
  var genericRouteType = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Main line 176, column 8 - line 176, column 56: " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var showRouteType = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericRouteType)(Data_Generic_Rep_Show.genericShowSum(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function () {
      return "LinkA";
  ...
  var genericFieldType = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Main line 39, column 8 - line 39, column 56: " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
  ...
  var $$eval = function (v) {
      if (v instanceof ChangeRoute) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.log(Data_Show.show(showRouteType)(v.value0))))(function () {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Mkpasswd.mkpasswd(v1.policy)))(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at Main line 79, column 5 - line 81, column 55: " + [ v2.constructor.name ]);
                  })())(function () {
                  ...
                  return function (v1) {
                      var newPolicy = (function () {
                          if (f instanceof PasswdLength) {
                              var $58 = {};
                              for (var $59 in s.policy) {
                                  if ({}.hasOwnProperty.call(s.policy, $59)) {
                                      $58[$59] = s["policy"][$59];
                                  };
                              };
                              $58.length = v1;
                          ...
                          if (f instanceof DegitsNum) {
                              var $61 = {};
                              for (var $62 in s.policy) {
                                  if ({}.hasOwnProperty.call(s.policy, $62)) {
                                      $61[$62] = s["policy"][$62];
                                  };
                              };
                              $61.degit = v1;
                          ...
                          if (f instanceof UppercaseNum) {
                              var $64 = {};
                              for (var $65 in s.policy) {
                                  if ({}.hasOwnProperty.call(s.policy, $65)) {
                                      $64[$65] = s["policy"][$65];
                                  };
                              };
                              $64.uppercase = v1;
                          ...
                          if (f instanceof LowercaseNum) {
                              var $67 = {};
                              for (var $68 in s.policy) {
                                  if ({}.hasOwnProperty.call(s.policy, $68)) {
                                      $67[$68] = s["policy"][$68];
                                  };
                              };
                              $67.lowercase = v1;
                          ...
                          if (f instanceof SymbolNum) {
                              var $70 = {};
                              for (var $71 in s.policy) {
                                  if ({}.hasOwnProperty.call(s.policy, $71)) {
                                      $70[$71] = s["policy"][$71];
                                  };
                              };
                              $70.symbol = v1;
                          ...
                          throw new Error("Failed pattern match at Main line 95, column 25 - line 100, column 71: " + [ f.constructor.name ]);
                      })();
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  ...
                  if (newValue instanceof Data_Either.Left) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $79.errMsg = newValue.value0;
                          return $79;
                      });
                  };
                  throw new Error("Failed pattern match at Main line 88, column 9 - line 90, column 57: " + [ newValue.constructor.name ]);
              })())(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value2);
              });
          });
      };
      throw new Error("Failed pattern match at Main line 70, column 1 - line 70, column 53: " + [ v.constructor.name ]);
  };
  var classes = function ($90) {
      return Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)($90));
  };
  var headerNav = Halogen_HTML_Elements.nav([ classes([ "border", "flex-none", "flex", "justify-center" ]) ])([ Halogen_HTML_Elements.a([ classes([ "flex-auto", "border", "p1", "center" ]), Halogen_HTML_Properties.href("#link/a") ])([ Halogen_HTML_Core.text("\u3064\u304f\u308b") ]), Halogen_HTML_Elements.a([ classes([ "flex-auto", "border", "p1", "center" ]), Halogen_HTML_Properties.href("#link/b") ])([ Halogen_HTML_Core.text("\u3057\u307e\u3046") ]) ]);
  var ui = (function () {
      var render = function (state) {
          var resultView = function (value) {
              var $86 = Data_String_CodePoints.length(value) > 0;
              if ($86) {
          ...
          var errorView = function (error) {
              var $87 = Data_String_CodePoints.length(error) > 0;
              if ($87) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(ui)(Data_Unit.unit)(v))(function (v1) {
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Routing_Hash.matches(menuRoute)(function (v2) {
              return function (newHash) {
                  return Effect_Aff.launchAff_(v1.query(Halogen_Query.action(ChangeRoute.create(newHash))));
              };
          }));
      });
  }));
  ...
  exports["genericRouteType"] = genericRouteType;
  exports["showRouteType"] = showRouteType;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
