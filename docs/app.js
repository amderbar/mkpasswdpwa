...
(function(exports) {
  ...
  var randomCharCodes = function (length) {
      return function (randomChar) {
          return Data_Traversable.sequence(Data_Traversable.traversableArray)(Effect.applicativeEffect)(Data_Array.replicate(length)(randomChar));
      };
  };
  ...
  var asciiNum = function (policy) {
      return policy.length - (((policy.degit + policy.uppercase | 0) + policy.lowercase | 0) + policy.symbol | 0) | 0;
  };
  var ascii = new Data_Tuple.Tuple(33, 126);
  var randomAscii = (function () {
  ...
  var randomSymbol = (function () {
      ...
      return function __do() {
          ...
          var $8 = Data_Foldable.elem(Data_Foldable.foldableArray)(Data_Eq.eqInt)(v)(symbols);
          if ($8) {
              return v;
          };
          return randomSymbol();
  ...
  var arrayFrom = function (policy) {
      return [ policy.length, policy.degit, policy.uppercase, policy.lowercase, policy.symbol ];
  };
  ...
  var mkpasswd = function (policy) {
      var randomCharCodeArray = function (p) {
          return Control_Bind.join(Effect.bindEffect)(Data_Functor.map(Effect.functorEffect)(Data_Functor.map(Data_Functor.functorFn)(shuffle)(Data_Array.concat))(Data_Traversable.sequence(Data_Traversable.traversableArray)(Effect.applicativeEffect)([ randomCharCodes(asciiNum(p))(randomAscii), randomCharCodes(degitNum(p))(randomDegit), randomCharCodes(uppercaseNum(p))(randomUpper), randomCharCodes(lowercaseNum(p))(randomLower), randomCharCodes(symbolNum(p))(randomSymbol) ])));
      };
      var fromCharCodeArray = function ($12) {
          return Data_String_CodeUnits.fromCharArray(Data_Array.mapMaybe(Data_Char.fromCharCode)($12));
      };
...
(function(exports) {
  ...
  var genericFieldType = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Mkpasswd.Component.Mkpasswd line 35, column 8 - line 35, column 56: " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var ui = (function () {
      var resultView = function (value) {
          var $30 = Data_String_CodePoints.length(value) > 0;
          if ($30) {
      ...
      var policyFormRow = function (feildType) {
          return function (labelTxt) {
              return function (currentValue) {
                  ...
                  return Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "flex-none", "clearfix" ]) ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"](inpIdStr), Mkpasswd_Halogen_Util.classes([ "col", "col-3", "right-align", "align-baseline", "label" ]) ])([ Halogen_HTML_Core.text(labelTxt) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.id_(inpIdStr), Mkpasswd_Halogen_Util.classes([ "col", "col-8", "input" ]), Halogen_HTML_Properties.value(currentValue), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(UpdatePolicy.create(feildType))) ]) ]);
              };
          };
      };
              ...
              return function (v) {
                  var newPolicy = (function () {
                      if (f instanceof PasswdLength) {
                          var $32 = {};
                          for (var $33 in s.policy) {
                              if ({}.hasOwnProperty.call(s.policy, $33)) {
                                  $32[$33] = s["policy"][$33];
                              };
                          };
                          $32.length = v;
                      ...
                      if (f instanceof DegitsNum) {
                          var $35 = {};
                          for (var $36 in s.policy) {
                              if ({}.hasOwnProperty.call(s.policy, $36)) {
                                  $35[$36] = s["policy"][$36];
                              };
                          };
                          $35.degit = v;
                      ...
                      if (f instanceof UppercaseNum) {
                          var $38 = {};
                          for (var $39 in s.policy) {
                              if ({}.hasOwnProperty.call(s.policy, $39)) {
                                  $38[$39] = s["policy"][$39];
                              };
                          };
                          $38.uppercase = v;
                      ...
                      if (f instanceof LowercaseNum) {
                          var $41 = {};
                          for (var $42 in s.policy) {
                              if ({}.hasOwnProperty.call(s.policy, $42)) {
                                  $41[$42] = s["policy"][$42];
                              };
                          };
                          $41.lowercase = v;
                      ...
                      if (f instanceof SymbolNum) {
                          var $44 = {};
                          for (var $45 in s.policy) {
                              if ({}.hasOwnProperty.call(s.policy, $45)) {
                                  $44[$45] = s["policy"][$45];
                              };
                          };
                          $44.symbol = v;
                      ...
                      throw new Error("Failed pattern match at Mkpasswd.Component.Mkpasswd line 120, column 21 - line 125, column 67: " + [ f.constructor.name ]);
                  })();
      ...
      var $$eval = function (v) {
          if (v instanceof Regenerate) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Mkpasswd.mkpasswd(v1.policy)))(function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          ...
                          throw new Error("Failed pattern match at Mkpasswd.Component.Mkpasswd line 106, column 15 - line 108, column 65: " + [ v2.constructor.name ]);
                      })())(function () {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      if (newValue instanceof Data_Either.Left) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $66.errMsg = newValue.value0;
                              return $66;
                          });
                      };
                      throw new Error("Failed pattern match at Mkpasswd.Component.Mkpasswd line 114, column 19 - line 116, column 67: " + [ newValue.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value2);
                  });
              });
          };
          throw new Error("Failed pattern match at Mkpasswd.Component.Mkpasswd line 102, column 11 - line 102, column 63: " + [ v.constructor.name ]);
      };
      var errorView = function (error) {
          var $73 = Data_String_CodePoints.length(error) > 0;
          if ($73) {
      ...
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "flex-auto", "flex", "flex-column" ]) ])([ Halogen_HTML_Elements.h1([ Mkpasswd_Halogen_Util.classes([ "center" ]) ])([ Halogen_HTML_Core.text("Mkpasswd") ]), errorView(state.errMsg), policyFormRow(PasswdLength.value)("\u306a\u304c\u3055\uff1a")(Data_Show.show(Data_Show.showInt)(state.policy.length)), policyFormRow(DegitsNum.value)("\u3059\u3046\u3058\uff1a")(Data_Show.show(Data_Show.showInt)(state.policy.degit)), policyFormRow(UppercaseNum.value)("\u82f1\u5927\u5b57\uff1a")(Data_Show.show(Data_Show.showInt)(state.policy.uppercase)), policyFormRow(LowercaseNum.value)("\u82f1\u5c0f\u5b57\uff1a")(Data_Show.show(Data_Show.showInt)(state.policy.lowercase)), policyFormRow(SymbolNum.value)("\u304d\u3054\u3046\uff1a")(Data_Show.show(Data_Show.showInt)(state.policy.symbol)), resultView(state.passwd), Halogen_HTML_Elements.button([ Mkpasswd_Halogen_Util.classes([ "self-center", "p1" ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Regenerate.create)) ])([ Halogen_HTML_Core.text("Generate new Password") ]) ]);
      };
...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];
  var MkpasswdSlot = (function () {
      function MkpasswdSlot() {

      };
      MkpasswdSlot.value = new MkpasswdSlot();
      return MkpasswdSlot;
  })();
  ...
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.main([ Mkpasswd_Halogen_Util.style("height: 100%"), Mkpasswd_Halogen_Util.classes([ "flex", "flex-column" ]) ])([ Halogen_HTML_Elements.nav([ Mkpasswd_Halogen_Util.classes([ "border", "flex-none", "flex", "justify-center" ]) ])([ Halogen_HTML_Elements.a([ Mkpasswd_Halogen_Util.classes([ "flex-auto", "border", "p1", "center" ]), Halogen_HTML_Properties.href("#link/a") ])([ Halogen_HTML_Core.text("\u3064\u304f\u308b") ]), Halogen_HTML_Elements.a([ Mkpasswd_Halogen_Util.classes([ "flex-auto", "border", "p1", "center" ]), Halogen_HTML_Properties.href("#link/b") ])([ Halogen_HTML_Core.text("\u3057\u307e\u3046") ]) ]), Halogen_HTML.slot(MkpasswdSlot.value)(Mkpasswd_Component_Mkpasswd.ui)(Data_Unit.unit)(Data_Void.absurd) ]);
      };
      var initialState = {
  ...
  exports["MkpasswdSlot"] = MkpasswdSlot;
