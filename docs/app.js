...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];                 
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(Halogen_VDom_Driver.runUI(Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
      render: Data_Function["const"](Halogen_HTML_Core.text("Hello, World")),
      "eval": function (v) {
