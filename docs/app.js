...
(function($PS) {
  ...
  var ui = (function () {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Mkpasswd.UI.Components.LabeledInputNumber (line 70, column 11 - line 70, column 74): " + [ v.constructor.name ]);
      };
...
(function($PS) {
  ...
  var ui = function (dictMonadEffect) {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "field" ]) ])([ Halogen_HTML_Elements.label([ Mkpasswd_Halogen_Util.classes([ "label" ]) ])([ Halogen_HTML_Core.text(Mkpasswd_Data_FieldType_Mkpasswd.labelTxt(state.fieldType)) ]), Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "field", "has-addons" ]) ])([ Halogen_HTML_Elements.span([ Mkpasswd_Halogen_Util.classes([ "control" ]) ])([ Halogen_HTML_Elements.label([ Mkpasswd_Halogen_Util.classes([ "button", "checkbox" ]) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Properties.checked(state.isUsed), Mkpasswd_Halogen_Util.classes([ "mr1" ]), Halogen_HTML_Events.onChecked(Halogen_HTML_Events.input(OnChkUse.create)) ]), Halogen_HTML_Core.text("use it") ]) ]), Halogen_HTML_Elements.span([ Mkpasswd_Halogen_Util.classes([ "control", "is-expanded" ]) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.id_(Data_Show.show(Mkpasswd_Data_FieldType_Mkpasswd.showFieldType)(state.fieldType)), Mkpasswd_Halogen_Util.classes([ "input" ]), Halogen_HTML_Properties.value(state.requiredMinNum), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(OnInputRequiredMinNum.create)), Halogen_HTML_Properties.step(DOM_HTML_Indexed_StepValue.Any.value), Halogen_HTML_Properties.min(Data_Int.toNumber(0)), Halogen_HTML_Properties.max(Data_Int.toNumber(100)), Halogen_HTML_Properties.disabled(!state.isUsed) ]) ]) ]) ]);
      };
      var initialState = function (i) {
          return i;
      };
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Mkpasswd.UI.Components.PolicyFormRow (line 85, column 11 - line 85, column 64): " + [ v.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
          initialState: initialState,
          render: render,
...
(function($PS) {
  ...
  var ui = function (dictMonadEffect) {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "field" ]) ])([ Halogen_HTML_Elements.label([ Mkpasswd_Halogen_Util.classes([ "label" ]) ])([ Halogen_HTML_Core.text(Mkpasswd_Data_FieldType_Mkpasswd.labelTxt(state.fieldType)) ]), Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "field", "has-addons" ]) ])([ Halogen_HTML_Elements.span([ Mkpasswd_Halogen_Util.classes([ "control" ]) ])([ Halogen_HTML_Elements.label([ Mkpasswd_Halogen_Util.classes([ "button", "checkbox" ]) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Properties.checked(state.isUsed), Mkpasswd_Halogen_Util.classes([ "mr1" ]), Halogen_HTML_Events.onChecked(Halogen_HTML_Events.input(function ($15) {
              return OnInputMinNum.create((function (v) {
                  return {
          ...
          })) ]), Halogen_HTML_Core.text("use it") ]) ]), Halogen_HTML_Elements.span([ Mkpasswd_Halogen_Util.classes([ "control", "is-expanded" ]) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.id_(Data_Show.show(Mkpasswd_Data_FieldType_Mkpasswd.showFieldType)(state.fieldType)), Mkpasswd_Halogen_Util.classes([ "input" ]), Halogen_HTML_Properties.value(state.requiredMinNum), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function ($16) {
              return OnInputMinNum.create((function (v) {
                  return {
                      fieldType: state.fieldType,
                      requiredMinNum: v,
          ...
          })), Halogen_HTML_Properties.step(DOM_HTML_Indexed_StepValue.Any.value), Halogen_HTML_Properties.min(Data_Int.toNumber(0)), Halogen_HTML_Properties.max(Data_Int.toNumber(100)), Halogen_HTML_Properties.disabled(!state.isUsed) ]) ]) ]), (function (i) {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Mkpasswd.UI.Components.SymbolPolicyFormRow (line 109, column 11 - line 109, column 77): " + [ v.constructor.name ]);
      };
...
(function($PS) {
  ...
  var cpSymRow = Halogen_Component_ChildPath.cp4;
  var cpPolRow = Halogen_Component_ChildPath.cp3;
  var cpNav = Halogen_Component_ChildPath.cp1;
  var cpLblInp = Halogen_Component_ChildPath.cp2;
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.main([ Mkpasswd_Halogen_Util.classes([ (function () {
              var $23 = Data_Maybe.isJust(state.passwd);
              if ($23) {
                  return "is-clipped";
              };
              return "";
          })() ]) ])([ Halogen_HTML["slot'"](cpNav)(Data_Unit.unit)(Mkpasswd_UI_Components_HeaderNav.component)(Data_Unit.unit)(Data_Void.absurd), Mkpasswd_UI_Element.container([ (function (i) {
              ...
              requiredMinNum: Data_Maybe.fromMaybe("")(Data_Functor.map(Data_Maybe.functorMaybe)(function ($75) {
                  return (function (v) {
                      return v.requiredMinNum;
              ...
              requiredMinNum: Data_Maybe.fromMaybe("")(Data_Functor.map(Data_Maybe.functorMaybe)(function ($76) {
                  return (function (v) {
                      return v.requiredMinNum;
                  })(Mkpasswd_Data_Switch.label($76));
              ...
              requiredMinNum: Data_Maybe.fromMaybe("")(Data_Functor.map(Data_Maybe.functorMaybe)(function ($77) {
                  return (function (v) {
                      return v.requiredMinNum;
                  })(Mkpasswd_Data_Switch.label($77));
              ...
              requiredMinNum: Data_Maybe.fromMaybe("")(Data_Functor.map(Data_Maybe.functorMaybe)(function ($78) {
                  return (function (v) {
                      return v.requiredMinNum;
                  })(Mkpasswd_Data_Switch.label($78));
              })(Data_Array.index(state.policy)(3))),
              isOpenMulChk: false,
              allChk: true,
              chars: Data_Functor.map(Data_Functor.functorArray)(Mkpasswd_Data_Switch.toSwitch(Mkpasswd_Data_Switch.On.value))(Data_Maybe.fromMaybe([  ])(Data_Functor.map(Data_Maybe.functorMaybe)(function ($79) {
                  return (function (v) {
                      return v.charSet;
                  })(Mkpasswd_Data_Switch.label($79));
              })(Data_Array.index(state.policy)(3))))
          }), Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "content", "message", "is-danger" ]) ])([ (function () {
              var $24 = Data_Array["null"](state.errMsg);
              if ($24) {
                  return Halogen_HTML_Core.text("");
              };
              return Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "message-body" ]) ])([ Halogen_HTML_Elements.ul([ Mkpasswd_Halogen_Util.classes([ "is-marginless" ]) ])(Data_Functor.map(Data_Functor.functorArray)(function (c) {
                  return Halogen_HTML_Elements.li([ Mkpasswd_Halogen_Util.classes([ "is-danger" ]) ])([ Halogen_HTML_Core.text(c) ]);
              })(state.errMsg)) ]);
          })() ]) ]), Halogen_HTML_Elements.section([ Mkpasswd_Halogen_Util.classes([ "level", "sticky-bottom", "box" ]) ])([ Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "level-item" ]) ])([ Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "field", "is-grouped" ]) ])([ Halogen_HTML_Elements.span([ Mkpasswd_Halogen_Util.classes([ "control" ]) ])([ Halogen_HTML_Elements.button([ Mkpasswd_Halogen_Util.classes([ "button", "is-dark" ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Generate.create)) ])([ Halogen_HTML_Core.text("Generate") ]) ]), Halogen_HTML_Elements.span([ Mkpasswd_Halogen_Util.classes([ "control" ]) ])([ Halogen_HTML_Elements.button([ Mkpasswd_Halogen_Util.classes([ "button", "is-light" ]) ])([ Halogen_HTML_Core.text("Reset") ]) ]) ]) ]) ]), Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "modal", (function () {
      ...
      var fieldIdx = function (v) {
          ...
          throw new Error("Failed pattern match at Mkpasswd.UI.Pages.Mkpasswd (line 289, column 11 - line 289, column 39): " + [ v.constructor.name ]);
      };
      var $$eval = function (v) {
          if (v instanceof Clear) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $28.passwd = Data_Maybe.Nothing.value;
                  return $28;
              }))(function () {
          ...
          if (v instanceof Generate) {
              var showErr = function (v1) {
                  ...
                  throw new Error("Failed pattern match at Mkpasswd.UI.Pages.Mkpasswd (line 253, column 31 - line 260, column 21): " + [ v1.constructor.name ]);
              };
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))((function () {
                      ...
                      throw new Error("Failed pattern match at Mkpasswd.UI.Pages.Mkpasswd (line 231, column 23 - line 233, column 56): " + [ vp.constructor.name ]);
                  })()))(function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          if (v2 instanceof Data_Either.Right) {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  ...
                                  $42.errMsg = [  ];
                                  $42.passwd = new Data_Maybe.Just(v2.value0);
                                  return $42;
                              });
                          };
                          if (v2 instanceof Data_Either.Left) {
                          ...
                          throw new Error("Failed pattern match at Mkpasswd.UI.Pages.Mkpasswd (line 234, column 15 - line 236, column 59): " + [ v2.constructor.name ]);
                      })())(function () {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var np = Mkpasswd_Data_Array.modifyAt(idx)(function (w) {
                      return Data_Functor.map(Mkpasswd_Data_Switch.functorSwitch)(function (v2) {
                          ...
                          $58.requiredMinNum = v.value0.requiredMinNum;
                          return $58;
          ...
          if (v instanceof OnInputSymNum) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $70.policy = Mkpasswd_Data_Array.modifyAt(idx)(Data_Functor.map(Mkpasswd_Data_Switch.functorSwitch)(function (v3) {
                          var $67 = {};
                          for (var $68 in v3) {
                          ...
                          $67.charSet = Data_Array.mapMaybe(Mkpasswd_Data_Switch.toMaybe)(v.value0.chars);
                          return $67;
                      }))(v1.policy);
                      return $70;
                  }))(function () {
          ...
          throw new Error("Failed pattern match at Mkpasswd.UI.Pages.Mkpasswd (line 220, column 11 - line 220, column 84): " + [ v.constructor.name ]);
      };
      return Halogen_Component.parentComponent(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Either.ordEither(ordPolRowSlot)(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Ord.ordVoid)))))({
          initialState: initialState,
          render: render,
          "eval": $$eval,
          receiver: Data_Function["const"](Data_Maybe.Nothing.value)
...
(function($PS) {
  ...
  var genericFeildType = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Mkpasswd.UI.Pages.Store (line 40, column 8 - line 40, column 56): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
  ...
  var ui = (function () {
      var queryType = function (v) {
          ...
          throw new Error("Failed pattern match at Mkpasswd.UI.Pages.Store (line 99, column 11 - line 99, column 49): " + [ v.constructor.name ]);
      };
      var labelTxt = function (v) {
          if (v instanceof AccountInput) {
              return "Title";
          ...
          throw new Error("Failed pattern match at Mkpasswd.UI.Pages.Store (line 96, column 11 - line 97, column 11): " + [ v.constructor.name ]);
      };
      var txtForm = function (feildType) {
          return function (inpHtmlElm) {
              return Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "field" ]) ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"](Data_Show.show(showFeildType)(feildType)), Mkpasswd_Halogen_Util.classes([ "label" ]) ])([ Halogen_HTML_Core.text(labelTxt(feildType)) ]), Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "control" ]) ])([ inpHtmlElm ]) ]);
          };
      };
      var txtArea = function (feildType) {
          return function (currVal) {
              return txtForm(feildType)(Halogen_HTML_Elements.textarea([ Halogen_HTML_Properties.id_(Data_Show.show(showFeildType)(feildType)), Mkpasswd_Halogen_Util.classes([ "textarea" ]), Halogen_HTML_Properties.value(currVal), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(queryType(feildType))) ]));
          };
      };
      var txtInput = function (feildType) {
          return function (currVal) {
              return txtForm(feildType)(Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.id_(Data_Show.show(showFeildType)(feildType)), Mkpasswd_Halogen_Util.classes([ "input" ]), Halogen_HTML_Properties.value(currVal), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(queryType(feildType))) ]));
          };
      };
      ...
      var errorView = function (v) {
          ...
          if (v instanceof Data_Maybe.Just) {
              return Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "content", "message", "is-danger" ]) ])([ (function () {
                  var $28 = Data_Array["null"](v.value0);
                  if ($28) {
                      return Halogen_HTML_Core.text("");
                  };
                  return Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "message-body" ]) ])([ Halogen_HTML_Elements.ul([ Mkpasswd_Halogen_Util.classes([ "is-marginless" ]) ])(Data_Functor.map(Data_Functor.functorArray)(function (c) {
          ...
          throw new Error("Failed pattern match at Mkpasswd.UI.Pages.Store (line 129, column 11 - line 130, column 11): " + [ v.constructor.name ]);
      };
      var render = function (state) {
          return Halogen_HTML_Elements.main_([ Halogen_HTML.slot(Data_Unit.unit)(Mkpasswd_UI_Components_HeaderNav.component)(Data_Unit.unit)(Data_Void.absurd), Mkpasswd_UI_Element.container([ errorView(state.error), txtInput(AccountInput.value)(state.form.account), txtInput(Passwdinput.value)(state.form.passwd), txtArea(NoteTextarea.value)(state.form.note), Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "field", "is-grouped" ]) ])([ Halogen_HTML_Elements.span([ Mkpasswd_Halogen_Util.classes([ "control" ]) ])([ Halogen_HTML_Elements.button([ Mkpasswd_Halogen_Util.classes([ "button", "is-dark" ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Save.create)) ])([ Halogen_HTML_Core.text("Save") ]) ]), Halogen_HTML_Elements.span([ Mkpasswd_Halogen_Util.classes([ "control" ]) ])([ Halogen_HTML_Elements.a([ Mkpasswd_Halogen_Util.classes([ "button" ]), Halogen_HTML_Properties.href(Mkpasswd_UI_Routing.routeHref(Mkpasswd_UI_Routing.List.value)) ])([ Halogen_HTML_Core.text("Cancel") ]) ]) ]) ]) ]);
      };
      var errorMsg = function (v) {
          ...
          throw new Error("Failed pattern match at Mkpasswd.UI.Pages.Store (line 143, column 11 - line 144, column 11): " + [ v.constructor.name ]);
      };
      var $$eval = function (v) {
          if (v instanceof UpdateAccount) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $36.form = (function () {
                          var $33 = {};
                          for (var $34 in v1.form) {
                              if ({}.hasOwnProperty.call(v1.form, $34)) {
                                  $33[$34] = v1["form"][$34];
                              };
                          };
                          $33.account = v.value0;
          ...
          if (v instanceof UpdatePasswd) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $45.form = (function () {
                          var $42 = {};
                          for (var $43 in v1.form) {
                              if ({}.hasOwnProperty.call(v1.form, $43)) {
                                  $42[$43] = v1["form"][$43];
                              };
                          };
                          $42.passwd = v.value0;
          ...
          if (v instanceof UpdateNote) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $54.form = (function () {
                          var $51 = {};
                          for (var $52 in v1.form) {
                              if ({}.hasOwnProperty.call(v1.form, $52)) {
                                  $51[$52] = v1["form"][$52];
                              };
                          };
                          $51.note = v.value0;
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      if (v2 instanceof Data_Either.Left) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              $62.error = new Data_Maybe.Just(Data_Functor.map(Data_Functor.functorArray)(errorMsg)(v2.value0));
                              return $62;
                          });
                      };
                      throw new Error("Failed pattern match at Mkpasswd.UI.Pages.Store (line 164, column 14 - line 168, column 77): " + [ v2.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
              });
          };
          throw new Error("Failed pattern match at Mkpasswd.UI.Pages.Store (line 149, column 11 - line 149, column 84): " + [ v.constructor.name ]);
      };
      return Halogen_Component.parentComponent(Data_Ord.ordUnit)({
          initialState: initialState,
          render: render,
