...
(function(exports) {
  ...
  var showFieldType = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Main line 40, column 1 - line 40, column 41: " + [ v.constructor.name ]);
  });
  var id = function (v) {
      return v;
  };
  var $$eval = function (v) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      if (v2 instanceof Data_Either.Left) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              $38.errMsg = Data_Show.show(Mkpasswd.showErrorReason)(v2.value0);
                              return $38;
                          });
                      };
                      throw new Error("Failed pattern match at Main line 83, column 5 - line 85, column 60: " + [ v2.constructor.name ]);
                  })())(function () {
                  ...
                  return function (v1) {
                      var newPolicy = (function () {
                          if (f instanceof PasswdLength) {
                              var $48 = {};
                              for (var $49 in s.policy) {
                                  if ({}.hasOwnProperty.call(s.policy, $49)) {
                                      $48[$49] = s["policy"][$49];
                                  };
                              };
                              $48.length = v1;
                          ...
                          if (f instanceof DegitsNum) {
                              var $51 = {};
                              for (var $52 in s.policy) {
                                  if ({}.hasOwnProperty.call(s.policy, $52)) {
                                      $51[$52] = s["policy"][$52];
                                  };
                              };
                              $51.degit = updateTuple(s.policy.degit)(v1);
                              return $51;
                          };
                          if (f instanceof UppercaseNum) {
                              var $54 = {};
                              for (var $55 in s.policy) {
                                  if ({}.hasOwnProperty.call(s.policy, $55)) {
                                      $54[$55] = s["policy"][$55];
                                  };
                              };
                              $54.uppercase = updateTuple(s.policy.uppercase)(v1);
                              return $54;
                          };
                          if (f instanceof LowercaseNum) {
                              var $57 = {};
                              for (var $58 in s.policy) {
                                  if ({}.hasOwnProperty.call(s.policy, $58)) {
                                      $57[$58] = s["policy"][$58];
                                  };
                              };
                              $57.lowercase = updateTuple(s.policy.lowercase)(v1);
                              return $57;
                          };
                          if (f instanceof SymbolNum) {
                              var $60 = {};
                              for (var $61 in s.policy) {
                                  if ({}.hasOwnProperty.call(s.policy, $61)) {
                                      $60[$61] = s["policy"][$61];
                                  };
                              };
                              $60.symbol = updateTuple(s.policy.symbol)(v1);
                              return $60;
                          };
                          throw new Error("Failed pattern match at Main line 103, column 25 - line 108, column 85: " + [ f.constructor.name ]);
                      })();
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  ...
                  if (newValue instanceof Data_Either.Left) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $69.errMsg = newValue.value0;
                          return $69;
                      });
                  };
                  throw new Error("Failed pattern match at Main line 94, column 9 - line 96, column 57: " + [ newValue.constructor.name ]);
              })())(function () {
              ...
              return function (s) {
                  return function (v1) {
                      var newPolicy = (function () {
                          ...
                          if (f instanceof DegitsNum) {
                              var $81 = {};
                              for (var $82 in s.policy) {
                                  if ({}.hasOwnProperty.call(s.policy, $82)) {
                                      $81[$82] = s["policy"][$82];
                                  };
                              };
                              $81.degit = updateTuple(s.policy.degit)(v1);
                              return $81;
                          };
                          if (f instanceof UppercaseNum) {
                              var $84 = {};
                              for (var $85 in s.policy) {
                                  if ({}.hasOwnProperty.call(s.policy, $85)) {
                                      $84[$85] = s["policy"][$85];
                                  };
                              };
                              $84.uppercase = updateTuple(s.policy.uppercase)(v1);
                              return $84;
                          };
                          if (f instanceof LowercaseNum) {
                              var $87 = {};
                              for (var $88 in s.policy) {
                                  if ({}.hasOwnProperty.call(s.policy, $88)) {
                                      $87[$88] = s["policy"][$88];
                                  };
                              };
                              $87.lowercase = updateTuple(s.policy.lowercase)(v1);
                              return $87;
                          };
                          if (f instanceof SymbolNum) {
                              var $90 = {};
                              for (var $91 in s.policy) {
                                  if ({}.hasOwnProperty.call(s.policy, $91)) {
                                      $90[$91] = s["policy"][$91];
                                  };
                              };
                              $90.symbol = updateTuple(s.policy.symbol)(v1);
                              return $90;
                          };
                          throw new Error("Failed pattern match at Main line 120, column 22 - line 125, column 84: " + [ f.constructor.name ]);
                      })();
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          var $93 = {};
                          for (var $94 in v2) {
      ...
      throw new Error("Failed pattern match at Main line 73, column 1 - line 73, column 53: " + [ v.constructor.name ]);
  };
  var classes = function ($108) {
      return Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)($108));
  };
  var headerNav = Halogen_HTML_Elements.nav([ classes([ "border", "flex-none", "flex", "justify-center" ]) ])([ Halogen_HTML_Elements.a([ classes([ "flex-auto", "border", "p1", "center" ]) ])([ Halogen_HTML_Core.text("\u3064\u304f\u308b") ]), Halogen_HTML_Elements.a([ classes([ "flex-auto", "border", "p1", "center" ]) ])([ Halogen_HTML_Core.text("\u3057\u307e\u3046") ]) ]);
  var ui = (function () {
      ...
      var resultView = function (value) {
          var $100 = Data_String_CodePoints.length(value) > 0;
          if ($100) {
              return Halogen_HTML_Elements.p([ classes([ "h3", "center", "border", "rounded" ]) ])([ Halogen_HTML_Core.text(value) ]);
          };
      ...
      var policyFormRow = function (feildType) {
          return function (labelTxt) {
              return function (v) {
                  ...
                  return Halogen_HTML_Elements.div([ classes([ "flex-none", "clearfix" ]) ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"](inpIdStr), classes([ "pr1", "col", "col-4", "right-align", "align-baseline", "label" ]) ])([ Halogen_HTML_Core.text(labelTxt) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.id_(inpIdStr), classes([ "col", "col-3", "input" ]), Halogen_HTML_Properties.disabled(!v.value0), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(v.value1)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(UpdatePolicy.create(feildType))) ]), Halogen_HTML_Elements.label([ classes([ "pl1", "col", "col-4", "left-align", "align-baseline", "label" ]) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Properties.checked(v.value0), Halogen_HTML_Events.onChecked(Halogen_HTML_Events.input(UpdateChecked.create(feildType))) ]), Halogen_HTML_Core.text("\u542b\u3081\u308b") ]) ]);
              };
          };
      };
      var lengthFormRow = function (feildType) {
          return function (labelTxt) {
              return function (currVal) {
                  var inpIdStr = Data_Show.show(showFieldType)(feildType);
                  return Halogen_HTML_Elements.div([ classes([ "flex-none", "clearfix" ]) ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"](inpIdStr), classes([ "pr1", "col", "col-4", "right-align", "align-baseline", "label" ]) ])([ Halogen_HTML_Core.text(labelTxt) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.id_(inpIdStr), classes([ "col", "col-3", "input" ]), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(currVal)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(UpdatePolicy.create(feildType))) ]) ]);
              };
          };
      };
      var initialState = {
      ...
      var errorView = function (error) {
          var $106 = Data_String_CodePoints.length(error) > 0;
          if ($106) {
              return Halogen_HTML_Elements.p([ classes([ "h3", "center", "border", "border-red" ]) ])([ Halogen_HTML_Core.text(error) ]);
          };
          return Halogen_HTML_Core.text(error);
      };
      var render = function (state) {
          return Halogen_HTML_Elements.main([ style("height: 100%"), classes([ "flex", "flex-column" ]) ])([ Halogen_HTML_Elements.h1([ classes([ "center" ]) ])([ Halogen_HTML_Core.text("Mkpasswd") ]), errorView(state.errMsg), lengthFormRow(PasswdLength.value)("\u306a\u304c\u3055\uff1a")(state.policy.length), policyFormRow(DegitsNum.value)("\u3059\u3046\u3058\uff1a")(state.policy.degit), policyFormRow(UppercaseNum.value)("\u82f1\u5927\u5b57\uff1a")(state.policy.uppercase), policyFormRow(LowercaseNum.value)("\u82f1\u5c0f\u5b57\uff1a")(state.policy.lowercase), policyFormRow(SymbolNum.value)("\u304d\u3054\u3046\uff1a")(state.policy.symbol), resultView(state.passwd), Halogen_HTML_Elements.button([ classes([ "self-center", "p1" ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Regenerate.create)) ])([ Halogen_HTML_Core.text("Generate new Password") ]) ]);
      };
