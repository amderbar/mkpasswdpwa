...
(function($PS) {
  ...
  var injQuery = function (dictFunctor) {
      return Data_Functor_Variant.inj()(new Data_Symbol.IsSymbol(function () {
          return "userQuery";
      }))(dictFunctor)(Type_Proxy["Proxy"].value);
  };
...
(function($PS) {
  ...
  var _FieldOutput = function (dictIsSymbol) {
      return function (dictNewtype) {
          return function (dictCons) {
              return function (sym) {
                  return function (dictWander) {
                      var $107 = _FieldResult(dictIsSymbol)()()(sym)(dictWander.Strong0());
  ...
  var getOutput = function (dictIsSymbol) {
      return function (dictNewtype) {
          return function (dictCons) {
              return function (sym) {
                  return Data_Lens_Fold.preview(_FieldOutput(dictIsSymbol)()()(sym)(Data_Lens_Internal_Forget.wanderForget(Data_Maybe_First.monoidFirst)));
              };
          };
      };
  };
  ...
  var routing = function (query) {
      return function (hashAction) {
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Routing_Hash.matches(menuHash)(function (mOld) {
              return function ($$new) {
                  return Control_Applicative.when(Effect.applicativeEffect)(Data_Eq.notEq(Data_Maybe.eqMaybe(eqRouteHash))(mOld)(new Data_Maybe.Just($$new)))(Effect_Aff.launchAff_(query(Halogen_Query.mkTell(hashAction($$new)))));
              };
          }));
      };
  };
...
(function($PS) {
  ...
  var render = function (s) {
      return Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "navbar", "is-fixed-top", "is-dark" ])), Halogen_HTML_Properties.attr("role")("navigation"), Halogen_HTML_Properties.attr("aria-label")("main navigation") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "container" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "navbar-brand" ])) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "navbar-item" ])), Halogen_HTML_Properties.href(Mkpasswd_UI_Routing.routeHref(Mkpasswd_UI_Routing.Index.value)) ])([ Halogen_HTML_Elements.strong_([ Halogen_HTML_Core.text("RandomStr") ]) ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "navbar-burger", "burger" ])), Halogen_HTML_Properties.attr("role")("button"), Halogen_HTML_Properties.attr("aria-label")("menu"), Halogen_HTML_Properties.attr("aria-expanded")("button"), Halogen_HTML_Events.onClick(function (v) {
          return SetMenu.create(!s.isMenuActive);
      }) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "navbar-menu", (function () {
          if (s.isMenuActive) {
              return "is-active";
          };
          return "";
      })() ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "navbar-start" ])) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "navbar-item" ])), Halogen_HTML_Events.onClick(function (v) {
          return new SetMenu(false);
      }), Halogen_HTML_Properties.href(Mkpasswd_UI_Routing.routeHref(Mkpasswd_UI_Routing.Index.value)) ])([ Halogen_HTML_Core.text("Generate") ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "navbar-item" ])), Halogen_HTML_Events.onClick(function (v) {
          return new SetMenu(false);
      }), Halogen_HTML_Properties.href(Mkpasswd_UI_Routing.routeHref(Mkpasswd_UI_Routing.List.value)) ])([ Halogen_HTML_Core.text("Gallery") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "navbar-end" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "navbar-item" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "buttons" ])) ])([  ]) ]) ]) ]) ]) ]);
  };
...
(function($PS) {
  ...
  var menuBtn = function (i) {
      return Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "dropdown-trigger" ])), Halogen_HTML_Properties.attr("aria-label")("more options"), Halogen_HTML_Events.onClick(function (v) {
          return new ToggleMenu(i);
      }) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "icon" ])) ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "fas", "fa-ellipsis-v" ])), Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]) ]) ]);
  };
  var initialState = function (v) {
      return {
          list: v,
  ...
  var footerBtnArea = [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "sticky-bottom", "p1", "is-pulled-right" ])) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "button", "is-dark", "is-rounded" ])), Halogen_HTML_Properties.href(Mkpasswd_UI_Routing.routeHref(Mkpasswd_UI_Routing.New.value)) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "icon" ])) ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "fas", "fa-plus" ])), Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]) ]) ]) ]) ];
  var emptyListView = [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "message" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "message-body", "text-wrap" ])) ])([ Halogen_HTML_Core.text("There is no work") ]) ]) ];
  var dropdownItem = function (mHref) {
      return function (action) {
          return function (icon) {
              return function (label) {
                  return Halogen_HTML_Elements.a(Data_Array.catMaybes([ Data_Maybe.Just.create(Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "dropdown-item" ]))), Data_Functor.map(Data_Maybe.functorMaybe)(function ($24) {
                      ...
                      return action;
                  })) ]))([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "icon" ])) ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "fas", icon ])), Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]) ]), Halogen_HTML_Core.text(label) ]);
              };
          };
      };
  };
  var cardMenu = function (mi) {
      return function (i) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "card-header-icon", "dropdown", "is-right", (function () {
              var $22 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(mi)(new Data_Maybe.Just(i));
              if ($22) {
                  return "is-active";
              };
              return "";
          })() ])) ])([ menuBtn(i), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "dropdown-menu" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "dropdown-content" ])) ])([ dropdownItem(Data_Maybe.Just.create(new Mkpasswd_UI_Routing.Store(i)))(new ToggleMenu(i))("fa-pen-fancy")("edit"), dropdownItem(Data_Maybe.Nothing.value)(new Delete(i))("fa-trash-alt")("remove") ]) ]) ]);
      };
  };
  var accountRow = function (mi) {
      return function (i) {
          return function (fd) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "card", "mb1" ])) ])([ Halogen_HTML_Elements.header([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "card-header" ])) ])([ Halogen_HTML_Elements.h2([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "card-header-title", "text-wrap" ])) ])([ Halogen_HTML_Core.text(fd.account) ]), cardMenu(mi)(i) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "card-content" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "message" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "message-body", "text-wrap" ])) ])([ Halogen_HTML_Core.text(fd.passwd) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "text-wrap" ])) ])([ Halogen_HTML_Core.text(fd.note) ]) ]) ]);
          };
      };
  };
  var _headerNav = Type_Proxy["Proxy"].value;
  var render = function (dictMonadEffect) {
      return function (state) {
          return Halogen_HTML_Elements.main_([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "headerNav";
          }))(Data_Ord.ordUnit)(_headerNav)(Data_Unit.unit)(Mkpasswd_UI_Components_HeaderNav.component)(Data_Unit.unit)(Data_Void.absurd), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "section" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "container" ])) ])(Control_Bind.join(Control_Bind.bindArray)([ (function () {
...
(function($PS) {
  ...
  var runGen = function ($51) {
      return Control_Monad_State.runState(unGen($51));
  };
  ...
  var choose = function (a) {
      return function (b) {
          ...
          return Data_Functor.map(functorGen)((function () {
              var $53 = Data_Semiring.add(Data_Semiring.semiringNumber)(min$prime);
              var $54 = Data_Semiring.mul(Data_Semiring.semiringNumber)(max$prime - min$prime);
              return function ($55) {
                  return unscale($53($54($55)));
              };
          })())(uniform);
      };
  };
...
(function($PS) {
  ...
  var genPassword = function (v) {
      var requiredLength = Data_Foldable.sum(Data_Array_NonEmpty_Internal.foldableNonEmptyArray)(Data_Semiring.semiringInt)(Data_Functor.map(Data_Array_NonEmpty_Internal.functorNonEmptyArray)(Data_Tuple.fst)(v.required));
      var remain = Data_Ord.max(Data_Ord.ordInt)(0)(v.length - requiredLength | 0);
      var genAll = Test_QuickCheck_Gen.oneOf(Data_Functor.map(Data_Array_NonEmpty_Internal.functorNonEmptyArray)(Data_Tuple.snd)(v.required));
      return Control_Bind.bind(Test_QuickCheck_Gen.bindGen)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Test_QuickCheck_Gen.applicativeGen)(Data_Tuple.uncurry(Test_QuickCheck_Gen.vectorOf))(Data_Array.cons(new Data_Tuple.Tuple(remain, genAll))(Data_Array_NonEmpty.toArray(v.required))))(function (charsets) {
...
(function($PS) {
  ...
  var formInput = function (dictMonadAff) {
      return function (disabled) {
          var transformAllowedSymbols = Formless_Validation.hoistFnE_((dictMonadAff.MonadEffect0()).Monad0())(function (arr) {
              var seed = Data_Array_NonEmpty.fromArray(Data_Array.catMaybes(Data_Functor.map(Data_Functor.functorArray)(Data_Switch.toMaybe)(arr)));
              return Data_Either.note([ EmptyCharSet.value ])(seed);
          });
          return {
              allChk: true,
              isOpen: false,
  ...
  var _allowedSymbols = Type_Proxy["Proxy"].value;
  var handleAction = function (dictMonadAff) {
      return function (v) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          return Formless_Component.handleAction(dictMonadAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                              ...
                              return "allowedSymbols";
                          }))()(Formless_Internal_Transform.formFieldsToMaybeOutputNil)())()()()()()()()()()(handleAction(dictMonadAff))(Formless_Component.raiseResult()(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                              return "allowedSymbols";
                          }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField()))(Heterogeneous_Mapping.mapRecordWithIndexNil)()())))(Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                              return "allowedSymbols";
          ...
          throw new Error("Failed pattern match at Mkpasswd.UI.Components.MultiChkboxes (line 95, column 16 - line 112, column 93): " + [ v.constructor.name ]);
      };
  };
  var render = function (dictMonadAff) {
      return function (fstate) {
          ...
          var errorDisplay = function (err) {
              return Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "help", "is-danger" ])) ])(Data_Functor.map(Data_Functor.functorArray)(function (msg) {
              ...
              return function (isChked) {
                  return function (onChange) {
                      return function (textElem) {
                          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "field" ])) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "controll" ])) ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "checkbox" ])) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Properties.checked(isChked), Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "mr1" ])), Halogen_HTML_Properties.disabled(isDisabled), Halogen_HTML_Events.onChange(onChange) ]), textElem ]) ]) ]);
                      };
                  };
              };
          };
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "card" ])) ])([ Halogen_HTML_Elements.header([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "card-header" ])), Halogen_HTML_Events.onClick(function (v) {
              return Formless_Action.injAction(ToggleOpen.value);
          }) ])([ Halogen_HTML_Elements.p([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "card-header-title" ])) ])([ Halogen_HTML_Core.text("Individual symbol") ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "card-header-icon" ])), Halogen_HTML_Properties.attr("aria-label")("more options") ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "icon" ])) ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "fas", "fa-angle-down" ])), Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]) ]) ]) ]), (function () {
              var v = Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
                  return "allowedSymbols";
              }))()()(_allowedSymbols)(fstate.form);
              if (v instanceof Data_Maybe.Just) {
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "card-content" ])) ])([ errorDisplay(new Data_Maybe.Just(v.value0)) ]);
              };
              if (v instanceof Data_Maybe.Nothing) {
              ...
              if (fstate.isOpen) {
                  return Halogen_HTML_Elements.fieldset([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "card-content" ])), Halogen_HTML_Properties.disabled(fstate.disabled) ])(Data_Array.cons(checkboxRow(fstate.disabled)(fstate.allChk)(function (v) {
                      return Formless_Action.injAction(ToggleAllChk.value);
                      ...
                      return "allowedSymbols";
                  }))()()(_allowedSymbols)(fstate.form))(function (i) {
                      return function (c) {
                          return checkboxRow(fstate.disabled)(Data_Switch.isOn(c))(function (v) {
                              return Formless_Action.injAction(new ToggleCharSwtich(i));
  ...
  var component = function (dictMonadAff) {
      return Formless_Component.component(dictMonadAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
          ...
          return "allowedSymbols";
      }))(Formless_Class_Initial.initialArray)()(Formless_Transform_Row.mkInputFieldsFromRowNil)())()()()()()()()()()()()()()()()()()(formInput(dictMonadAff))({
          ...
          receive: function ($38) {
              return Data_Maybe.Just.create(SetDisabled.create($38));
          },
...
(function($PS) {
  ...
  var showFieldType = new Data_Show.Show(Data_Show_Generic.genericShow(genericFieldType)(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function () {
      return "PasswdLength";
  ...
  var _numUpper = Type_Proxy["Proxy"].value;
  var _numSymbol = Type_Proxy["Proxy"].value;
  var _numLower = Type_Proxy["Proxy"].value;
  var _numDigit = Type_Proxy["Proxy"].value;
  var _multichkboxes = Type_Proxy["Proxy"].value;
  var _length = Type_Proxy["Proxy"].value;
  var _isUseUpper = Type_Proxy["Proxy"].value;
  var _isUseSymbol = Type_Proxy["Proxy"].value;
  var _isUseLower = Type_Proxy["Proxy"].value;
  var _isUseDigit = Type_Proxy["Proxy"].value;
  var formInput = function (dictMonad) {
      var isInt = Formless_Validation.hoistFnE_(dictMonad)((function () {
          var $100 = Data_Either.note([ TypeMismatch.value ]);
          return function ($101) {
      ...
      var enoughLong = Formless_Validation.hoistFnE(dictMonad)(function (form) {
          return function (len) {
              var requiredLength = Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringInt)(Data_Array.catMaybes([ Formless_Retrieve.getOutput(new Data_Symbol.IsSymbol(function () {
                  return "numDigit";
              }))()()(_numDigit)(form), Formless_Retrieve.getOutput(new Data_Symbol.IsSymbol(function () {
                  return "numUpper";
              }))()()(_numUpper)(form), Formless_Retrieve.getOutput(new Data_Symbol.IsSymbol(function () {
                  return "numLower";
              }))()()(_numLower)(form), Formless_Retrieve.getOutput(new Data_Symbol.IsSymbol(function () {
                  return "numSymbol";
              }))()()(_numSymbol)(form) ]));
      ...
      var atLeastOneTrue = Formless_Validation.hoistFnE(dictMonad)(function (form) {
          return function (v) {
              return chk(EmptyCharSet.value)(Control_Category.identity(Control_Category.categoryFn))(Data_Foldable.or(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)([ Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                  return "isUseDigit";
              }))()()(_isUseDigit)(form), Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                  return "isUseUpper";
              }))()()(_isUseUpper)(form), Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                  return "isUseLower";
              }))()()(_isUseLower)(form), Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                  return "isUseSymbol";
              }))()()(_isUseSymbol)(form) ]));
          };
      });
  ...
  var _isNonEmpty = Type_Proxy["Proxy"].value;
  var spec = function (dictMonadAff) {
      var toPaswdPolicy = function (conf) {
          return function (allowedSymbols) {
              var seed = Data_Array_NonEmpty.fromArray(Data_Array.catMaybes(Data_Functor.map(Data_Functor.functorArray)(Data_Switch.toMaybe)([ Data_Switch.toSwitch(conf.isUseDigit)(new Data_Tuple.Tuple(conf.numDigit, Data_Char_Gen.genDigitChar(Test_QuickCheck_Gen.monadGenGen))), Data_Switch.toSwitch(conf.isUseUpper)(new Data_Tuple.Tuple(conf.numUpper, Data_Char_Gen.genAlphaUppercase(Test_QuickCheck_Gen.monadGenGen))), Data_Switch.toSwitch(conf.isUseLower)(new Data_Tuple.Tuple(conf.numLower, Data_Char_Gen.genAlphaLowercase(Test_QuickCheck_Gen.monadGenGen))), Data_Switch.toSwitch(conf.isUseSymbol)(Data_Tuple.Tuple.create(conf.numSymbol)(Test_QuickCheck_Gen.elements(allowedSymbols))) ])));
              return Data_Functor.map(Data_Maybe.functorMaybe)(function (v) {
                  return {
                      length: conf.length,
                      required: v
              ...
              return function (isUsed) {
                  return function (inp) {
                      return function (onInput) {
                          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "control", "is-expanded" ])) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.id(Data_Show.show(showFieldType)(fieldType)), Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "input", (function () {
                              if (hasErr) {
                                  return "is-danger";
                              };
                              return "";
      ...
      var inputAddon = function (isUsed) {
          return function (onChecked) {
              return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "control" ])) ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "button", "checkbox" ])) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Properties.checked(isUsed), Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "mr1" ])), Halogen_HTML_Events.onChecked(onChecked) ]) ]) ]);
          };
      };
      ...
      var labelBlock = function (fieldType) {
          return Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"](Data_Show.show(showFieldType)(fieldType)), Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "label" ])) ])([ Halogen_HTML_Core.text(fieldLabelText(fieldType)) ]);
      };
      var handleAction = function (v) {
          ...
          if (v.value0 instanceof SymbolCharNum) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)($$eval(Formless_Action.set(new Data_Symbol.IsSymbol(function () {
                  return "isUseSymbol";
              }))()()(_isUseSymbol)(v.value1)))(function () {
                  return $$eval(Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                      return "isNonEmpty";
                  }))()()(_isNonEmpty)(v.value1));
              });
      ...
      var $$eval = function (act) {
          return Formless_Component.handleAction(dictMonadAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              ...
              return "numUpper";
          }))()(Formless_Internal_Transform.formFieldsToMaybeOutputNil)())())())())())())())())())())()()()()()()()()()(handleAction)(Formless_Component.raiseResult()(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
              return "isNonEmpty";
              ...
              return "numUpper";
          }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField()))(Heterogeneous_Mapping.mapRecordWithIndexNil)()())()())()())()())()())()())()())()())()())()())))(act);
      };
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)($$eval(Formless_Action.validateAll))(function () {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  var conf = Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(function (v1) {
                      ...
                      return "length";
                  }))()()(_length)(form)))(Formless_Retrieve.getOutput(new Data_Symbol.IsSymbol(function () {
                      return "isNonEmpty";
                  }))()()(_isNonEmpty)(form)))(Formless_Retrieve.getOutput(new Data_Symbol.IsSymbol(function () {
                      return "numDigit";
                  }))()()(_numDigit)(form)))(Formless_Retrieve.getOutput(new Data_Symbol.IsSymbol(function () {
                      return "isUseDigit";
                  }))()()(_isUseDigit)(form)))(Formless_Retrieve.getOutput(new Data_Symbol.IsSymbol(function () {
                      return "numLower";
                  }))()()(_numLower)(form)))(Formless_Retrieve.getOutput(new Data_Symbol.IsSymbol(function () {
                      return "isUseLower";
                  }))()()(_isUseLower)(form)))(Formless_Retrieve.getOutput(new Data_Symbol.IsSymbol(function () {
                      return "numUpper";
                  }))()()(_numUpper)(form)))(Formless_Retrieve.getOutput(new Data_Symbol.IsSymbol(function () {
                      return "isUseUpper";
                  }))()()(_isUseUpper)(form)))(Formless_Retrieve.getOutput(new Data_Symbol.IsSymbol(function () {
                      return "numSymbol";
                  }))()()(_numSymbol)(form)))(Formless_Retrieve.getOutput(new Data_Symbol.IsSymbol(function () {
                      return "isUseSymbol";
                  }))()()(_isUseSymbol)(form));
                  ...
                  }))(Data_Ord.ordUnit)(_multichkboxes)(Data_Unit.unit)(Formless_Query.submitReply))(function (mCharSet) {
                      var mAllowedSymbols = Data_Functor.map(Data_Maybe.functorMaybe)((function () {
                          var $102 = Formless_Transform_Record.unwrapOutputFields()(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                              return "allowedSymbols";
                          }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField()))(Heterogeneous_Mapping.mapRecordWithIndexNil)()()));
                          return function ($103) {
                              return (function (v1) {
          ...
          return function (err) {
              return function (isUsed) {
                  return function (inp) {
                      return function (onChecked) {
                          return function (onInput) {
                              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "field" ])) ])([ labelBlock(fieldType), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "field", "has-addons" ])) ])([ inputAddon(isUsed)(onChecked), inputNumberForm(fieldType)(Data_Maybe.isJust(err))(isUsed)(inp)(onInput) ]), errorDisplay(err) ]);
                          };
                      };
                  };
              };
      ...
      var render = function (fstate) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "container" ])) ])([ (function () {
              var err = Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
                  return "length";
              }))()()(_length)(fstate.form);
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "field" ])) ])([ labelBlock(PasswdLength.value), inputNumberForm(PasswdLength.value)(Data_Maybe.isJust(err))(true)(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                  return "length";
              }))()()(_length)(fstate.form))(Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                  return "length";
              }))()()(_length)), errorDisplay(err) ]);
          })(), inputFormGroup(DigitCharNum.value)(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
              return "numDigit";
          }))()()(_numDigit)(fstate.form))(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "isUseDigit";
          }))()()(_isUseDigit)(fstate.form))(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "numDigit";
          }))()()(_numDigit)(fstate.form))((function () {
              var $104 = ToggleCharSetUse.create(DigitCharNum.value);
              return function ($105) {
                  return Formless_Action.injAction($104($105));
              };
          })())(Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
              return "numDigit";
          }))()()(_numDigit)), inputFormGroup(AlphaUppercase.value)(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
              return "numUpper";
          }))()()(_numUpper)(fstate.form))(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "isUseUpper";
          }))()()(_isUseUpper)(fstate.form))(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "numUpper";
          }))()()(_numUpper)(fstate.form))((function () {
              var $106 = ToggleCharSetUse.create(AlphaUppercase.value);
              return function ($107) {
                  return Formless_Action.injAction($106($107));
              };
          })())(Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
              return "numUpper";
          }))()()(_numUpper)), inputFormGroup(AlphaLowercaseNum.value)(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
              return "numLower";
          }))()()(_numLower)(fstate.form))(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "isUseLower";
          }))()()(_isUseLower)(fstate.form))(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "numLower";
          }))()()(_numLower)(fstate.form))((function () {
              var $108 = ToggleCharSetUse.create(AlphaLowercaseNum.value);
              return function ($109) {
                  return Formless_Action.injAction($108($109));
              };
          })())(Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
              return "numLower";
          }))()()(_numLower)), inputFormGroup(SymbolCharNum.value)(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
              return "numSymbol";
          }))()()(_numSymbol)(fstate.form))(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "isUseSymbol";
          }))()()(_isUseSymbol)(fstate.form))(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "numSymbol";
          }))()()(_numSymbol)(fstate.form))((function () {
              var $110 = ToggleCharSetUse.create(SymbolCharNum.value);
              return function ($111) {
                  return Formless_Action.injAction($110($111));
              };
          })())(Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
              return "numSymbol";
          }))()()(_numSymbol)), errorDisplay(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
              return "isNonEmpty";
          }))()()(_isNonEmpty)(fstate.form)), Halogen_HTML.slot_()(new Data_Symbol.IsSymbol(function () {
              return "multichkboxes";
  ...
  var component = function (dictMonadAff) {
      var resultModal = function (mPasswd) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "modal", (function () {
              var $89 = Data_Maybe.isJust(mPasswd);
              if ($89) {
                  return "is-active";
              };
              return "";
          })() ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "modal-background" ])), Halogen_HTML_Events.onClick(function (v) {
              return Clear.value;
          }) ])([  ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "modal-card" ])) ])([ Halogen_HTML_Elements.header([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "modal-card-head" ])) ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "modal-card-title" ])) ])([ Halogen_HTML_Core.text("Result") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "delete" ])), Halogen_HTML_Properties.attr("aria-label")("close"), Halogen_HTML_Events.onClick(function (v) {
              return Clear.value;
          }) ])([  ]) ]), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "modal-card-body" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "level" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "level-item", "has-text-centered", "is-size-3", "text-wrap" ])) ])([ Halogen_HTML_Elements.br_, Halogen_HTML_Core.text(Data_Maybe.fromMaybe("")(mPasswd)), Halogen_HTML_Elements.br_ ]) ]) ]), Halogen_HTML_Elements.footer([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "modal-card-foot" ])) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "button", "is-dark" ])), Halogen_HTML_Events.onClick(function (v) {
              return Save.value;
          }), Halogen_HTML_Properties.href(Mkpasswd_UI_Routing.routeHref(Mkpasswd_UI_Routing.New.value)) ])([ Halogen_HTML_Core.text("Save") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "button" ])), Halogen_HTML_Events.onClick(function (v) {
      ...
      var handleAction = function (v) {
          if (v instanceof Clear) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $91.passwd = Data_Maybe.Nothing.value;
                  return $91;
              });
          };
          if (v instanceof Generate) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.request()(new Data_Symbol.IsSymbol(function () {
                  return "formless";
              }))(Data_Ord.ordUnit)(Formless_Types_Component["_formless"])(Data_Unit.unit)((function () {
                  var $112 = Formless_Query.injQuery(functorPasswdConfigQuery);
                  return function ($113) {
                      return $112(GetPasswdPolicy.create($113));
                  };
              })()))(function (mRes) {
      ...
      var footerBtnArea = Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "level", "sticky-bottom", "box" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "level-item" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "field", "is-grouped" ])) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "control" ])) ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "button", "is-dark" ])), Halogen_HTML_Events.onClick(function (v) {
          return Generate.value;
      }) ])([ Halogen_HTML_Core.text("Generate") ]) ]) ]) ]) ]);
      var render = function (state) {
          return Halogen_HTML_Elements.main([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ (function () {
              var $99 = Data_Maybe.isJust(state.passwd);
              if ($99) {
                  return "is-clipped";
              };
              return "";
              ...
              return "headerNav";
          }))(Data_Ord.ordUnit)(_headerNav)(Data_Unit.unit)(Mkpasswd_UI_Components_HeaderNav.component)(Data_Unit.unit)(Data_Void.absurd), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "section" ])) ])([ Halogen_HTML.slot_()(new Data_Symbol.IsSymbol(function () {
              return "formless";
              ...
              return "numUpper";
          }))(Formless_Class_Initial.initialString)()(Formless_Transform_Row.mkInputFieldsFromRowNil)())())())())())())())())())())()()()()()()()()()()()()()()()()()(Data_Function["const"](formInput((dictMonadAff.MonadEffect0()).Monad0())))(spec(dictMonadAff)))(Data_Unit.unit) ]), footerBtnArea, resultModal(state.passwd) ]);
      };
      return Halogen_Component.mkComponent({
          initialState: initialState,
          render: render,
...
(function($PS) {
      ...
      return function (dictMonadAff) {
          ...
          var labelBlock = function (fieldType) {
              return function (labelTxt) {
                  return Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"](Data_Show.show(showFieldType)(fieldType)), Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "label" ])) ])([ Halogen_HTML_Core.text(labelTxt) ]);
              };
          };
          ...
          var render = function (fstate) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "container" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "field" ])) ])([ labelBlock(AccountInput.value)("Title"), inputTextForm(AccountInput.value)(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
                  return "account";
              }))()()(Type_Proxy["Proxy"].value)(fstate.form))(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                  return "account";
              }))()()(Type_Proxy["Proxy"].value)(fstate.form))(Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                  return "account";
              }))()()(Type_Proxy["Proxy"].value)), errorDisplay(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
                  return "account";
              }))()()(Type_Proxy["Proxy"].value)(fstate.form)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "field" ])) ])([ labelBlock(Passwdinput.value)("The Work"), inputTextForm(Passwdinput.value)(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
                  return "passwd";
              }))()()(Type_Proxy["Proxy"].value)(fstate.form))(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                  return "passwd";
              }))()()(Type_Proxy["Proxy"].value)(fstate.form))(Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "passwd";
              }))()()(Type_Proxy["Proxy"].value)(fstate.form)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "field" ])) ])([ labelBlock(NoteTextarea.value)("Description"), textAreaForm(NoteTextarea.value)(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
                  return "note";
              }))()()(Type_Proxy["Proxy"].value)(fstate.form))(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                  return "note";
              }))()()(Type_Proxy["Proxy"].value)(fstate.form))(Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "note";
              }))()()(Type_Proxy["Proxy"].value)(fstate.form)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "field", "is-grouped" ])) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "control" ])) ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "button", "is-dark" ])), Halogen_HTML_Events.onClick(function (v) {
                  return Formless_Action.submit;
              }) ])([ Halogen_HTML_Core.text("Save") ]) ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "control" ])) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "button" ])), Halogen_HTML_Properties.href(Mkpasswd_UI_Routing.routeHref(Mkpasswd_UI_Routing.List.value)) ])([ Halogen_HTML_Core.text("Cancel") ]) ]) ]) ]);
          };
          return {
              render: render,
  ...
  var formInput = function (dictMonad) {
      return function (fd) {
          ...
          return {
              initialInputs: Data_Functor.map(Data_Maybe.functorMaybe)(Formless_Transform_Record.wrapInputFields()(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                  return "account";
              }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.wrapField()))(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                  return "note";
              }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.wrapField()))(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                  return "passwd";
              }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.wrapField()))(Heterogeneous_Mapping.mapRecordWithIndexNil)()())()())()())))(fd),
              validators: {
  ...
  var component = function (dictMonadAff) {
      var render = function (state) {
          return Halogen_HTML_Elements.main_([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "headerNav";
          }))(Data_Ord.ordUnit)(_headerNav)(Data_Unit.unit)(Mkpasswd_UI_Components_HeaderNav.component)(Data_Unit.unit)(Data_Void.absurd), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)([ "section" ])) ])([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "formless";
              ...
              return "passwd";
          }))(Formless_Class_Initial.initialString)()(Formless_Transform_Row.mkInputFieldsFromRowNil)())())())()()()()()()()()()()()()()()()()()(formInput((dictMonadAff.MonadEffect0()).Monad0()))(spec((dictMonadAff.MonadEffect0()).Monad0())(dictMonadAff)))(state)(HandleFormless.create) ]) ]);
      };
...
(function($PS) {
  ...
  var _storePage = Type_Proxy["Proxy"].value;
  var _listPage = Type_Proxy["Proxy"].value;
  var _indexPage = Type_Proxy["Proxy"].value;
  var component = function (dictMonadAff) {
      var render = function (v) {
          if (v.route instanceof Mkpasswd_UI_Routing.Index) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "indexPage";
              }))(Data_Ord.ordUnit)(_indexPage)(Data_Unit.unit)(Mkpasswd_UI_Pages_Mkpasswd.component(dictMonadAff))(Data_Unit.unit)(Mkpasswd.create);
          };
          if (v.route instanceof Mkpasswd_UI_Routing.List) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "listPage";
              }))(Data_Ord.ordUnit)(_listPage)(Data_Unit.unit)(Mkpasswd_UI_Pages_List.component(dictMonadAff.MonadEffect0()))(v.storage)(Delete.create);
          };
          if (v.route instanceof Mkpasswd_UI_Routing.New) {
              ...
              })(v.passwd))(Save.create);
          };
          if (v.route instanceof Mkpasswd_UI_Routing.Store) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "storePage";
              }))(Data_Ord.ordUnit)(_storePage)(Data_Unit.unit)(Mkpasswd_UI_Pages_Store.component(dictMonadAff))(Data_Array.index(v.storage)(v.route.value0))(Save.create);
          };
          throw new Error("Failed pattern match at Mkpasswd.UI (line 75, column 39 - line 79, column 79): " + [ v.route.constructor.name ]);
      };
      var initialState = function (v) {
          return {
