...
(function($PS) {
  ...
  var ModifyValidate = (function () {
      function ModifyValidate(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      ModifyValidate.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new ModifyValidate(value0, value1, value2);
              };
          };
      };
              ...
              return function (post) {
                  return function (last) {
                      var readRef = function (dictMonadAff1) {
                          return function ($32) {
                              return Effect_Class.liftEffect(dictMonadAff1.MonadEffect0())(Data_Functor.map(Effect.functorEffect)(Control_Bind.join(Data_Maybe.bindMaybe))(Data_Traversable.traverse(Data_Traversable.traversableMaybe)(Effect.applicativeEffect)(Effect_Ref.read)($32)));
                          };
                      };
                      ...
                      var killFiber$prime = function (dictMonadAff1) {
                          return function ($33) {
                              return Effect_Aff_Class.liftAff(dictMonadAff1)(Effect_Aff.killFiber(Effect_Exception.error("time's up!"))($33));
                          };
                      };
                              ...
                              return function (maybeLast) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
                                      ...
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(readRef(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff1))(ref))(function (v1) {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Foldable.traverse_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(function (v2) {
                                              return Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)((dictMonadAff1.MonadEffect0()).Monad0())(v2(Effect_Exception.error("new action")));
                                          })(v1))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff1.MonadEffect0()))(Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(Effect_Ref.write(Data_Maybe.Nothing.value))(ref)))(function () {
                                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.fork(dictMonadAff1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(process)(function (v2) {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.modifyState_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                                          ...
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff1.MonadEffect0()))(Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(Effect_Ref.write(Data_Maybe.Nothing.value))(ref)))(function () {
                                                              return Data_Foldable.traverse_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(Control_Category.identity(Control_Category.categoryFn))(maybeLast);
                                                          });
                                                      });
                                                  })))(function (v2) {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff1.MonadEffect0()))(Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(Effect_Ref.write(new Data_Maybe.Just(v2)))(ref)))(function () {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bindFlipped(Halogen_Query_HalogenM.bindHalogenM)(Data_Foldable.traverse_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(function (f) {
                              return Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)((dictMonadAff.MonadEffect0()).Monad0())(f(Effect_Exception.error("times' up!")));
                          }))(readRef(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(vdRef)))(function () {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Data_Functor.map(Effect.functorEffect)(Control_Bind.join(Data_Maybe.bindMaybe))(Data_Traversable.traverse(Data_Traversable.traversableMaybe)(Effect.applicativeEffect)(Effect_Ref.read)(dbRef))))(function (v1) {
                                      ...
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff_AVar.empty))(function (v2) {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(mkFiber(v2))(function (v3) {
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.fork(dictMonadAff)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff_AVar.take(v2)))(function (v4) {
                                                  ...
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(Effect_Ref.write(new Data_Maybe.Just({
                                                      "var": v2,
                                                      fiber: v3
                                                  })))(dbRef)))(function () {
                                  ...
                                  if (v1 instanceof Data_Maybe.Just) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(killFiber$prime(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(v1.value0.fiber)))(function () {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(mkFiber(v1["value0"]["var"]))(function (v2) {
                                              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(Effect_Ref.write(new Data_Maybe.Just({
                                                  "var": v1["value0"]["var"],
                                                  fiber: v2
                                              })))(dbRef));
                                          });
                                  ...
                                  throw new Error("Failed pattern match at Formless.Internal.Debounce (line 41, column 3 - line 58, column 71): " + [ v1.constructor.name ]);
                              });
                          });
                      });
                  };
                                                                                      ...
                                                                                      return function (dictNewtype7) {
                                                                                          var initialState = function (v) {
                                                                                              return Control_Comonad_Store.store(v.render)({
                                                                                                  ...
                                                                                                  submitAttempts: 0,
                                                                                                  submitting: false,
                                                                                                  form: Formless_Internal_Transform.inputFieldsToFormFields(dictRowToList)(dictInputFieldsToFormFields)(dictNewtype)(dictNewtype2)(v.initialInputs),
                                                                                                  internal: {
                                                                                                      allTouched: false,
                                                                                          ...
                                                                                          var runSubmit = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.modifyState(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                                                              ...
                                                                                              $79.submitAttempts = st.submitAttempts + 1 | 0;
                                                                                              $79.submitting = true;
                                                                                              return $79;
                                                                                          }))(function (v) {
                                                                                              ...
                                                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(!internal.allTouched)(Renderless_State.modifyState_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                                                                                  ...
                                                                                                  $83.form = Formless_Internal_Transform.setFormFieldsTouched(dictRowToList1)(dictSetFormFieldsTouched)(dictNewtype2)(v.form);
                                                                                                  $83.internal = Data_Newtype.over(Formless_Types_Component.newtypeInternalState)(Formless_Types_Component.newtypeInternalState)(Formless_Types_Component.InternalState)(function (v2) {
                                                                                                      return {
                                                                                                          allTouched: true,
                                                                                                      ...
                                                                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.modifyState_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                                                                              ...
                                                                                                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)((function () {
                                                                                                                  var $90 = Data_Eq.eq(Formless_Types_Component.eqValidStatus)(v2.validity)(Formless_Types_Component.Valid.value);
                                                                                                                  if ($90) {
                                                                                                                      return Formless_Internal_Transform.formFieldsToMaybeOutputFields(dictRowToList1)(dictNewtype2)(dictNewtype3)(dictFormFieldToMaybeOutput)(v2.form);
                                                                                                                  };
                                                                                                                  return Data_Maybe.Nothing.value;
                                                                                                              })());
                                                                                                          });
                                                                                          ...
                                                                                          var $$eval = function (v) {
                                                                                                  ...
                                                                                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Ref["new"](Data_Maybe.Nothing.value)))(function (v1) {
                                                                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Ref["new"](Data_Maybe.Nothing.value)))(function (v2) {
                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.modifyState_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                                                                              ...
                                                                                                              $94.internal = Data_Newtype.over(Formless_Types_Component.newtypeInternalState)(Formless_Types_Component.newtypeInternalState)(Formless_Types_Component.InternalState)(function (v4) {
                                                                                                                  return {
                                                                                                                      debounceRef: new Data_Maybe.Just(v1),
                                                                                                                      validationRef: new Data_Maybe.Just(v2),
                                                                                                                      allTouched: v4.allTouched,
                                                                                              ...
                                                                                              if (v instanceof Formless_Types_Component.Modify) {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.modifyState_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                                                                      ...
                                                                                                      $98.form = Formless_Internal_Transform.unsafeModifyInputVariant(dictNewtype6)(dictNewtype2)(Control_Category.identity(Control_Category.categoryFn))(v.value0)(st.form);
                                                                                                      return $98;
                                                                                                  }))(function () {
                                                                                              ...
                                                                                              if (v instanceof Formless_Types_Component.Validate) {
                                                                                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                                                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)((dictMonadAff.MonadEffect0()).Monad0())(Formless_Internal_Transform.unsafeRunValidationVariant((dictMonadAff.MonadEffect0()).Monad0())(dictNewtype7)(dictNewtype2)(dictNewtype4)(v.value0)((Data_Newtype.unwrap(Formless_Types_Component.newtypeInternalState)(v1.internal)).validators)(v1.form)))(function (v2) {
                                                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.modifyState_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                                                                                              var $105 = {};
                                                                                                              for (var $106 in v3) {
                                                                                              ...
                                                                                              if (v instanceof Formless_Types_Component.ModifyValidate) {
                                                                                                  var validate = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                                                                                  ...
                                                                                                  var modifyWith = function (f) {
                                                                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.modifyState(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                                                                          ...
                                                                                                          $115.form = Formless_Internal_Transform.unsafeModifyInputVariant(dictNewtype6)(dictNewtype2)(f)(v.value1)(st.form);
                                                                                                          return $115;
                                                                                                      }))(function (v1) {
                                                                                                  ...
                                                                                                  if (v.value0 instanceof Data_Maybe.Nothing) {
                                                                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(modifyWith(Control_Category.identity(Control_Category.categoryFn)))(function (v1) {
                                                                                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(validate)(function (v2) {
                                                                                                              return $$eval(new Formless_Types_Component.SyncFormData(v.value2));
                                                                                                          });
                                                                                                      });
                                                                                                  };
                                                                                                  if (v.value0 instanceof Data_Maybe.Just) {
                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Formless_Internal_Debounce.debounceForm(dictMonadAff)(v.value0.value0)(modifyWith(Control_Category.identity(Control_Category.categoryFn)))(Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(modifyWith(Data_Function["const"](Formless_Data_FormFieldResult.Validating.value)))(validate))($$eval(new Formless_Types_Component.SyncFormData(v.value2))))(function () {
                                                                                                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value2);
                                                                                                      });
                                                                                                  };
                                                                                                  throw new Error("Failed pattern match at Formless.Component (line 129, column 7 - line 140, column 17): " + [ v.value0.constructor.name ]);
                                                                                              };
                                                                                              if (v instanceof Formless_Types_Component.Reset) {
                                                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.modifyState_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                                                                      ...
                                                                                                      $124.form = Formless_Internal_Transform.unsafeModifyInputVariant(dictNewtype6)(dictNewtype2)(Control_Category.identity(Control_Category.categoryFn))(v.value0)(st.form);
                                                                                                      $124.internal = Data_Newtype.over(Formless_Types_Component.newtypeInternalState)(Formless_Types_Component.newtypeInternalState)(Formless_Types_Component.InternalState)(function (v2) {
                                                                                                          return {
                                                                                                              allTouched: false,
                                                                                                              debounceRef: v2.debounceRef,
                                                                                                              initialInputs: v2.initialInputs,
                                                                                              ...
                                                                                              if (v instanceof Formless_Types_Component.SetAll) {
                                                                                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.modifyState(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                                                                      return {
                                                                                                          form: Formless_Internal_Transform.replaceFormFieldInputs(dictRowToList1)(dictReplaceFormFieldInputs)(dictNewtype)(dictNewtype2)(v.value0)(st.form),
                                                                                                          dirty: st.dirty,
                                                                                                          errors: st.errors,
                                                                                              ...
                                                                                              if (v instanceof Formless_Types_Component.ModifyAll) {
                                                                                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.modifyState(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                                                                      return {
                                                                                                          form: Formless_Internal_Transform.modifyAll(dictRowToList1)(dictModifyAll)(dictNewtype1)(dictNewtype2)(v.value0)(st.form),
                                                                                                          dirty: st.dirty,
                                                                                                          errors: st.errors,
                                                                                                          internal: st.internal,
                                                                                                          submitAttempts: st.submitAttempts,
                                                                                              ...
                                                                                              if (v instanceof Formless_Types_Component.Submit) {
                                                                                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(runSubmit)(function (v1) {
                                                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Foldable.traverse_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(function ($171) {
                                                                                                          return Halogen_Query_HalogenM.raise(Formless_Types_Component.Submitted.create($171));
                                                                                                      })(v1))(function () {
                                                                                                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                                                                                                      });
                                                                                                  });
                                                                                              ...
                                                                                              if (v instanceof Formless_Types_Component.ResetAll) {
                                                                                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.modifyState(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                                                                      return {
                                                                                                          ...
                                                                                                          submitAttempts: 0,
                                                                                                          submitting: false,
                                                                                                          form: Formless_Internal_Transform.replaceFormFieldInputs(dictRowToList1)(dictReplaceFormFieldInputs)(dictNewtype)(dictNewtype2)((Data_Newtype.unwrap(Formless_Types_Component.newtypeInternalState)(st.internal)).initialInputs)(st.form),
                                                                                                  ...
                                                                                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                                                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Renderless_State.modifyState(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                                                                                          return {
                                                                                                              ...
                                                                                                              submitAttempts: 0,
                                                                                                              submitting: false,
                                                                                                              form: Formless_Internal_Transform.replaceFormFieldInputs(dictRowToList1)(dictReplaceFormFieldInputs)(dictNewtype)(dictNewtype2)(v.value0)(v1.form),
                                                                                                              internal: Data_Newtype.over(Formless_Types_Component.newtypeInternalState)(Formless_Types_Component.newtypeInternalState)(Formless_Types_Component.InternalState)(function (v3) {
                                                                                                                  return {
                                                                                                                      ...
                                                                                                                      debounceRef: v3.debounceRef,
                                                                                                                      validationRef: v3.validationRef,
                                                                                              ...
                                                                                              throw new Error("Failed pattern match at Formless.Component (line 85, column 10 - line 268, column 13): " + [ v.constructor.name ]);
                                                                                          };
  ...
  var setValidate = function (dictIsSymbol) {
      return function (dictNewtype) {
          return function (dictCons) {
              return function (sym) {
                  return function (i) {
                      return Formless_Types_Component.ModifyValidate.create(Data_Maybe.Nothing.value)(Data_Newtype.wrap(dictNewtype)(Data_Variant.inj(dictCons)(dictIsSymbol)(sym)(Data_Newtype.wrap(Formless_Types_Form.newtypeInputFunction)(Data_Function["const"](i)))));
                  };
              };
          };
      };
...
(function($PS) {
  ...
  exports["_FieldOutput"] = _FieldOutput;
})(PS);
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
  $PS["Mkpasswd.UI.Components.HeaderNav"] = $PS["Mkpasswd.UI.Components.HeaderNav"] || {};
  var exports = $PS["Mkpasswd.UI.Components.HeaderNav"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Function = $PS["Data.Function"];
  ...
  var SetMenu = (function () {
      function SetMenu(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetMenu.create = function (value0) {
          return function (value1) {
              return new SetMenu(value0, value1);
          };
      };
      return SetMenu;
  })();
  var render = function (s) {
      return Halogen_HTML_Elements.nav([ Mkpasswd_Halogen_Util.classes([ "navbar", "is-fixed-top", "is-dark" ]), Halogen_HTML_Properties.attr("role")("navigation"), Halogen_HTML_Properties.attr("aria-label")("main navigation") ])([ Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "container" ]) ])([ Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "navbar-brand" ]) ])([ Halogen_HTML_Elements.a([ Mkpasswd_Halogen_Util.classes([ "navbar-item" ]), Halogen_HTML_Properties.href(Mkpasswd_UI_Routing.routeHref(Mkpasswd_UI_Routing.Index.value)) ])([ Halogen_HTML_Elements.strong_([ Halogen_HTML_Core.text("RandomStr") ]) ]), Halogen_HTML_Elements.a([ Mkpasswd_Halogen_Util.classes([ "navbar-burger", "burger" ]), Halogen_HTML_Properties.attr("role")("button"), Halogen_HTML_Properties.attr("aria-label")("menu"), Halogen_HTML_Properties.attr("aria-expanded")("button"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SetMenu.create(!s.isMenuActive))) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]) ]) ]), Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "navbar-menu", (function () {
          if (s.isMenuActive) {
              return "is-active";
          };
          return "";
      })() ]) ])([ Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "navbar-start" ]) ])([ Halogen_HTML_Elements.a([ Mkpasswd_Halogen_Util.classes([ "navbar-item" ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SetMenu.create(false))), Halogen_HTML_Properties.href(Mkpasswd_UI_Routing.routeHref(Mkpasswd_UI_Routing.Index.value)) ])([ Halogen_HTML_Core.text("Generate") ]), Halogen_HTML_Elements.a([ Mkpasswd_Halogen_Util.classes([ "navbar-item" ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SetMenu.create(false))), Halogen_HTML_Properties.href(Mkpasswd_UI_Routing.routeHref(Mkpasswd_UI_Routing.List.value)) ])([ Halogen_HTML_Core.text("Gallery") ]) ]), Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "navbar-end" ]) ])([ Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "navbar-item" ]) ])([ Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "buttons" ]) ])([  ]) ]) ]) ]) ]) ]);
  };
...
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
  $PS["Mkpasswd.UI.Element"] = $PS["Mkpasswd.UI.Element"] || {};
  var exports = $PS["Mkpasswd.UI.Element"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Mkpasswd_Halogen_Util = $PS["Mkpasswd.Halogen.Util"];                
  var container = function (content) {
      return Halogen_HTML_Elements.section([ Mkpasswd_Halogen_Util.classes([ "section" ]) ])([ Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "container" ]) ])(content) ]);
  };
...
(function($PS) {
  ...
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var Mkpasswd_Halogen_Util = $PS["Mkpasswd.Halogen.Util"];
  var Mkpasswd_UI_Components_HeaderNav = $PS["Mkpasswd.UI.Components.HeaderNav"];
  var Mkpasswd_UI_Element = $PS["Mkpasswd.UI.Element"];
  var Mkpasswd_UI_Routing = $PS["Mkpasswd.UI.Routing"];
  var Web_HTML = $PS["Web.HTML"];
  var Web_HTML_Window = $PS["Web.HTML.Window"];                
  ...
  var ToggleMenu = (function () {
      function ToggleMenu(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ToggleMenu.create = function (value0) {
          return function (value1) {
              return new ToggleMenu(value0, value1);
          };
      };
      return ToggleMenu;
  })();
  ...
  var ui = (function () {
      var initialState = function (v) {
          return {
              list: v,
              openMenuIndex: Data_Maybe.Nothing.value
          };
      };
      var $$eval = function (v) {
          if (v instanceof Delete) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.confirm("\u524a\u9664\u3057\u307e\u3059\u3002\u3088\u308d\u3057\u3044\u3067\u3059\u304b\uff1f"))))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(v1)(Halogen_Query_HalogenM.raise(new DelPasswd(v.value0))))(function () {
                      return $$eval(new ToggleMenu(v.value0, v.value1));
                  });
              });
          };
          if (v instanceof ToggleMenu) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(function (v1) {
                  return v1.openMenuIndex;
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $13.openMenuIndex = (function () {
                          var $12 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(v1)(new Data_Maybe.Just(v.value0));
                          if ($12) {
                              return Data_Maybe.Nothing.value;
                          };
                          return new Data_Maybe.Just(v.value0);
          ...
          throw new Error("Failed pattern match at Mkpasswd.UI.Pages.List (line 169, column 11 - line 169, column 84): " + [ v.constructor.name ]);
      };
      var accountRow = function (mi) {
          return function (i) {
              return function (fd) {
                  return Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "card", "mb1" ]) ])([ Halogen_HTML_Elements.header([ Mkpasswd_Halogen_Util.classes([ "card-header" ]) ])([ Halogen_HTML_Elements.h2([ Mkpasswd_Halogen_Util.classes([ "card-header-title", "text-wrap" ]) ])([ Halogen_HTML_Core.text(fd.account) ]), Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "card-header-icon", "dropdown", "is-right", (function () {
                      var $23 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(mi)(new Data_Maybe.Just(i));
                      if ($23) {
                          return "is-active";
                      };
                      return "";
                  })() ]) ])([ Halogen_HTML_Elements.a([ Mkpasswd_Halogen_Util.classes([ "dropdown-trigger" ]), Halogen_HTML_Properties.attr("aria-label")("more options"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ToggleMenu.create(i))) ])([ Halogen_HTML_Elements.span([ Mkpasswd_Halogen_Util.classes([ "icon" ]) ])([ Halogen_HTML_Elements.i([ Mkpasswd_Halogen_Util.classes([ "fas", "fa-ellipsis-v" ]), Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]) ]) ]), Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "dropdown-menu" ]) ])([ Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "dropdown-content" ]) ])([ Halogen_HTML_Elements.a([ Mkpasswd_Halogen_Util.classes([ "dropdown-item" ]), Halogen_HTML_Properties.href(Mkpasswd_UI_Routing.routeHref(new Mkpasswd_UI_Routing.Store(i))), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ToggleMenu.create(i))) ])([ Halogen_HTML_Elements.span([ Mkpasswd_Halogen_Util.classes([ "icon" ]) ])([ Halogen_HTML_Elements.i([ Mkpasswd_Halogen_Util.classes([ "fas", "fa-pen-fancy" ]), Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]) ]), Halogen_HTML_Core.text("edit") ]), Halogen_HTML_Elements.a([ Mkpasswd_Halogen_Util.classes([ "dropdown-item" ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Delete.create(i))) ])([ Halogen_HTML_Elements.span([ Mkpasswd_Halogen_Util.classes([ "icon" ]) ])([ Halogen_HTML_Elements.i([ Mkpasswd_Halogen_Util.classes([ "fas", "fa-trash-alt" ]), Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]) ]), Halogen_HTML_Core.text("remove") ]) ]) ]) ]) ]), Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "card-content" ]) ])([ Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "message" ]) ])([ Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "message-body", "text-wrap" ]) ])([ Halogen_HTML_Core.text(fd.passwd) ]) ]), Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "text-wrap" ]) ])([ Halogen_HTML_Core.text(fd.note) ]) ]) ]);
              };
          };
      };
      var render = function (state) {
          return Halogen_HTML_Elements.main_([ Halogen_HTML.slot(Data_Unit.unit)(Mkpasswd_UI_Components_HeaderNav.component)(Data_Unit.unit)(Data_Void.absurd), Mkpasswd_UI_Element.container(Data_Array.snoc((function () {
              var $24 = Data_Array["null"](state.list);
              if ($24) {
                  return [ Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "message" ]) ])([ Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "message-body", "text-wrap" ]) ])([ Halogen_HTML_Core.text("There is no work") ]) ]) ];
              };
              return Data_Array.mapWithIndex(accountRow(state.openMenuIndex))(state.list);
          })())(Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "sticky-bottom", "p1", "is-pulled-right" ]) ])([ Halogen_HTML_Elements.a([ Mkpasswd_Halogen_Util.classes([ "button", "is-dark", "is-rounded" ]), Halogen_HTML_Properties.href(Mkpasswd_UI_Routing.routeHref(Mkpasswd_UI_Routing.New.value)) ])([ Halogen_HTML_Elements.span([ Mkpasswd_Halogen_Util.classes([ "icon" ]) ])([ Halogen_HTML_Elements.i([ Mkpasswd_Halogen_Util.classes([ "fas", "fa-plus" ]), Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]) ]) ]) ]))) ]);
      };
...
(function($PS) {
  ...
  var labelTxt = function (v) {
      ...
      throw new Error("Failed pattern match at Mkpasswd.Data.FieldType.Mkpasswd (line 20, column 1 - line 20, column 32): " + [ v.constructor.name ]);
  };
  ...
  var eqFieldType = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof DegitsNum && y instanceof DegitsNum) {
              return true;
          };
          if (x instanceof UppercaseNum && y instanceof UppercaseNum) {
              return true;
          };
          if (x instanceof LowercaseNum && y instanceof LowercaseNum) {
              return true;
          };
          if (x instanceof SymbolNum && y instanceof SymbolNum) {
              return true;
          };
          return false;
      };
  });
  var ordFieldType = new Data_Ord.Ord(function () {
      return eqFieldType;
  }, function (x) {
      return function (y) {
          if (x instanceof DegitsNum && y instanceof DegitsNum) {
          ...
          if (y instanceof LowercaseNum) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof SymbolNum && y instanceof SymbolNum) {
              return Data_Ordering.EQ.value;
          };
          throw new Error("Failed pattern match at Mkpasswd.Data.FieldType.Mkpasswd (line 18, column 8 - line 18, column 46): " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  ...
  exports["ordFieldType"] = ordFieldType;
})(PS);
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
...
(function($PS) {
  ...
  var eqSwitch = function (dictEq) {
      return new Data_Eq.Eq(function (x) {
          return function (y) {
              return Data_Eq.eq(Data_Tuple.eqTuple(Data_Eq.eqBoolean)(dictEq))(x)(y);
          };
      });
  };
  exports["On"] = On;
...
(function($PS) {
  ...
  var minRule = Data_Ord.lessThanOrEq(Data_Ord.ordInt);
  var maxRule = Data_Ord.greaterThanOrEq(Data_Ord.ordInt);
  var $$int = function (e) {
      return function ($31) {
          return Data_Either.note([ e ])(Data_Int.fromString($31));
      };
  };          
  var chk = function (e) {
      return function (r) {
...
(function($PS) {
  ...
  var OnModInput = (function () {
      function OnModInput(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      OnModInput.create = function (value0) {
          return function (value1) {
              return new OnModInput(value0, value1);
          };
      };
      return OnModInput;
  })();
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "card" ]) ])([ Halogen_HTML_Elements.header([ Mkpasswd_Halogen_Util.classes([ "card-header" ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ToggleMulChk.create(!state.isOpenMulChk))) ])([ Halogen_HTML_Elements.p([ Mkpasswd_Halogen_Util.classes([ "card-header-title" ]) ])([ Halogen_HTML_Core.text("Individual symbol") ]), Halogen_HTML_Elements.a([ Mkpasswd_Halogen_Util.classes([ "card-header-icon" ]), Halogen_HTML_Properties.attr("aria-label")("more options") ])([ Halogen_HTML_Elements.span([ Mkpasswd_Halogen_Util.classes([ "icon" ]) ])([ Halogen_HTML_Elements.i([ Mkpasswd_Halogen_Util.classes([ "fas", "fa-angle-down" ]), Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]) ]) ]) ]), (function () {
              if (state.isOpenMulChk) {
                  return Halogen_HTML_Elements.fieldset([ Mkpasswd_Halogen_Util.classes([ "card-content" ]), Halogen_HTML_Properties.disabled(state.disabled) ])(Data_Array.cons(Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "field" ]) ])([ Halogen_HTML_Elements.span([ Mkpasswd_Halogen_Util.classes([ "controll" ]) ])([ Halogen_HTML_Elements.label([ Mkpasswd_Halogen_Util.classes([ "checkbox" ]) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Properties.checked(state.allChk), Mkpasswd_Halogen_Util.classes([ "mr1" ]), Halogen_HTML_Properties.disabled(state.disabled), Halogen_HTML_Events.onChecked(Halogen_HTML_Events.input(OnChkAll.create)) ]), Halogen_HTML_Core.text("use all symbol") ]) ]) ]))(Data_Array.cons(Halogen_HTML_Elements.hr_)(Data_Function.flip(Data_Array.mapWithIndex)(state.chars)(function (i) {
                      return function (c) {
                          return Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "field" ]) ])([ Halogen_HTML_Elements.span([ Mkpasswd_Halogen_Util.classes([ "controll" ]) ])([ Halogen_HTML_Elements.label([ Mkpasswd_Halogen_Util.classes([ "checkbox" ]) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Properties.checked(Mkpasswd_Data_Switch.isOn(c)), Mkpasswd_Halogen_Util.classes([ "mr1" ]), Halogen_HTML_Properties.disabled(state.disabled), Halogen_HTML_Events.onChange(Halogen_HTML_Events.input_(OnCheck.create(i))) ]), Halogen_HTML_Elements.strong_([ Halogen_HTML_Core.text(Data_String_CodeUnits.singleton(Data_Maybe.fromMaybe("?")(Data_Char.fromCharCode(Mkpasswd_Data_Switch.label(c))))) ]) ]) ]) ]);
                      };
                  }))));
              };
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof OnModInput) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $27.disabled = v.value0.disabled;
                  return $27;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          throw new Error("Failed pattern match at Mkpasswd.UI.Components.MultiChkboxes (line 115, column 11 - line 115, column 64): " + [ v.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
          initialState: initialState,
          render: render,
          "eval": $$eval,
          receiver: Halogen_HTML_Events.input(OnModInput.create)
      });
  })();
  exports["OnCheck"] = OnCheck;
  exports["OnChkAll"] = OnChkAll;
  exports["ToggleMulChk"] = ToggleMulChk;
  exports["OnModInput"] = OnModInput;
  exports["ui"] = ui;
})(PS);
(function($PS) {
  // Generated by purs version 0.12.5
  ...
  var OnFormMsg = (function () {
      function OnFormMsg(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      OnFormMsg.create = function (value0) {
          return function (value1) {
              return new OnFormMsg(value0, value1);
          };
      };
      return OnFormMsg;
  })();
  var OnPolFromMsg = (function () {
      function OnPolFromMsg(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      OnPolFromMsg.create = function (value0) {
          return function (value1) {
              return new OnPolFromMsg(value0, value1);
          };
      };
      return OnPolFromMsg;
  })();
  var proxyPolicyRow = function (dictRowToList) {
      return function (dictNewtype) {
          return function (dictMakeSProxies) {
  ...
  var proxy = function (dictRowToList) {
      return function (dictNewtype) {
          return function (dictMakeSProxies) {
              return Formless_Transform_Row.mkSProxies(dictRowToList)(dictNewtype)(dictMakeSProxies)(Formless_Types_Form.FormProxy.value);
          };
  ...
  var newtypePolicyForm = new Data_Newtype.Newtype(function (n) {
      return n;
  }, PolicyForm);
  ...
  var minLength = 0;
  var maxLength = 100;
  var showErr = function (v) {
      if (v instanceof Mkpasswd_Data_Validation.OutOfRange) {
          return Data_Show.show(Data_Show.showInt)(minLength) + ("\u3068" + (Data_Show.show(Data_Show.showInt)(maxLength) + "\u306e\u9593\u3067\u5165\u529b\u3057\u3066\u304f\u3060\u3055\u3044"));
      };
      if (v instanceof Mkpasswd_Data_Validation.ValueMissing) {
          return "\u6574\u6570\u3092\u5165\u529b\u3057\u3066\u304f\u3060\u3055\u3044";
      };
      if (v instanceof Mkpasswd_Data_Validation.EmptyCharSet) {
          return "\u4f7f\u7528\u3059\u308b\u6587\u5b57\u3092\u6307\u5b9a\u3057\u3066\u304f\u3060\u3055\u3044";
      };
      if (v instanceof Mkpasswd_Data_Validation.TooShort) {
          return "\u9577\u3055\u306f\u6587\u5b57\u7a2e\u3054\u3068\u306e\u5fc5\u8981\u6700\u4f4e\u6570\u306e\u7dcf\u548c\u3088\u308a\u3082\u5927\u304d\u304f\u3057\u3066\u304f\u3060\u3055\u3044";
      };
      if (v instanceof Mkpasswd_Data_Validation.TypeMismatch) {
          return "\u6574\u6570\u3092\u5165\u529b\u3057\u3066\u304f\u3060\u3055\u3044";
      };
      if (v instanceof Mkpasswd_Data_Validation.Invalid) {
          return "\u30a8\u30e9\u30fc\u3092\u89e3\u6d88\u3057\u3066\u304f\u3060\u3055\u3044";
      };
      if (v instanceof Mkpasswd_Data_Validation.Unknown) {
          return "\u306a\u3093\u304b\u30a8\u30e9\u30fc\u306b\u306a\u3063\u305f\u3093\u3067\u30ea\u30ed\u30fc\u30c9\u3057\u3066\u304f\u3060\u3055\u3044";
      };
      throw new Error("Failed pattern match at Mkpasswd.UI.Pages.Mkpasswd (line 307, column 5 - line 316, column 1): " + [ v.constructor.name ]);
  };
  var renderPolicyRow = function (fieldType) {
      return function (fstate) {
          var isUsed = Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "isUsed";
          }))(newtypePolicyForm)()((proxyPolicyRow()(newtypePolicyForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "charSet";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "isUsed";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "requiredMinNum";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).isUsed)(fstate.form);
          return Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "field" ]) ])([ Halogen_HTML_Elements.label([ Mkpasswd_Halogen_Util.classes([ "label" ]) ])([ Halogen_HTML_Core.text(Mkpasswd_Data_FieldType_Mkpasswd.labelTxt(fieldType)) ]), Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "field", "has-addons" ]) ])([ Halogen_HTML_Elements.span([ Mkpasswd_Halogen_Util.classes([ "control" ]) ])([ Halogen_HTML_Elements.label([ Mkpasswd_Halogen_Util.classes([ "button", "checkbox" ]) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Properties.checked(isUsed), Mkpasswd_Halogen_Util.classes([ "mr1" ]), Halogen_HTML_Events.onChecked(Halogen_HTML_Events.input(Formless_Query.setValidate(new Data_Symbol.IsSymbol(function () {
              return "isUsed";
          }))(newtypePolicyForm)()((proxyPolicyRow()(newtypePolicyForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "charSet";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "requiredMinNum";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).isUsed))) ]), Halogen_HTML_Core.text("use it") ]) ]), Halogen_HTML_Elements.span([ Mkpasswd_Halogen_Util.classes([ "control", "is-expanded" ]) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.id_(Data_Show.show(Mkpasswd_Data_FieldType_Mkpasswd.showFieldType)(fieldType)), Mkpasswd_Halogen_Util.classes([ "input", (function () {
              var $32 = Data_Maybe.isJust(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
                  return "requiredMinNum";
              }))(newtypePolicyForm)()((proxyPolicyRow()(newtypePolicyForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                  return "charSet";
              }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "requiredMinNum";
              }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).requiredMinNum)(fstate.form));
              if ($32) {
                  return "is-danger";
              };
              return "";
              ...
              return "requiredMinNum";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).requiredMinNum)(fstate.form)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(Formless_Query.setValidate(new Data_Symbol.IsSymbol(function () {
              return "requiredMinNum";
          }))(newtypePolicyForm)()((proxyPolicyRow()(newtypePolicyForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "charSet";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "requiredMinNum";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).requiredMinNum))), Halogen_HTML_Properties.step(DOM_HTML_Indexed_StepValue.Any.value), Halogen_HTML_Properties.min(Data_Int.toNumber(minLength)), Halogen_HTML_Properties.max(Data_Int.toNumber(maxLength)), Halogen_HTML_Properties.disabled(!isUsed) ]) ]) ]), Halogen_HTML_Elements.ul([ Mkpasswd_Halogen_Util.classes([ "help", "is-danger" ]) ])(Data_Functor.map(Data_Functor.functorArray)(function (msg) {
              return Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text(showErr(msg)) ]);
          })(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Maybe.fromMaybe([  ])(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
              return "requiredMinNum";
          }))(newtypePolicyForm)()((proxyPolicyRow()(newtypePolicyForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "charSet";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "requiredMinNum";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).requiredMinNum)(fstate.form)))(Data_Maybe.fromMaybe([  ])(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
              return "charSet";
          }))(newtypePolicyForm)()((proxyPolicyRow()(newtypePolicyForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "charSet";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "requiredMinNum";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).charSet)(fstate.form))))), (function () {
              var $33 = Data_Eq.eq(Mkpasswd_Data_FieldType_Mkpasswd.eqFieldType)(fieldType)(Mkpasswd_Data_FieldType_Mkpasswd.SymbolNum.value);
              if ($33) {
                  return (function (i) {
                      return Halogen_HTML.slot(Data_Unit.unit)(Mkpasswd_UI_Components_MultiChkboxes.ui)(i)(Halogen_HTML_Events.input(Formless_Query.setValidate(new Data_Symbol.IsSymbol(function () {
                          return "charSet";
                      }))(newtypePolicyForm)()((proxyPolicyRow()(newtypePolicyForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                          return "charSet";
                      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                          ...
                          return "requiredMinNum";
                      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).charSet)));
                  })({
                      allChk: true,
                      chars: Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                          return "charSet";
                      }))(newtypePolicyForm)()((proxyPolicyRow()(newtypePolicyForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                          return "charSet";
                      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                          ...
                          return "requiredMinNum";
                      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).charSet)(fstate.form),
                      isOpenMulChk: false,
                      disabled: !isUsed
                  });
              };
  ...
  var validators = (function () {
      var required = Formless_Validation.hoistFnE_(Effect_Aff.monadAff)(Mkpasswd_Data_Validation.chk(Mkpasswd_Data_Validation.ValueMissing.value)(Mkpasswd_Data_Validation.requiredRule));
      var range = Formless_Validation.hoistFnE_(Effect_Aff.monadAff)(Mkpasswd_Data_Validation.chk(Mkpasswd_Data_Validation.OutOfRange.value)(Mkpasswd_Data_Validation.rangeRule(minLength)(maxLength)));
      var policy = Formless_Validation.hoistFn_(Effect_Aff.monadAff)(function (i) {
          return Data_Functor.map(Data_Functor.functorArray)(function (p) {
              return Mkpasswd_Data_PasswdPolicy.passwdPolicy(p.requiredMinNum)(p.charSet);
          })(Data_Array.filter(function (v) {
              return v.isUsed;
          })(i));
      });
      var nonEmpty = Formless_Validation.hoistFnE_(Effect_Aff.monadAff)(Mkpasswd_Data_Validation.chk(Mkpasswd_Data_Validation.EmptyCharSet.value)(Mkpasswd_Data_Validation.nonEmptyRule));
      var $$int = Formless_Validation.hoistFnE_(Effect_Aff.monadAff)(Mkpasswd_Data_Validation["int"](Mkpasswd_Data_Validation.TypeMismatch.value));
      var exists = Formless_Validation.hoistFnE_(Effect_Aff.monadAff)(Data_Either.note([ Mkpasswd_Data_Validation.Invalid.value ]));
      var enoughLong = Formless_Validation.hoistFnE(Effect_Aff.monadAff)(function (form) {
          var p = Data_Maybe.fromMaybe([  ])(Formless_Retrieve.getOutput(new Data_Symbol.IsSymbol(function () {
              return "policy";
          }))(newtypeForm)()((proxy()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "length";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "policy";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))).policy)(form));
          return Mkpasswd_Data_Validation.chk(Mkpasswd_Data_Validation.TooShort.value)(Mkpasswd_Data_Validation.minRule(Mkpasswd_Data_PasswdPolicy.requiredMinLength(p)));
      });
      return {
          length: Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation(Effect_Aff.monadAff))(required)(Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation(Effect_Aff.monadAff))($$int)(Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation(Effect_Aff.monadAff))(range)(enoughLong))),
          policy: Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation(Effect_Aff.monadAff))(exists)(Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation(Effect_Aff.monadAff))(policy)(nonEmpty))
      };
  })();
  var validatorsPolicyRow = (function () {
      var unUsed = function (o) {
          return Formless_Validation.hoistFnE(Effect_Aff.monadAff)(function (form) {
              return function (v) {
                  return Mkpasswd_Data_Validation.chk(Mkpasswd_Data_Validation.Unknown.value)(function (v1) {
                      return !Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                          return "isUsed";
                      }))(newtypePolicyForm)()((proxyPolicyRow()(newtypePolicyForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                          return "charSet";
                      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                          ...
                          return "requiredMinNum";
                      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).isUsed)(form);
                  })(o);
              };
          });
      };
      var unSwitchAll = Formless_Validation.hoistFn_(Effect_Aff.monadAff)(Data_Array.mapMaybe(Mkpasswd_Data_Switch.toMaybe));
      var required = Formless_Validation.hoistFnE_(Effect_Aff.monadAff)(Mkpasswd_Data_Validation.chk(Mkpasswd_Data_Validation.ValueMissing.value)(Mkpasswd_Data_Validation.requiredRule));
      var range = Formless_Validation.hoistFnE_(Effect_Aff.monadAff)(Mkpasswd_Data_Validation.chk(Mkpasswd_Data_Validation.OutOfRange.value)(Mkpasswd_Data_Validation.rangeRule(minLength)(maxLength)));
      var nonEmpty = Formless_Validation.hoistFnE_(Effect_Aff.monadAff)(Mkpasswd_Data_Validation.chk(Mkpasswd_Data_Validation.EmptyCharSet.value)(Mkpasswd_Data_Validation.nonEmptyRule));
      var $$int = Formless_Validation.hoistFnE_(Effect_Aff.monadAff)(Mkpasswd_Data_Validation["int"](Mkpasswd_Data_Validation.TypeMismatch.value));
      return {
          requiredMinNum: Control_Alt.alt(Formless_Validation.altValidation(Effect_Aff.monadAff))(unUsed(0))(Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation(Effect_Aff.monadAff))(required)(Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation(Effect_Aff.monadAff))($$int)(range))),
          isUsed: Formless_Validation.hoistFn_(Effect_Aff.monadAff)(Control_Category.identity(Control_Category.categoryFn)),
          charSet: Control_Alt.alt(Formless_Validation.altValidation(Effect_Aff.monadAff))(unUsed([ 0 ]))(Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation(Effect_Aff.monadAff))(unSwitchAll)(nonEmpty))
      };
  })();
  var renderFormless = function (fstate) {
      return Mkpasswd_UI_Element.container([ Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "field" ]) ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("PasswdLength"), Mkpasswd_Halogen_Util.classes([ "pr1", "label" ]) ])([ Halogen_HTML_Core.text("Length") ]), Halogen_HTML_Elements.span([ Mkpasswd_Halogen_Util.classes([ "control" ]) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.id_("PasswdLength"), Mkpasswd_Halogen_Util.classes([ "input", (function () {
          var $34 = Data_Maybe.isJust(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
              return "length";
          }))(newtypeForm)()((proxy()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "length";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "policy";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))).length)(fstate.form));
          if ($34) {
              return "is-danger";
          };
          return "";
          ...
          return "policy";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))).length)(fstate.form)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(Formless_Query.setValidate(new Data_Symbol.IsSymbol(function () {
          return "length";
      }))(newtypeForm)()((proxy()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "length";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "policy";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))).length))), Halogen_HTML_Properties.step(DOM_HTML_Indexed_StepValue.Any.value), Halogen_HTML_Properties.max(Data_Int.toNumber(maxLength)), Halogen_HTML_Properties.min(Data_Int.toNumber(minLength)) ]) ]), Halogen_HTML_Elements.ul([ Mkpasswd_Halogen_Util.classes([ "help", "is-danger" ]) ])(Data_Functor.map(Data_Functor.functorArray)(function (msg) {
          return Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text(showErr(msg)) ]);
      })(Data_Maybe.fromMaybe([  ])(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
          return "length";
      }))(newtypeForm)()((proxy()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "length";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "policy";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))).length)(fstate.form)))) ]), (function (i) {
          return Halogen_HTML.slot(Mkpasswd_Data_FieldType_Mkpasswd.DegitsNum.value)(Formless_Component.component(Data_Ord.ordUnit)(Effect_Aff_Class.monadAffAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              return "requiredMinNum";
              ...
              return "charSet";
          }))(Formless_Types_Form.eqInputField(Data_Eq.eqArray(Mkpasswd_Data_Switch.eqSwitch(Data_Eq.eqInt)))))(Formless_Internal_Transform.inputFieldsToFormFieldsCons(new Data_Symbol.IsSymbol(function () {
              return "charSet";
              ...
              return "charSet";
          }))(Effect_Aff.monadAff)()(newtypePolicyForm)()(Formless_Internal_Transform.row1Cons()())(Formless_Internal_Transform.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
              return "isUsed";
          }))(Effect_Aff.monadAff)()(newtypePolicyForm)()(Formless_Internal_Transform.row1Cons()())(Formless_Internal_Transform.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
              return "requiredMinNum";
          }))(Effect_Aff.monadAff)()(newtypePolicyForm)()(Formless_Internal_Transform.row1Cons()())(Formless_Internal_Transform.applyToValidationNil(Effect_Aff.monadAff)))))(Formless_Internal_Transform.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
              return "charSet";
          }))()(Formless_Internal_Transform.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
              return "isUsed";
          }))()(Formless_Internal_Transform.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
              return "requiredMinNum";
          }))()(Formless_Internal_Transform.formFieldsToMaybeOutputNil)(Formless_Internal_Transform.row1Cons()()))(Formless_Internal_Transform.row1Cons()()))(Formless_Internal_Transform.row1Cons()()))(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm))(i)(Halogen_HTML_Events.input(function ($57) {
              return Formless_Query.raise(Halogen_Query.action(OnPolFromMsg.create($57)));
          }));
      })({
          initialInputs: Formless_Transform_Record.wrapInputFields(newtypePolicyForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
              return "charSet";
              ...
              isUsed: true,
              requiredMinNum: Data_Maybe.fromMaybe("")(Data_Functor.map(Data_Maybe.functorMaybe)(function ($58) {
                  return Data_Show.show(Data_Show.showInt)((function (v) {
                      return v.requiredMinNum;
                  })($58));
              })(Data_Array.index(Mkpasswd_Data_PasswdPolicy.defaultPolicy)(0))),
              charSet: Data_Functor.map(Data_Functor.functorArray)(Mkpasswd_Data_Switch.toSwitch(Mkpasswd_Data_Switch.On.value))(Data_Maybe.fromMaybe([  ])(Data_Functor.map(Data_Maybe.functorMaybe)(function (v) {
                  return v.charSet;
              })(Data_Array.index(Mkpasswd_Data_PasswdPolicy.defaultPolicy)(0))))
          }),
          validators: validatorsPolicyRow,
          render: renderPolicyRow(Mkpasswd_Data_FieldType_Mkpasswd.DegitsNum.value)
      }), (function (i) {
          return Halogen_HTML.slot(Mkpasswd_Data_FieldType_Mkpasswd.UppercaseNum.value)(Formless_Component.component(Data_Ord.ordUnit)(Effect_Aff_Class.monadAffAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              return "requiredMinNum";
          }))(Formless_Types_Form.eqInputField(Data_Eq.eqString)))()(new Data_Symbol.IsSymbol(function () {
              return "isUsed";
          }))(Formless_Types_Form.eqInputField(Data_Eq.eqBoolean)))()(new Data_Symbol.IsSymbol(function () {
              ...
              return "requiredMinNum";
          }))()(Formless_Internal_Transform.formFieldsToMaybeOutputNil)(Formless_Internal_Transform.row1Cons()()))(Formless_Internal_Transform.row1Cons()()))(Formless_Internal_Transform.row1Cons()()))(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm))(i)(Halogen_HTML_Events.input(function ($59) {
              return Formless_Query.raise(Halogen_Query.action(OnPolFromMsg.create($59)));
          }));
      })({
          initialInputs: Formless_Transform_Record.wrapInputFields(newtypePolicyForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
              return "charSet";
              ...
              isUsed: true,
              requiredMinNum: Data_Maybe.fromMaybe("")(Data_Functor.map(Data_Maybe.functorMaybe)(function ($60) {
                  return Data_Show.show(Data_Show.showInt)((function (v) {
                      return v.requiredMinNum;
                  })($60));
              })(Data_Array.index(Mkpasswd_Data_PasswdPolicy.defaultPolicy)(1))),
              charSet: Data_Functor.map(Data_Functor.functorArray)(Mkpasswd_Data_Switch.toSwitch(Mkpasswd_Data_Switch.On.value))(Data_Maybe.fromMaybe([  ])(Data_Functor.map(Data_Maybe.functorMaybe)(function (v) {
                  return v.charSet;
              })(Data_Array.index(Mkpasswd_Data_PasswdPolicy.defaultPolicy)(1))))
          }),
          validators: validatorsPolicyRow,
          render: renderPolicyRow(Mkpasswd_Data_FieldType_Mkpasswd.UppercaseNum.value)
      }), (function (i) {
          return Halogen_HTML.slot(Mkpasswd_Data_FieldType_Mkpasswd.LowercaseNum.value)(Formless_Component.component(Data_Ord.ordUnit)(Effect_Aff_Class.monadAffAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              return "requiredMinNum";
          }))(Formless_Types_Form.eqInputField(Data_Eq.eqString)))()(new Data_Symbol.IsSymbol(function () {
              return "isUsed";
          }))(Formless_Types_Form.eqInputField(Data_Eq.eqBoolean)))()(new Data_Symbol.IsSymbol(function () {
              ...
              return "requiredMinNum";
          }))()(Formless_Internal_Transform.formFieldsToMaybeOutputNil)(Formless_Internal_Transform.row1Cons()()))(Formless_Internal_Transform.row1Cons()()))(Formless_Internal_Transform.row1Cons()()))(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm))(i)(Halogen_HTML_Events.input(function ($61) {
              return Formless_Query.raise(Halogen_Query.action(OnPolFromMsg.create($61)));
          }));
      })({
          initialInputs: Formless_Transform_Record.wrapInputFields(newtypePolicyForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
              return "charSet";
              ...
              isUsed: true,
              requiredMinNum: Data_Maybe.fromMaybe("")(Data_Functor.map(Data_Maybe.functorMaybe)(function ($62) {
                  return Data_Show.show(Data_Show.showInt)((function (v) {
                      return v.requiredMinNum;
                  })($62));
              })(Data_Array.index(Mkpasswd_Data_PasswdPolicy.defaultPolicy)(2))),
              charSet: Data_Functor.map(Data_Functor.functorArray)(Mkpasswd_Data_Switch.toSwitch(Mkpasswd_Data_Switch.On.value))(Data_Maybe.fromMaybe([  ])(Data_Functor.map(Data_Maybe.functorMaybe)(function (v) {
                  return v.charSet;
              })(Data_Array.index(Mkpasswd_Data_PasswdPolicy.defaultPolicy)(2))))
          }),
          validators: validatorsPolicyRow,
          render: renderPolicyRow(Mkpasswd_Data_FieldType_Mkpasswd.LowercaseNum.value)
      }), (function (i) {
          return Halogen_HTML.slot(Mkpasswd_Data_FieldType_Mkpasswd.SymbolNum.value)(Formless_Component.component(Data_Ord.ordUnit)(Effect_Aff_Class.monadAffAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              return "requiredMinNum";
          }))(Formless_Types_Form.eqInputField(Data_Eq.eqString)))()(new Data_Symbol.IsSymbol(function () {
              return "isUsed";
          }))(Formless_Types_Form.eqInputField(Data_Eq.eqBoolean)))()(new Data_Symbol.IsSymbol(function () {
              ...
              return "requiredMinNum";
          }))()(Formless_Internal_Transform.formFieldsToMaybeOutputNil)(Formless_Internal_Transform.row1Cons()()))(Formless_Internal_Transform.row1Cons()()))(Formless_Internal_Transform.row1Cons()()))(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm)(newtypePolicyForm))(i)(Halogen_HTML_Events.input(function ($63) {
              return Formless_Query.raise(Halogen_Query.action(OnPolFromMsg.create($63)));
          }));
      })({
          initialInputs: Formless_Transform_Record.wrapInputFields(newtypePolicyForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
              return "charSet";
              ...
              isUsed: true,
              requiredMinNum: Data_Maybe.fromMaybe("")(Data_Functor.map(Data_Maybe.functorMaybe)(function ($64) {
                  return Data_Show.show(Data_Show.showInt)((function (v) {
                      return v.requiredMinNum;
                  })($64));
              })(Data_Array.index(Mkpasswd_Data_PasswdPolicy.defaultPolicy)(3))),
              charSet: Data_Functor.map(Data_Functor.functorArray)(Mkpasswd_Data_Switch.toSwitch(Mkpasswd_Data_Switch.On.value))(Data_Maybe.fromMaybe([  ])(Data_Functor.map(Data_Maybe.functorMaybe)(function (v) {
                  return v.charSet;
              })(Data_Array.index(Mkpasswd_Data_PasswdPolicy.defaultPolicy)(3))))
          }),
          validators: validatorsPolicyRow,
          render: renderPolicyRow(Mkpasswd_Data_FieldType_Mkpasswd.SymbolNum.value)
      }), Halogen_HTML_Elements.ul([ Mkpasswd_Halogen_Util.classes([ "help", "is-danger" ]) ])(Data_Functor.map(Data_Functor.functorArray)(function (msg) {
          return Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text(showErr(msg)) ]);
      })(Data_Maybe.fromMaybe([  ])(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
          return "policy";
      }))(newtypeForm)()((proxy()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "policy";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))).policy)(fstate.form)))) ]);
  };
  var cpNav = Halogen_Component_ChildPath.cp1;
  var cpForm = Halogen_Component_ChildPath.cp2;
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.main([ Mkpasswd_Halogen_Util.classes([ (function () {
              var $35 = Data_Maybe.isJust(state.passwd);
              if ($35) {
                  return "is-clipped";
              };
              return "";
          })() ]) ])([ Halogen_HTML["slot'"](cpNav)(Data_Unit.unit)(Mkpasswd_UI_Components_HeaderNav.component)(Data_Unit.unit)(Data_Void.absurd), (function (i) {
              return Halogen_HTML["slot'"](cpForm)(Data_Unit.unit)(Formless_Component.component(Mkpasswd_Data_FieldType_Mkpasswd.ordFieldType)(Effect_Aff_Class.monadAffAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                  return "policy";
                  ...
                  return "charSet";
              }))(Data_Eq.eqArray(Data_Eq.eqInt))))))))()(new Data_Symbol.IsSymbol(function () {
                  return "length";
                  ...
                  return "policy";
              }))()(Formless_Internal_Transform.formFieldsToMaybeOutputNil)(Formless_Internal_Transform.row1Cons()()))(Formless_Internal_Transform.row1Cons()()))(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm))(i)(Halogen_HTML_Events.input(OnFormMsg.create));
          })({
              initialInputs: Formless_Transform_Record.wrapInputFields(newtypeForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                  return "length";
              }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.wrapField(Formless_Types_Form.newtypeInputField)))(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                  return "policy";
              }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.wrapField(Formless_Types_Form.newtypeInputField)))(Heterogeneous_Mapping.mapRecordWithIndexNil)()())()()))({
                  length: Data_Show.show(Data_Show.showInt)(Mkpasswd_Data_PasswdPolicy.defaultLength),
                  policy: Data_Maybe.Nothing.value
              }),
              validators: validators,
              render: renderFormless
          }), Halogen_HTML_Elements.section([ Mkpasswd_Halogen_Util.classes([ "level", "sticky-bottom", "box" ]) ])([ Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "level-item" ]) ])([ Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "field", "is-grouped" ]) ])([ Halogen_HTML_Elements.span([ Mkpasswd_Halogen_Util.classes([ "control" ]) ])([ Halogen_HTML_Elements.button([ Mkpasswd_Halogen_Util.classes([ "button", "is-dark" ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Generate.create)) ])([ Halogen_HTML_Core.text("Generate") ]) ]) ]) ]) ]), Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "modal", (function () {
              var $36 = Data_Maybe.isJust(state.passwd);
              if ($36) {
                  return "is-active";
              };
              return "";
          })() ]) ])([ Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "modal-background" ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Clear.create)) ])([  ]), Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "modal-card" ]) ])([ Halogen_HTML_Elements.header([ Mkpasswd_Halogen_Util.classes([ "modal-card-head" ]) ])([ Halogen_HTML_Elements.h1([ Mkpasswd_Halogen_Util.classes([ "modal-card-title" ]) ])([ Halogen_HTML_Core.text("Result") ]), Halogen_HTML_Elements.button([ Mkpasswd_Halogen_Util.classes([ "delete" ]), Halogen_HTML_Properties.attr("aria-label")("close"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Clear.create)) ])([  ]) ]), Halogen_HTML_Elements.section([ Mkpasswd_Halogen_Util.classes([ "modal-card-body" ]) ])([ Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "level" ]) ])([ Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "level-item", "has-text-centered", "is-size-3", "text-wrap" ]) ])([ Halogen_HTML_Elements.br_, Halogen_HTML_Core.text(Data_Maybe.fromMaybe("")(state.passwd)), Halogen_HTML_Elements.br_ ]) ]) ]), Halogen_HTML_Elements.footer([ Mkpasswd_Halogen_Util.classes([ "modal-card-foot" ]) ])([ Halogen_HTML_Elements.a([ Mkpasswd_Halogen_Util.classes([ "button", "is-dark" ]), Halogen_HTML_Properties.href(Mkpasswd_UI_Routing.routeHref(Mkpasswd_UI_Routing.New.value)) ])([ Halogen_HTML_Core.text("Save") ]), Halogen_HTML_Elements.button([ Mkpasswd_Halogen_Util.classes([ "button" ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Generate.create)) ])([ Halogen_HTML_Core.text("Regenerate") ]) ]) ]) ]) ]);
      };
      var initialState = Data_Function["const"]({
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof Clear) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $46.passwd = Data_Maybe.Nothing.value;
                  return $46;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          ...
          if (v instanceof Generate) {
              var mkpasswdFormless = function (r) {
                  var s = Formless_Transform_Record.unwrapOutputFields(newtypeForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                      return "length";
                      ...
                      return "policy";
                  }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField(Formless_Types_Form.newtypeOutputField)))(Heterogeneous_Mapping.mapRecordWithIndexNil)()())()()))(r);
                  return Mkpasswd.mkpasswd(s.length)(s.policy);
              };
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)((function () {
                  var fieldTypes = [ Mkpasswd_Data_FieldType_Mkpasswd.DegitsNum.value, Mkpasswd_Data_FieldType_Mkpasswd.UppercaseNum.value, Mkpasswd_Data_FieldType_Mkpasswd.LowercaseNum.value, Mkpasswd_Data_FieldType_Mkpasswd.SymbolNum.value ];
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Traversable["for"](Halogen_Query_HalogenM.applicativeHalogenM)(Data_Traversable.traversableArray)(fieldTypes)(function (ft) {
                      return Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(cpForm)(Data_Unit.unit)(Formless_Query.send(ft)(Formless_Query.submitReply));
                  }))(function (v1) {
                      var policy = Data_Functor.map(Data_Maybe.functorMaybe)(Data_Functor.map(Data_Functor.functorArray)(Formless_Transform_Record.unwrapOutputFields(newtypePolicyForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                          return "charSet";
                      }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField(Formless_Types_Form.newtypeOutputField)))(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                          return "isUsed";
                      }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField(Formless_Types_Form.newtypeOutputField)))(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                          return "requiredMinNum";
                      }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField(Formless_Types_Form.newtypeOutputField)))(Heterogeneous_Mapping.mapRecordWithIndexNil)()())()())()()))))(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(Control_Bind.join(Data_Maybe.bindMaybe))(v1));
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(cpForm)(Data_Unit.unit)(Formless_Query.set_(new Data_Symbol.IsSymbol(function () {
                          return "policy";
                      }))(newtypeForm)()((proxy()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                          return "length";
                      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                          return "policy";
                      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil)))).policy)(policy)))(function (v2) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(cpForm)(Data_Unit.unit)(Formless_Query.submitReply))(function (v3) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Data_Functor.map(Effect.functorEffect)(Control_Bind.join(Data_Maybe.bindMaybe))(Data_Traversable.traverse(Data_Traversable.traversableMaybe)(Effect.applicativeEffect)(mkpasswdFormless)(Control_Bind.join(Data_Maybe.bindMaybe)(v3)))))(function (v4) {
                                  return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Maybe.isJust(v4))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v5) {
                                      var $53 = {};
                                      for (var $54 in v5) {
                                          if ({}.hasOwnProperty.call(v5, $54)) {
                                              $53[$54] = v5[$54];
                                          };
                                      };
                                      $53.passwd = v4;
          ...
          throw new Error("Failed pattern match at Mkpasswd.UI.Pages.Mkpasswd (line 159, column 11 - line 159, column 84): " + [ v.constructor.name ]);
      };
  ...
  exports["cpNav"] = cpNav;
  exports["cpForm"] = cpForm;
  exports["Generate"] = Generate;
  exports["Clear"] = Clear;
  exports["OnFormMsg"] = OnFormMsg;
  exports["OnPolFromMsg"] = OnPolFromMsg;
  exports["ui"] = ui;
  exports["Form"] = Form;
  exports["proxy"] = proxy;
  ...
  exports["proxyPolicyRow"] = proxyPolicyRow;
  exports["validatorsPolicyRow"] = validatorsPolicyRow;
  exports["renderPolicyRow"] = renderPolicyRow;
  exports["newtypeForm"] = newtypeForm;
  exports["newtypePolicyForm"] = newtypePolicyForm;
})(PS);
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
  ...
  var validators = (function () {
      var isUnder1000 = Formless_Validation.hoistFnE_(Effect_Aff.monadAff)(function (v) {
          return Control_Apply.applySecond(Data_Either.applyEither)(Mkpasswd_Data_Validation.chk(Mkpasswd_Data_Validation.OutOfRange.value)(Mkpasswd_Data_Validation.maxRule(1000))(Data_String_CodePoints.length(v)))(Control_Applicative.pure(Data_Either.applicativeEither)(v));
      });
      var isUnder100 = Formless_Validation.hoistFnE_(Effect_Aff.monadAff)(function (v) {
          return Control_Apply.applySecond(Data_Either.applyEither)(Mkpasswd_Data_Validation.chk(Mkpasswd_Data_Validation.OutOfRange.value)(Mkpasswd_Data_Validation.maxRule(100))(Data_String_CodePoints.length(v)))(Control_Applicative.pure(Data_Either.applicativeEither)(v));
      });
      var isNonEmpty = Formless_Validation.hoistFnE_(Effect_Aff.monadAff)(Mkpasswd_Data_Validation.chk(Mkpasswd_Data_Validation.ValueMissing.value)(Mkpasswd_Data_Validation.requiredRule));
      return {
          account: Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation(Effect_Aff.monadAff))(isNonEmpty)(isUnder100),
          passwd: Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation(Effect_Aff.monadAff))(isNonEmpty)(isUnder100),
          note: isUnder1000
      };
  })();
  var proxy = function (dictRowToList) {
  ...
  var genericFeildType = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Mkpasswd.UI.Pages.Store (line 48, column 8 - line 48, column 56): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
  ...
  var renderFormless = function (fstate) {
      ...
      return Mkpasswd_UI_Element.container([ Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "field" ]) ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"](Data_Show.show(showFeildType)(AccountInput.value)), Mkpasswd_Halogen_Util.classes([ "label" ]) ])([ Halogen_HTML_Core.text("Title") ]), Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "control" ]) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.id_(Data_Show.show(showFeildType)(AccountInput.value)), Mkpasswd_Halogen_Util.classes([ "input", (function () {
          var $17 = Data_Maybe.isJust(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
              return "account";
          }))(newtypeForm)()((proxy()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "account";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "passwd";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).account)(fstate.form));
          if ($17) {
              return "is-danger";
          };
          return "";
          ...
          return "passwd";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).account)(fstate.form)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(Formless_Query.setValidate(new Data_Symbol.IsSymbol(function () {
          return "account";
      }))(newtypeForm)()((proxy()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "account";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "passwd";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).account))) ]) ]), Halogen_HTML_Elements.ul([ Mkpasswd_Halogen_Util.classes([ "help", "is-danger" ]) ])(Data_Functor.map(Data_Functor.functorArray)(function (msg) {
          return Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text(errorMsg(msg)) ]);
      })(Data_Maybe.fromMaybe([  ])(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
          return "account";
      }))(newtypeForm)()((proxy()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "account";
          ...
          return "passwd";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).account)(fstate.form)))) ]), Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "field" ]) ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"](Data_Show.show(showFeildType)(Passwdinput.value)), Mkpasswd_Halogen_Util.classes([ "label" ]) ])([ Halogen_HTML_Core.text("The Work") ]), Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "control" ]) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.id_(Data_Show.show(showFeildType)(Passwdinput.value)), Mkpasswd_Halogen_Util.classes([ "input", (function () {
          var $18 = Data_Maybe.isJust(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
              return "passwd";
          }))(newtypeForm)()((proxy()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "account";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "passwd";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).passwd)(fstate.form));
          if ($18) {
              return "is-danger";
          };
          return "";
          ...
          return "passwd";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).passwd)(fstate.form)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(Formless_Query.setValidate(new Data_Symbol.IsSymbol(function () {
          return "passwd";
      }))(newtypeForm)()((proxy()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "account";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "passwd";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).passwd))) ]) ]), Halogen_HTML_Elements.ul([ Mkpasswd_Halogen_Util.classes([ "help", "is-danger" ]) ])(Data_Functor.map(Data_Functor.functorArray)(function (msg) {
          return Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text(errorMsg(msg)) ]);
      })(Data_Maybe.fromMaybe([  ])(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
          return "passwd";
      }))(newtypeForm)()((proxy()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "passwd";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).passwd)(fstate.form)))) ]), Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "field" ]) ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"](Data_Show.show(showFeildType)(NoteTextarea.value)), Mkpasswd_Halogen_Util.classes([ "label" ]) ])([ Halogen_HTML_Core.text("Description") ]), Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "control" ]) ])([ Halogen_HTML_Elements.textarea([ Halogen_HTML_Properties.id_(Data_Show.show(showFeildType)(NoteTextarea.value)), Mkpasswd_Halogen_Util.classes([ "textarea", (function () {
          var $19 = Data_Maybe.isJust(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
              return "note";
          }))(newtypeForm)()((proxy()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              return "account";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "passwd";
          }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).note)(fstate.form));
          if ($19) {
              return "is-danger";
          };
          return "";
          ...
          return "passwd";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).note)(fstate.form)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(Formless_Query.setValidate(new Data_Symbol.IsSymbol(function () {
          return "note";
      }))(newtypeForm)()((proxy()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          return "account";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "passwd";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).note))) ]) ]), Halogen_HTML_Elements.ul([ Mkpasswd_Halogen_Util.classes([ "help", "is-danger" ]) ])(Data_Functor.map(Data_Functor.functorArray)(function (msg) {
          return Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text(errorMsg(msg)) ]);
      })(Data_Maybe.fromMaybe([  ])(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
          return "note";
      }))(newtypeForm)()((proxy()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "passwd";
      }))(Formless_Internal_Transform.row1Cons()())(Formless_Transform_Row.makeSProxiesNil))))).note)(fstate.form)))) ]), Halogen_HTML_Elements.div([ Mkpasswd_Halogen_Util.classes([ "field", "is-grouped" ]) ])([ Halogen_HTML_Elements.span([ Mkpasswd_Halogen_Util.classes([ "control" ]) ])([ Halogen_HTML_Elements.button([ Mkpasswd_Halogen_Util.classes([ "button", "is-dark" ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Formless_Types_Component.Submit.create)) ])([ Halogen_HTML_Core.text("Save") ]) ]), Halogen_HTML_Elements.span([ Mkpasswd_Halogen_Util.classes([ "control" ]) ])([ Halogen_HTML_Elements.a([ Mkpasswd_Halogen_Util.classes([ "button" ]), Halogen_HTML_Properties.href(Mkpasswd_UI_Routing.routeHref(Mkpasswd_UI_Routing.List.value)) ])([ Halogen_HTML_Core.text("Cancel") ]) ]) ]) ]);
  };
  var cpNav = Halogen_Component_ChildPath.cp1;
  var cpFrm = Halogen_Component_ChildPath.cp2;
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.main_([ Halogen_HTML["slot'"](cpNav)(Data_Unit.unit)(Mkpasswd_UI_Components_HeaderNav.component)(Data_Unit.unit)(Data_Void.absurd), Halogen_HTML["slot'"](cpFrm)(Data_Unit.unit)(Formless_Component.component(Data_Ord.ordVoid)(Effect_Aff_Class.monadAffAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              return "passwd";
          }))(Formless_Types_Form.eqInputField(Data_Eq.eqString)))()(new Data_Symbol.IsSymbol(function () {
              return "note";
          }))(Formless_Types_Form.eqInputField(Data_Eq.eqString)))()(new Data_Symbol.IsSymbol(function () {
              ...
              return "passwd";
          }))()(Formless_Internal_Transform.formFieldsToMaybeOutputNil)(Formless_Internal_Transform.row1Cons()()))(Formless_Internal_Transform.row1Cons()()))(Formless_Internal_Transform.row1Cons()()))(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm))({
              initialInputs: Formless_Transform_Record.wrapInputFields(newtypeForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                  return "account";
              }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.wrapField(Formless_Types_Form.newtypeInputField)))(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                  return "note";
                  ...
                  return "passwd";
              }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.wrapField(Formless_Types_Form.newtypeInputField)))(Heterogeneous_Mapping.mapRecordWithIndexNil)()())()())()()))(state),
              validators: validators,
              render: renderFormless
          })(Halogen_HTML_Events.input(Formless.create)) ]);
      };
      var initialState = function (inp) {
          return Data_Maybe.fromMaybe(Mkpasswd_Data_States.initialForm)(inp);
      };
      var $$eval = function (v) {
          if (v.value0 instanceof Formless_Types_Component.Submitted) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)((function () {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Routing_Hash.setHash(Mkpasswd_UI_Routing.routeHref(Mkpasswd_UI_Routing.List.value))))(function () {
                      return Halogen_Query_HalogenM.raise(new SavePasswd(form));
                  });
              })());
          };
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
...
(function($PS) {
  ...
  var ui = (function () {
      var render = function (state) {
          ...
          throw new Error("Failed pattern match at Mkpasswd.UI.Container (line 76, column 15 - line 80, column 93): " + [ state.route.constructor.name ]);
      };
      var initialState = {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof Load) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Mkpasswd_Data_Storage.fetch(Simple_JSON.readArray(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at Mkpasswd.UI.Container (line 92, column 14 - line 94, column 68): " + [ v1.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
              });
          ...
          throw new Error("Failed pattern match at Mkpasswd.UI.Container (line 82, column 11 - line 82, column 76): " + [ v.constructor.name ]);
      };
