...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Data.Char.Gen.Symbols"] = $PS["Data.Char.Gen.Symbols"] || {};
  var exports = $PS["Data.Char.Gen.Symbols"];
  var Data_Array = $PS["Data.Array"];
  var Data_Char = $PS["Data.Char"];
  var Data_Functor = $PS["Data.Functor"];                
  var symbols = Data_Array.catMaybes(Data_Functor.map(Data_Functor.functorArray)(Data_Char.fromCharCode)(Data_Array.concat([ Data_Array.range(33)(47), Data_Array.range(58)(64), Data_Array.range(91)(96), Data_Array.range(123)(126) ])));
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Data.Switch"] = $PS["Data.Switch"] || {};
  var exports = $PS["Data.Switch"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Function = $PS["Data.Function"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Tuple = $PS["Data.Tuple"];
  var toSwitch = function (s) {
      return function (a) {
          return new Data_Tuple.Tuple(s, a);
      };
  };
  var modifyFst = function (f) {
      var $32 = Data_Functor.map(Data_Tuple.functorTuple)(f);
      return function ($33) {
          return Data_Tuple.swap($32(Data_Tuple.swap($33)));
      };
  };
  var off = function (v) {
      return modifyFst(Data_Function["const"](false))(v);
  };
  var on = function (v) {
      return modifyFst(Data_Function["const"](true))(v);
  };
                  ...
                  return function (i) {
                      return Control_Bind.bind(dictMonad.Bind1())(Data_Newtype.unwrap(newtypeValidation)(v0)(form)(i))(function (eo) {
                          return Data_Either.either((function () {
                              ...
                              return function ($43) {
                                  return $42(Data_Either.Left.create($43));
                              };
  ...
  var hoistFnE = function (dictMonad) {
      return function (f) {
          return Validation(function (form) {
              var $50 = Control_Applicative.pure(dictMonad.Applicative0());
              var $51 = f(form);
              return function ($52) {
                  return $50($51($52));
              };
...
(function($PS) {
  ...
  var _FieldOutput = function (dictIsSymbol) {
      return function (dictNewtype) {
          return function (dictCons) {
              return function (sym) {
                  return function (dictWander) {
                      var $107 = _FieldResult(dictIsSymbol)(dictNewtype)()(sym)(dictWander.Strong0());
                      var $108 = Formless_Data_FormFieldResult["_Success"](dictWander.Choice1());
                      return function ($109) {
                          return $107($108($109));
                      };
                  };
  ...
  var getOutput = function (dictIsSymbol) {
      return function (dictNewtype) {
          return function (dictCons) {
              return function (sym) {
                  return Data_Lens_Fold.preview(_FieldOutput(dictIsSymbol)(dictNewtype)()(sym)(Data_Lens_Internal_Forget.wanderForget(Data_Maybe_First.monoidFirst)));
              };
          };
      };
  };
...
(function($PS) {
  ...
  var matches = (function () {
      var $10 = matchesWith(Data_Either.foldableEither);
      return function ($11) {
...
(function($PS) {
  ...
  var routeHref = function (v) {
      ...
      throw new Error("Failed pattern match at Mkpasswd.UI.Routing (line 30, column 1 - line 30, column 33): " + [ v.constructor.name ]);
  };
  ...
  var routing = function (query) {
      return function (hashAction) {
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Routing_Hash.matches(menuHash)(function (mOld) {
              return function ($$new) {
                  return Control_Applicative.when(Effect.applicativeEffect)(Data_Eq.notEq(Data_Maybe.eqMaybe(eqRouteHash))(mOld)(new Data_Maybe.Just($$new)))(Effect_Aff.launchAff_(query(Halogen_Query.tell(hashAction($$new)))));
              };
          }));
      };
  };
...
(function($PS) {
  ...
  var SetMenu = (function () {
      function SetMenu(value0) {
          this.value0 = value0;
      };
      SetMenu.create = function (value0) {
          return new SetMenu(value0);
      };
      return SetMenu;
  })();
  var render = function (s) {
      return Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "navbar", "is-fixed-top", "is-dark" ])), Halogen_HTML_Properties.attr("role")("navigation"), Halogen_HTML_Properties.attr("aria-label")("main navigation") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "container" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "navbar-brand" ])) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "navbar-item" ])), Halogen_HTML_Properties.href(Mkpasswd_UI_Routing.routeHref(Mkpasswd_UI_Routing.Index.value)) ])([ Halogen_HTML_Elements.strong_([ Halogen_HTML_Core.text("RandomStr") ]) ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "navbar-burger", "burger" ])), Halogen_HTML_Properties.attr("role")("button"), Halogen_HTML_Properties.attr("aria-label")("menu"), Halogen_HTML_Properties.attr("aria-expanded")("button"), Halogen_HTML_Events.onClick(function (v) {
          return new Data_Maybe.Just(SetMenu.create(!s.isMenuActive));
      }) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "navbar-menu", (function () {
          if (s.isMenuActive) {
              return "is-active";
          };
          return "";
      })() ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "navbar-start" ])) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "navbar-item" ])), Halogen_HTML_Events.onClick(function (v) {
          return new Data_Maybe.Just(new SetMenu(false));
      }), Halogen_HTML_Properties.href(Mkpasswd_UI_Routing.routeHref(Mkpasswd_UI_Routing.Index.value)) ])([ Halogen_HTML_Core.text("Generate") ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "navbar-item" ])), Halogen_HTML_Events.onClick(function (v) {
          return new Data_Maybe.Just(new SetMenu(false));
      }), Halogen_HTML_Properties.href(Mkpasswd_UI_Routing.routeHref(Mkpasswd_UI_Routing.List.value)) ])([ Halogen_HTML_Core.text("Gallery") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "navbar-end" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "navbar-item" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "buttons" ])) ])([  ]) ]) ]) ]) ]) ]);
  };
...
(function($PS) {
  ...
  var ToggleMenu = (function () {
      function ToggleMenu(value0) {
          this.value0 = value0;
      };
      ToggleMenu.create = function (value0) {
          return new ToggleMenu(value0);
      };
      return ToggleMenu;
  })();
  var Receive = (function () {
  ...
  var menuBtn = function (i) {
      return Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "dropdown-trigger" ])), Halogen_HTML_Properties.attr("aria-label")("more options"), Halogen_HTML_Events.onClick(function (v) {
          return new Data_Maybe.Just(new ToggleMenu(i));
      }) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "icon" ])) ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "fas", "fa-ellipsis-v" ])), Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]) ]) ]);
  };
  var initialState = function (v) {
      return {
          list: v,
  ...
  var handleAction = function (dictMonadEffect) {
      return function (v) {
          if (v instanceof Delete) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.confirm("\u524a\u9664\u3057\u307e\u3059\u3002\u3088\u308d\u3057\u3044\u3067\u3059\u304b\uff1f"))))(function (a) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(a)(Halogen_Query_HalogenM.raise(v.value0)))(function () {
                      return handleAction(dictMonadEffect)(new ToggleMenu(v.value0));
                  });
              });
          };
          if (v instanceof ToggleMenu) {
              ...
              })(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM)))(function (mi) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $14 = {};
                      for (var $15 in v1) {
                      ...
                      $14.openMenuIndex = (function () {
                          var $13 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(mi)(new Data_Maybe.Just(v.value0));
                          if ($13) {
                              return Data_Maybe.Nothing.value;
                          };
                          return new Data_Maybe.Just(v.value0);
          ...
          throw new Error("Failed pattern match at Mkpasswd.UI.Pages.List (line 190, column 16 - line 199, column 31): " + [ v.constructor.name ]);
      };
  };
  var footerBtnArea = [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "sticky-bottom", "p1", "is-pulled-right" ])) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "button", "is-dark", "is-rounded" ])), Halogen_HTML_Properties.href(Mkpasswd_UI_Routing.routeHref(Mkpasswd_UI_Routing.New.value)) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "icon" ])) ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "fas", "fa-plus" ])), Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]) ]) ]) ]) ];
  var emptyListView = [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "message" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "message-body", "text-wrap" ])) ])([ Halogen_HTML_Core.text("There is no work") ]) ]) ];
  var dropdownItem = function (mHref) {
      return function (action) {
          return function (icon) {
              return function (label) {
                  return Halogen_HTML_Elements.a(Data_Array.catMaybes([ Data_Maybe.Just.create(Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "dropdown-item" ]))), Data_Functor.map(Data_Maybe.functorMaybe)(function ($24) {
                      return Halogen_HTML_Properties.href(Mkpasswd_UI_Routing.routeHref($24));
                  })(mHref), Data_Maybe.Just.create(Halogen_HTML_Events.onClick(function (v) {
                      return new Data_Maybe.Just(action);
                  })) ]))([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "icon" ])) ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "fas", icon ])), Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]) ]), Halogen_HTML_Core.text(label) ]);
              };
          };
      };
  };
  var cardMenu = function (mi) {
      return function (i) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "card-header-icon", "dropdown", "is-right", (function () {
              var $22 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(mi)(new Data_Maybe.Just(i));
              if ($22) {
                  return "is-active";
              };
              return "";
          })() ])) ])([ menuBtn(i), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "dropdown-menu" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "dropdown-content" ])) ])([ dropdownItem(Data_Maybe.Just.create(new Mkpasswd_UI_Routing.Store(i)))(new ToggleMenu(i))("fa-pen-fancy")("edit"), dropdownItem(Data_Maybe.Nothing.value)(new Delete(i))("fa-trash-alt")("remove") ]) ]) ]);
      };
  };
  var accountRow = function (mi) {
      return function (i) {
          return function (fd) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "card", "mb1" ])) ])([ Halogen_HTML_Elements.header([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "card-header" ])) ])([ Halogen_HTML_Elements.h2([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "card-header-title", "text-wrap" ])) ])([ Halogen_HTML_Core.text(fd.account) ]), cardMenu(mi)(i) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "card-content" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "message" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "message-body", "text-wrap" ])) ])([ Halogen_HTML_Core.text(fd.passwd) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "text-wrap" ])) ])([ Halogen_HTML_Core.text(fd.note) ]) ]) ]);
          };
      };
  };
  var _headerNav = Data_Symbol.SProxy.value;
  var render = function (dictMonadEffect) {
      return function (state) {
          return Halogen_HTML_Elements.main_([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "headerNav";
          }))(Data_Ord.ordUnit)(_headerNav)(Data_Unit.unit)(Mkpasswd_UI_Components_HeaderNav.component)(Data_Unit.unit)(Data_Void.absurd), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "section" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "container" ])) ])(Control_Bind.join(Control_Bind.bindArray)([ (function () {
              var $23 = Data_Array["null"](state.list);
              if ($23) {
...
(function($PS) {
  ...
  var genPassword = function (v) {
      var requiredLength = Data_Foldable.sum(Data_NonEmpty.foldableNonEmpty(Data_Foldable.foldableArray))(Data_Semiring.semiringInt)(Data_Functor.map(Data_NonEmpty.functorNonEmpty(Data_Functor.functorArray))(Data_Tuple.fst)(v.required));
      var remain = Data_Ord.max(Data_Ord.ordInt)(0)(v.length - requiredLength | 0);
      var genAll = Test_QuickCheck_Gen.oneOf(Data_Functor.map(Data_NonEmpty.functorNonEmpty(Data_Functor.functorArray))(Data_Tuple.snd)(v.required));
      return Control_Bind.bind(Test_QuickCheck_Gen.bindGen)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Test_QuickCheck_Gen.applicativeGen)(Data_Tuple.uncurry(Test_QuickCheck_Gen.vectorOf))(Data_Array.cons(new Data_Tuple.Tuple(remain, genAll))(Data_NonEmpty.fromNonEmpty(Data_Array.cons)(v.required))))(function (charsets) {
          return Control_Bind.bind(Test_QuickCheck_Gen.bindGen)(Test_QuickCheck_Gen.shuffle(Control_Bind.join(Control_Bind.bindArray)(charsets)))(function (passcode) {
              return Control_Applicative.pure(Test_QuickCheck_Gen.applicativeGen)(Data_String_CodeUnits.fromCharArray(passcode));
          });
      });
  };
  var mkpasswd = function (policy) {
      return Data_Functor.map(Effect.functorEffect)(Data_Array.head)(Test_QuickCheck_Gen["randomSample'"](1)(genPassword(policy)));
  };
...
(function($PS) {
  ...
  var DOM_HTML_Indexed_InputType = $PS["DOM.HTML.Indexed.InputType"];
  var Data_Array = $PS["Data.Array"];
  var Data_Char_Gen_Symbols = $PS["Data.Char.Gen.Symbols"];
  var Data_Either = $PS["Data.Either"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Function = $PS["Data.Function"];
  var Data_Functor = $PS["Data.Functor"];
  ...
  var Data_NonEmpty = $PS["Data.NonEmpty"];
  var Data_String_CodeUnits = $PS["Data.String.CodeUnits"];
  var Data_Switch = $PS["Data.Switch"];
  var Data_Symbol = $PS["Data.Symbol"];
  var Formless_Action = $PS["Formless.Action"];
  var Formless_Class_Initial = $PS["Formless.Class.Initial"];
  ...
  var SetDisabled = (function () {
      function SetDisabled(value0) {
          this.value0 = value0;
      };
      SetDisabled.create = function (value0) {
          return new SetDisabled(value0);
      };
      return SetDisabled;
  })();
  ...
  var ToggleAllChk = (function () {
      function ToggleAllChk() {

      };
      ToggleAllChk.value = new ToggleAllChk();
      return ToggleAllChk;
  })();
  var ToggleCharSwtich = (function () {
      function ToggleCharSwtich(value0) {
          this.value0 = value0;
      };
      ToggleCharSwtich.create = function (value0) {
          return new ToggleCharSwtich(value0);
      };
      return ToggleCharSwtich;
  })();
  ...
  var render = function (dictMonadAff) {
      return function (fstate) {
          ...
          var errorDisplay = function (err) {
              return Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "help", "is-danger" ])) ])(Data_Functor.map(Data_Functor.functorArray)(function (msg) {
                  return Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text(errorMsg(msg)) ]);
              })(Data_Maybe.fromMaybe([  ])(err)));
          };
          var checkboxRow = function (isDisabled) {
              return function (isChked) {
                  return function (onChange) {
                      return function (textElem) {
                          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "field" ])) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "controll" ])) ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "checkbox" ])) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Properties.checked(isChked), Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "mr1" ])), Halogen_HTML_Properties.disabled(isDisabled), Halogen_HTML_Events.onChange(onChange) ]), textElem ]) ]) ]);
                      };
                  };
              };
          };
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "card" ])) ])([ Halogen_HTML_Elements.header([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "card-header" ])), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Formless_Action.injAction(ToggleOpen.value));
          }) ])([ Halogen_HTML_Elements.p([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "card-header-title" ])) ])([ Halogen_HTML_Core.text("Individual symbol") ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "card-header-icon" ])), Halogen_HTML_Properties.attr("aria-label")("more options") ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "icon" ])) ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "fas", "fa-angle-down" ])), Halogen_HTML_Properties.attr("aria-hidden")("true") ])([  ]) ]) ]) ]), (function () {
              var v = Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
                  return "allowedSymbols";
              }))(newtypeForm)()((proxy()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                  return "allowedSymbols";
              }))()(Formless_Transform_Row.makeSProxiesNil))).allowedSymbols)(fstate.form);
              if (v instanceof Data_Maybe.Just) {
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "card-content" ])) ])([ errorDisplay(new Data_Maybe.Just(v.value0)) ]);
              };
              if (v instanceof Data_Maybe.Nothing) {
                  return Halogen_HTML_Core.text("");
              };
              throw new Error("Failed pattern match at Mkpasswd.UI.Components.MultiChkboxes (line 139, column 7 - line 145, column 21): " + [ v.constructor.name ]);
          })(), (function () {
              if (fstate.isOpen) {
                  return Halogen_HTML_Elements.fieldset([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "card-content" ])), Halogen_HTML_Properties.disabled(fstate.disabled) ])(Data_Array.cons(checkboxRow(fstate.disabled)(fstate.allChk)(function (v) {
                      return Data_Maybe.Just.create(Formless_Action.injAction(ToggleAllChk.value));
                  })(Halogen_HTML_Core.text("use all symbol")))(Data_Array.cons(Halogen_HTML_Elements.hr_)(Data_Function.flip(Data_Array.mapWithIndex)(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                      return "allowedSymbols";
                  }))(newtypeForm)()((proxy()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                      return "allowedSymbols";
                  }))()(Formless_Transform_Row.makeSProxiesNil))).allowedSymbols)(fstate.form))(function (i) {
                      return function (c) {
                          return checkboxRow(fstate.disabled)(Data_Switch.isOn(c))(function (v) {
                              return Data_Maybe.Just.create(Formless_Action.injAction(new ToggleCharSwtich(i)));
                          })(Halogen_HTML_Elements.strong_([ Halogen_HTML_Core.text(Data_String_CodeUnits.singleton(Data_Switch.label(c))) ]));
                      };
                  }))));
              };
              return Halogen_HTML_Core.text("");
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          ...
          if (v instanceof ToggleAllChk) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean))(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  return v1.allChk;
              })))(function (allChk) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $38 = {};
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          var allowedSymbols = Data_Functor.map(Data_Functor.functorArray)((function () {
                              if (allChk) {
                                  return Data_Switch.on;
                              };
                              return Data_Switch.off;
                          })())(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                              return "allowedSymbols";
                          }))(newtypeForm)()((proxy()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                              return "allowedSymbols";
                          }))()(Formless_Transform_Row.makeSProxiesNil))).allowedSymbols)(form));
                          return Formless_Component.handleAction(dictMonadAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                              return "allowedSymbols";
                          }))(Formless_Types_Form.eqInputField(Data_Eq.eqArray(Data_Switch.eqSwitch(Data_Eq.eqChar)))))(Formless_Internal_Transform.inputFieldsToFormFieldsCons(new Data_Symbol.IsSymbol(function () {
                              return "allowedSymbols";
                              ...
                              return "allowedSymbols";
                          }))((dictMonadAff.MonadEffect0()).Monad0())()(newtypeForm)()()(Formless_Internal_Transform.applyToValidationNil((dictMonadAff.MonadEffect0()).Monad0())))(Formless_Internal_Transform.formFieldsToMaybeOutputCons(new Data_Symbol.IsSymbol(function () {
                              return "allowedSymbols";
                          }))()(Formless_Internal_Transform.formFieldsToMaybeOutputNil)())(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)()(handleAction(dictMonadAff))(Formless_Component.raiseResult(newtypeForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                              return "allowedSymbols";
                          }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField(Formless_Types_Form.newtypeOutputField)))(Heterogeneous_Mapping.mapRecordWithIndexNil)()())))(Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                              return "allowedSymbols";
                          }))(newtypeForm)()((proxy()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                              return "allowedSymbols";
                          }))()(Formless_Transform_Row.makeSProxiesNil))).allowedSymbols)(allowedSymbols));
                      });
                  });
              });
          };
          if (v instanceof ToggleCharSwtich) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  return v1.form;
              }))(function (form) {
                  var allowedSymbols = (function (i) {
                      return function (f) {
                          return function (a) {
                              return Data_Maybe.fromMaybe(a)(Data_Array.modifyAt(i)(f)(a));
                          };
                      };
                  })(v.value0)(Data_Switch.toggle)(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                      return "allowedSymbols";
                  }))(newtypeForm)()((proxy()(newtypeForm)(Formless_Transform_Row.makeSProxiesCons(new Data_Symbol.IsSymbol(function () {
                      return "allowedSymbols";
                  }))()(Formless_Transform_Row.makeSProxiesNil))).allowedSymbols)(form));
          ...
          throw new Error("Failed pattern match at Mkpasswd.UI.Components.MultiChkboxes (line 95, column 16 - line 112, column 98): " + [ v.constructor.name ]);
      };
  };    
  var formInput = function (dictMonadAff) {
      return function (disabled) {
          var transformAllowedSymbols = Formless_Validation.hoistFnE_((dictMonadAff.MonadEffect0()).Monad0())(function (arr) {
              var seed = Data_Array.uncons(Data_Array.catMaybes(Data_Functor.map(Data_Functor.functorArray)(Data_Switch.toMaybe)(arr)));
              return Data_Either.note([ EmptyCharSet.value ])(Data_Functor.map(Data_Maybe.functorMaybe)(function (v) {
          ...
          return {
              ...
              isOpen: false,
              disabled: disabled,
              initialInputs: Data_Maybe.Just.create(Formless_Transform_Record.wrapInputFields(newtypeForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                  return "allowedSymbols";
                  ...
                  allowedSymbols: Data_Functor.map(Data_Functor.functorArray)(Data_Switch.toSwitch(true))(Data_Char_Gen_Symbols.symbols)
              })),
              validators: {
  ...
  var component = function (dictMonadAff) {
      return Formless_Component.component(dictMonadAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
          ...
          return "allowedSymbols";
      }))(Formless_Class_Initial.initialArray)()(Formless_Transform_Row.mkInputFieldsFromRowNil)())(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)()()()()()()()()()(formInput(dictMonadAff))({
          ...
          receive: function ($48) {
              return Data_Maybe.Just.create(SetDisabled.create($48));
          },
...
(function($PS) {
  ...
  var Mkpasswd_UI_Routing = $PS["Mkpasswd.UI.Routing"];
  var Test_QuickCheck_Gen = $PS["Test.QuickCheck.Gen"];                
  var GetPasswdPolicy = (function () {
      function GetPasswdPolicy(value0) {
          this.value0 = value0;
      };
      GetPasswdPolicy.create = function (value0) {
          return new GetPasswdPolicy(value0);
      };
  ...
  var DigitCharNum = (function () {
      function DigitCharNum() {

      };
      DigitCharNum.value = new DigitCharNum();
      return DigitCharNum;
  })();
  var AlphaUppercase = (function () {
      function AlphaUppercase() {

      };
      AlphaUppercase.value = new AlphaUppercase();
      return AlphaUppercase;
  })();
  var AlphaLowercaseNum = (function () {
      function AlphaLowercaseNum() {

      };
      AlphaLowercaseNum.value = new AlphaLowercaseNum();
      return AlphaLowercaseNum;
  })();
  var SymbolCharNum = (function () {
      function SymbolCharNum() {

      };
      SymbolCharNum.value = new SymbolCharNum();
      return SymbolCharNum;
  })();
  var ToggleCharSetUse = (function () {
      function ToggleCharSetUse(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ToggleCharSetUse.create = function (value0) {
          return function (value1) {
              return new ToggleCharSetUse(value0, value1);
          };
      };
      return ToggleCharSetUse;
  })();
  ...
  var genericFieldType = new Data_Generic_Rep.Generic(function (x) {
      ...
      if (x instanceof DigitCharNum) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value));
      };
      if (x instanceof AlphaUppercase) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value)));
      };
      if (x instanceof AlphaLowercaseNum) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value))));
      };
      if (x instanceof SymbolCharNum) {
      ...
      throw new Error("Failed pattern match at Mkpasswd.UI.Pages.Mkpasswd (line 307, column 1 - line 307, column 56): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return PasswdLength.value;
      };
      if (x instanceof Data_Generic_Rep.Inr && x.value0 instanceof Data_Generic_Rep.Inl) {
          return DigitCharNum.value;
      };
      if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0 instanceof Data_Generic_Rep.Inl)) {
          return AlphaUppercase.value;
      };
      if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && (x.value0.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0.value0 instanceof Data_Generic_Rep.Inl))) {
          return AlphaLowercaseNum.value;
      };
  ...
  var functorPasswdConfigQuery = new Data_Functor.Functor(function (f) {
      return function (m) {
          return new GetPasswdPolicy(Data_Functor.map(Data_Functor.functorFn)(f)(m.value0));
      };
  });
  var _numUpper = Data_Symbol.SProxy.value;
  var _numSymbol = Data_Symbol.SProxy.value;
  var _numLower = Data_Symbol.SProxy.value;
  var _numDigit = Data_Symbol.SProxy.value;
  var _multichkboxes = Data_Symbol.SProxy.value;
  var _length = Data_Symbol.SProxy.value;
  var _isUseUpper = Data_Symbol.SProxy.value;
  var _isUseSymbol = Data_Symbol.SProxy.value;
  var _isUseLower = Data_Symbol.SProxy.value;
  var _isUseDigit = Data_Symbol.SProxy.value;
  var formInput = function (dictMonad) {
      var isInt = Formless_Validation.hoistFnE_(dictMonad)((function () {
          var $107 = Data_Either.note([ TypeMismatch.value ]);
          return function ($108) {
              return $107(Data_Int.fromString($108));
          };
      })());
      var chk = function (e) {
          return function (r) {
      ...
      var enoughLong = Formless_Validation.hoistFnE(dictMonad)(function (form) {
          return function (len) {
              var requiredLength = Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringInt)(Data_Array.catMaybes([ Formless_Retrieve.getOutput(new Data_Symbol.IsSymbol(function () {
                  return "numDigit";
                  ...
                  return "numSymbol";
              }))(newtypeForm)()(_numSymbol)(form) ]));
              return chk(TooShort.value)(function (v) {
                  return v >= requiredLength;
              })(len);
          };
      });
      var isInRange = Formless_Validation.hoistFnE_(dictMonad)(chk(OutOfRange.value)(Data_Ord.between(Data_Ord.ordInt)(minLength)(maxLength)));
      var atLeastOneTrue = Formless_Validation.hoistFnE(dictMonad)(function (form) {
          return function (v) {
              return chk(EmptyCharSet.value)(Control_Category.identity(Control_Category.categoryFn))(Data_Foldable.or(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)([ Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                  return "isUseDigit";
              }))(newtypeForm)()(_isUseDigit)(form), Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                  return "isUseUpper";
              }))(newtypeForm)()(_isUseUpper)(form), Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                  return "isUseLower";
              }))(newtypeForm)()(_isUseLower)(form), Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                  return "isUseSymbol";
              }))(newtypeForm)()(_isUseSymbol)(form) ]));
          };
      });
      return {
          initialInputs: Data_Maybe.Just.create(Formless_Transform_Record.wrapInputFields(newtypeForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
          ...
          validators: {
              length: Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation(dictMonad))(isInt)(Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation(dictMonad))(isInRange)(enoughLong)),
              isNonEmpty: atLeastOneTrue,
              numDigit: Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation(dictMonad))(isInt)(isInRange),
              isUseDigit: Formless_Validation.noValidation(dictMonad),
              numUpper: Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation(dictMonad))(isInt)(isInRange),
              isUseUpper: Formless_Validation.noValidation(dictMonad),
              numLower: Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation(dictMonad))(isInt)(isInRange),
              isUseLower: Formless_Validation.noValidation(dictMonad),
              numSymbol: Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation(dictMonad))(isInt)(isInRange),
              isUseSymbol: Formless_Validation.noValidation(dictMonad)
          }
      };
  };
  var _isNonEmpty = Data_Symbol.SProxy.value;
  var spec = function (dictMonadAff) {
      var toPaswdPolicy = function (conf) {
          return function (allowedSymbols) {
              var seed = Data_Array.uncons(Data_Array.catMaybes(Data_Functor.map(Data_Functor.functorArray)(Data_Switch.toMaybe)([ Data_Switch.toSwitch(conf.isUseDigit)(new Data_Tuple.Tuple(conf.numDigit, Data_Char_Gen.genDigitChar(Test_QuickCheck_Gen.monadGenGen))), Data_Switch.toSwitch(conf.isUseUpper)(new Data_Tuple.Tuple(conf.numUpper, Data_Char_Gen.genAlphaUppercase(Test_QuickCheck_Gen.monadGenGen))), Data_Switch.toSwitch(conf.isUseLower)(new Data_Tuple.Tuple(conf.numLower, Data_Char_Gen.genAlphaLowercase(Test_QuickCheck_Gen.monadGenGen))), Data_Switch.toSwitch(conf.isUseSymbol)(Data_Tuple.Tuple.create(conf.numSymbol)(Test_QuickCheck_Gen.elements(allowedSymbols))) ])));
              return Data_Functor.map(Data_Maybe.functorMaybe)(function ($109) {
                  return (function (v) {
                      return {
                          length: conf.length,
                          required: v
      ...
      var inputNumberForm = function (fieldType) {
          return function (hasErr) {
              return function (isUsed) {
                  return function (inp) {
                      return function (onInput) {
                          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "control", "is-expanded" ])) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Properties.id_(Data_Show.show(showFieldType)(fieldType)), Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "input", (function () {
                              if (hasErr) {
                                  return "is-danger";
                              };
                              return "";
                          })() ])), Halogen_HTML_Properties.value(inp), Halogen_HTML_Events.onValueInput(onInput), Halogen_HTML_Properties.step(DOM_HTML_Indexed_StepValue.Any.value), Halogen_HTML_Properties.max(Data_Int.toNumber(maxLength)), Halogen_HTML_Properties.min(Data_Int.toNumber(minLength)), Halogen_HTML_Properties.disabled(!isUsed) ]) ]);
                      };
                  };
              };
          };
      };
      var inputAddon = function (isUsed) {
          return function (onChecked) {
              return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "control" ])) ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "button", "checkbox" ])) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Properties.checked(isUsed), Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "mr1" ])), Halogen_HTML_Events.onChecked(onChecked) ]) ]) ]);
          };
      };
      var fieldLabelText = function (v) {
          if (v instanceof PasswdLength) {
              return "Length";
          };
          if (v instanceof DigitCharNum) {
              return "Numeral";
          };
          if (v instanceof AlphaUppercase) {
              return "Uppercase Alphabet";
          };
          if (v instanceof AlphaLowercaseNum) {
              return "Lowercase Alphabet";
          };
          if (v instanceof SymbolCharNum) {
              return "Symbol";
          };
          throw new Error("Failed pattern match at Mkpasswd.UI.Pages.Mkpasswd (line 471, column 20 - line 476, column 30): " + [ v.constructor.name ]);
      };
      var labelBlock = function (fieldType) {
          return Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"](Data_Show.show(showFieldType)(fieldType)), Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "label" ])) ])([ Halogen_HTML_Core.text(fieldLabelText(fieldType)) ]);
      };
      var handleAction = function (v) {
          if (v.value0 instanceof PasswdLength) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
          };
          if (v.value0 instanceof DigitCharNum) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)($$eval(Formless_Action.set(new Data_Symbol.IsSymbol(function () {
                  return "isUseDigit";
              }))(newtypeForm)()(_isUseDigit)(v.value1)))(function () {
                  return $$eval(Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                      return "isNonEmpty";
                  }))(newtypeForm)()(_isNonEmpty)(v.value1));
              });
          };
          if (v.value0 instanceof AlphaUppercase) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)($$eval(Formless_Action.set(new Data_Symbol.IsSymbol(function () {
                  return "isUseUpper";
              }))(newtypeForm)()(_isUseUpper)(v.value1)))(function () {
                  return $$eval(Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                      return "isNonEmpty";
                  }))(newtypeForm)()(_isNonEmpty)(v.value1));
              });
          };
          if (v.value0 instanceof AlphaLowercaseNum) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)($$eval(Formless_Action.set(new Data_Symbol.IsSymbol(function () {
                  return "isUseLower";
              }))(newtypeForm)()(_isUseLower)(v.value1)))(function () {
                  return $$eval(Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                      return "isNonEmpty";
                  }))(newtypeForm)()(_isNonEmpty)(v.value1));
              });
          };
          if (v.value0 instanceof SymbolCharNum) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)($$eval(Formless_Action.set(new Data_Symbol.IsSymbol(function () {
                  return "isUseSymbol";
              }))(newtypeForm)()(_isUseSymbol)(v.value1)))(function () {
                  return $$eval(Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                      return "isNonEmpty";
                  }))(newtypeForm)()(_isNonEmpty)(v.value1));
              });
          };
          throw new Error("Failed pattern match at Mkpasswd.UI.Pages.Mkpasswd (line 381, column 18 - line 394, column 43): " + [ v.constructor.name ]);
      };
      var $$eval = function (act) {
          return Formless_Component.handleAction(dictMonadAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              return "numUpper";
              ...
              return "isNonEmpty";
          }))(Formless_Types_Form.eqInputField(Data_Eq.eqBoolean)))(Formless_Internal_Transform.inputFieldsToFormFieldsCons(new Data_Symbol.IsSymbol(function () {
              return "isNonEmpty";
              ...
              return "isNonEmpty";
          }))((dictMonadAff.MonadEffect0()).Monad0())()(newtypeForm)()()(Formless_Internal_Transform.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
              return "isUseDigit";
          }))((dictMonadAff.MonadEffect0()).Monad0())()(newtypeForm)()()(Formless_Internal_Transform.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
              return "isUseLower";
          }))((dictMonadAff.MonadEffect0()).Monad0())()(newtypeForm)()()(Formless_Internal_Transform.applyToValidationCons(new Data_Symbol.IsSymbol(function () {
              ...
              return "numUpper";
          }))()(Formless_Internal_Transform.formFieldsToMaybeOutputNil)())())())())())())())())())())(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)()(handleAction)(Formless_Component.raiseResult(newtypeForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
              return "isNonEmpty";
      ...
      var handleQuery = function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)($$eval(Formless_Action.validateAll))(function () {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  return v1.form;
              }))(function (form) {
                  var conf = Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(function (v1) {
                      return function (v2) {
                          return function (v3) {
                              return function (v4) {
                                  return function (v5) {
                  ...
                  })(Formless_Retrieve.getOutput(new Data_Symbol.IsSymbol(function () {
                      return "length";
                  }))(newtypeForm)()(_length)(form)))(Formless_Retrieve.getOutput(new Data_Symbol.IsSymbol(function () {
                      return "isNonEmpty";
                  }))(newtypeForm)()(_isNonEmpty)(form)))(Formless_Retrieve.getOutput(new Data_Symbol.IsSymbol(function () {
                      return "numDigit";
                  }))(newtypeForm)()(_numDigit)(form)))(Formless_Retrieve.getOutput(new Data_Symbol.IsSymbol(function () {
                      return "isUseDigit";
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                      return "multichkboxes";
                  }))(Data_Ord.ordUnit)(_multichkboxes)(Data_Unit.unit)(Halogen_Query.request(Formless_Query.submitReply)))(function (mCharSet) {
                      var mAllowedSymbols = Data_Functor.map(Data_Maybe.functorMaybe)((function () {
                          var $110 = Formless_Transform_Record.unwrapOutputFields(Mkpasswd_UI_Components_MultiChkboxes.newtypeForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                              return "allowedSymbols";
                          }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.unwrapField(Formless_Types_Form.newtypeOutputField)))(Heterogeneous_Mapping.mapRecordWithIndexNil)()()));
                          return function ($111) {
                              return (function (v1) {
                                  return v1.allowedSymbols;
                              })($110($111));
                          };
                      })())(Control_Bind.join(Data_Maybe.bindMaybe)(mCharSet));
                      var policy = Control_Bind.join(Data_Maybe.bindMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(toPaswdPolicy)(conf))(mAllowedSymbols));
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Functor.map(Data_Maybe.functorMaybe)(v.value0)(policy));
                  });
              });
          });
      };
      var errorMsg = function (v) {
          ...
          if (v instanceof EmptyCharSet) {
              return "\u4f7f\u7528\u3059\u308b\u6587\u5b57\u3092\u6307\u5b9a\u3057\u3066\u304f\u3060\u3055\u3044";
          };
          if (v instanceof TooShort) {
              return "\u9577\u3055\u306f\u6587\u5b57\u7a2e\u3054\u3068\u306e\u5fc5\u8981\u6700\u4f4e\u6570\u306e\u7dcf\u548c\u3088\u308a\u3082\u5927\u304d\u304f\u3057\u3066\u304f\u3060\u3055\u3044";
          };
          throw new Error("Failed pattern match at Mkpasswd.UI.Pages.Mkpasswd (line 397, column 14 - line 402, column 48): " + [ v.constructor.name ]);
      };
      var errorDisplay = function (err) {
          return Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "help", "is-danger" ])) ])(Data_Functor.map(Data_Functor.functorArray)(function (msg) {
              return Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text(errorMsg(msg)) ]);
      ...
      var inputFormGroup = function (fieldType) {
          return function (err) {
              return function (isUsed) {
                  return function (inp) {
                      return function (onChecked) {
                          return function (onInput) {
                              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "field" ])) ])([ labelBlock(fieldType), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "field", "has-addons" ])) ])([ inputAddon(isUsed)(onChecked), inputNumberForm(fieldType)(Data_Maybe.isJust(err))(isUsed)(inp)(onInput) ]), errorDisplay(err) ]);
                          };
                      };
                  };
              };
      ...
      var render = function (fstate) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "container" ])) ])([ (function () {
              var err = Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
                  return "length";
              }))(newtypeForm)()(_length)(fstate.form);
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "field" ])) ])([ labelBlock(PasswdLength.value), inputNumberForm(PasswdLength.value)(Data_Maybe.isJust(err))(true)(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                  return "length";
              }))(newtypeForm)()(_length)(fstate.form))((function () {
                  var $112 = Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                      return "length";
                  }))(newtypeForm)()(_length);
                  return function ($113) {
                      return Data_Maybe.Just.create($112($113));
                  };
              })()), errorDisplay(err) ]);
          })(), inputFormGroup(DigitCharNum.value)(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
              return "numDigit";
          }))(newtypeForm)()(_numDigit)(fstate.form))(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "isUseDigit";
          }))(newtypeForm)()(_isUseDigit)(fstate.form))(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "numDigit";
          }))(newtypeForm)()(_numDigit)(fstate.form))((function () {
              var $114 = ToggleCharSetUse.create(DigitCharNum.value);
              return function ($115) {
                  return Data_Maybe.Just.create(Formless_Action.injAction($114($115)));
              };
          })())((function () {
              var $116 = Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                  return "numDigit";
              }))(newtypeForm)()(_numDigit);
              return function ($117) {
                  return Data_Maybe.Just.create($116($117));
              };
          })()), inputFormGroup(AlphaUppercase.value)(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
              return "numUpper";
          }))(newtypeForm)()(_numUpper)(fstate.form))(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "isUseUpper";
          }))(newtypeForm)()(_isUseUpper)(fstate.form))(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "numUpper";
          }))(newtypeForm)()(_numUpper)(fstate.form))((function () {
              var $118 = ToggleCharSetUse.create(AlphaUppercase.value);
              return function ($119) {
                  return Data_Maybe.Just.create(Formless_Action.injAction($118($119)));
              };
          })())((function () {
              var $120 = Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                  return "numUpper";
              }))(newtypeForm)()(_numUpper);
              return function ($121) {
                  return Data_Maybe.Just.create($120($121));
              };
          })()), inputFormGroup(AlphaLowercaseNum.value)(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
              return "numLower";
          }))(newtypeForm)()(_numLower)(fstate.form))(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "isUseLower";
          }))(newtypeForm)()(_isUseLower)(fstate.form))(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "numLower";
          }))(newtypeForm)()(_numLower)(fstate.form))((function () {
              var $122 = ToggleCharSetUse.create(AlphaLowercaseNum.value);
              return function ($123) {
                  return Data_Maybe.Just.create(Formless_Action.injAction($122($123)));
              };
          })())((function () {
              var $124 = Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                  return "numLower";
              }))(newtypeForm)()(_numLower);
              return function ($125) {
                  return Data_Maybe.Just.create($124($125));
              };
          })()), inputFormGroup(SymbolCharNum.value)(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
              return "numSymbol";
          }))(newtypeForm)()(_numSymbol)(fstate.form))(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "isUseSymbol";
          }))(newtypeForm)()(_isUseSymbol)(fstate.form))(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "numSymbol";
          }))(newtypeForm)()(_numSymbol)(fstate.form))((function () {
              var $126 = ToggleCharSetUse.create(SymbolCharNum.value);
              return function ($127) {
                  return Data_Maybe.Just.create(Formless_Action.injAction($126($127)));
              };
          })())((function () {
              var $128 = Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                  return "numSymbol";
              }))(newtypeForm)()(_numSymbol);
              return function ($129) {
                  return Data_Maybe.Just.create($128($129));
              };
          })()), errorDisplay(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
              return "isNonEmpty";
          }))(newtypeForm)()(_isNonEmpty)(fstate.form)), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "multichkboxes";
          }))(Data_Ord.ordUnit)(_multichkboxes)(Data_Unit.unit)(Mkpasswd_UI_Components_MultiChkboxes.component(dictMonadAff))(!Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
              return "isUseSymbol";
          }))(newtypeForm)()(_isUseSymbol)(fstate.form))(Data_Function["const"](Data_Maybe.Nothing.value)) ]);
      };
      return {
          render: render,
          handleAction: handleAction,
  ...
  var _headerNav = Data_Symbol.SProxy.value;
  var component = function (dictMonadAff) {
      var resultModal = function (mPasswd) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "modal", (function () {
              var $96 = Data_Maybe.isJust(mPasswd);
              if ($96) {
                  return "is-active";
              };
              return "";
          })() ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "modal-background" ])), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Clear.value);
          }) ])([  ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "modal-card" ])) ])([ Halogen_HTML_Elements.header([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "modal-card-head" ])) ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "modal-card-title" ])) ])([ Halogen_HTML_Core.text("Result") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "delete" ])), Halogen_HTML_Properties.attr("aria-label")("close"), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Clear.value);
          }) ])([  ]) ]), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "modal-card-body" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "level" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "level-item", "has-text-centered", "is-size-3", "text-wrap" ])) ])([ Halogen_HTML_Elements.br_, Halogen_HTML_Core.text(Data_Maybe.fromMaybe("")(mPasswd)), Halogen_HTML_Elements.br_ ]) ]) ]), Halogen_HTML_Elements.footer([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "modal-card-foot" ])) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "button", "is-dark" ])), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Save.value);
          }), Halogen_HTML_Properties.href(Mkpasswd_UI_Routing.routeHref(Mkpasswd_UI_Routing.New.value)) ])([ Halogen_HTML_Core.text("Save") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "button" ])), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(Generate.value);
          }) ])([ Halogen_HTML_Core.text("Regenerate") ]) ]) ]) ]);
      };
      ...
      var handleAction = function (v) {
          if (v instanceof Clear) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $98.passwd = Data_Maybe.Nothing.value;
                  return $98;
              });
          };
          if (v instanceof Generate) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                  return "formless";
              }))(Data_Ord.ordUnit)(Formless_Types_Component["_formless"])(Data_Unit.unit)(Formless_Query.injQuery(functorPasswdConfigQuery)(Halogen_Query.request(GetPasswdPolicy.create))))(function (mRes) {
                  if (mRes instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Mkpasswd.mkpasswd(mRes.value0)))(function (newPasswd) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              var $102 = {};
                              for (var $103 in v1) {
                  ...
                  throw new Error("Failed pattern match at Mkpasswd.UI.Pages.Mkpasswd (line 160, column 7 - line 164, column 29): " + [ mRes.constructor.name ]);
              });
          };
          if (v instanceof Save) {
              return Control_Bind.bindFlipped(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  return v1.passwd;
              }));
          };
          throw new Error("Failed pattern match at Mkpasswd.UI.Pages.Mkpasswd (line 155, column 18 - line 166, column 34): " + [ v.constructor.name ]);
      };
      var footerBtnArea = Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "level", "sticky-bottom", "box" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "level-item" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "field", "is-grouped" ])) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "control" ])) ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "button", "is-dark" ])), Halogen_HTML_Events.onClick(function (v) {
          return new Data_Maybe.Just(Generate.value);
      }) ])([ Halogen_HTML_Core.text("Generate") ]) ]) ]) ]) ]);
      var render = function (state) {
          return Halogen_HTML_Elements.main([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ (function () {
              var $106 = Data_Maybe.isJust(state.passwd);
              if ($106) {
                  return "is-clipped";
              };
              return "";
              ...
              return "headerNav";
          }))(Data_Ord.ordUnit)(_headerNav)(Data_Unit.unit)(Mkpasswd_UI_Components_HeaderNav.component)(Data_Unit.unit)(Data_Void.absurd), Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "section" ])) ])([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "formless";
          }))(Data_Ord.ordUnit)(Formless_Types_Component["_formless"])(Data_Unit.unit)(Formless_Component.component(dictMonadAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              return "numUpper";
          }))(Formless_Types_Form.eqInputField(Data_Eq.eqString)))()(new Data_Symbol.IsSymbol(function () {
              return "numSymbol";
          }))(Formless_Types_Form.eqInputField(Data_Eq.eqString)))()(new Data_Symbol.IsSymbol(function () {
              ...
              return "numUpper";
          }))(Formless_Class_Initial.initialString)()(Formless_Transform_Row.mkInputFieldsFromRowNil)())())())())())())())())())())(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)()()()()()()()()()(Data_Function["const"](formInput((dictMonadAff.MonadEffect0()).Monad0())))(spec(dictMonadAff)))(Data_Unit.unit)(Data_Function["const"](Data_Maybe.Nothing.value)) ]), footerBtnArea, resultModal(state.passwd) ]);
      };
      return Halogen_Component.mkComponent({
          initialState: initialState,
          render: render,
...
(function($PS) {
  ...
  var genericFieldType = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Mkpasswd.UI.Pages.Store (line 110, column 1 - line 110, column 56): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
  ...
  var spec = function (dictMonad) {
      return function (dictMonadAff) {
          var textAreaForm = function (fieldType) {
              return function (err) {
                  return function (inp) {
                      return function (onInput) {
                          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "control" ])) ])([ Halogen_HTML_Elements.textarea([ Halogen_HTML_Properties.id_(Data_Show.show(showFieldType)(fieldType)), Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "textarea", (function () {
                              var $23 = Data_Maybe.isJust(err);
                              if ($23) {
                                  return "is-danger";
                              };
                              return "";
                          })() ])), Halogen_HTML_Properties.value(inp), Halogen_HTML_Events.onValueInput(onInput) ]) ]);
                      };
                  };
              };
          };
          var labelBlock = function (fieldType) {
              return function (labelTxt) {
                  return Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"](Data_Show.show(showFieldType)(fieldType)), Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "label" ])) ])([ Halogen_HTML_Core.text(labelTxt) ]);
              };
          };
          var inputTextForm = function (fieldType) {
              return function (err) {
                  return function (inp) {
                      return function (onInput) {
                          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "control" ])) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.id_(Data_Show.show(showFieldType)(fieldType)), Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "input", (function () {
                              var $24 = Data_Maybe.isJust(err);
                              if ($24) {
                                  return "is-danger";
                              };
                              return "";
          ...
          var errorMsg = function (v) {
              ...
              throw new Error("Failed pattern match at Mkpasswd.UI.Pages.Store (line 129, column 14 - line 131, column 31): " + [ v.constructor.name ]);
          };
          var errorDisplay = function (err) {
              return Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "help", "is-danger" ])) ])(Data_Functor.map(Data_Functor.functorArray)(function (msg) {
                  return Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text(errorMsg(msg)) ]);
          ...
          var render = function (fstate) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "container" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "field" ])) ])([ labelBlock(AccountInput.value)("Title"), inputTextForm(AccountInput.value)(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
                  return "account";
              }))(newtypeForm)()(Data_Symbol.SProxy.value)(fstate.form))(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                  return "account";
              }))(newtypeForm)()(Data_Symbol.SProxy.value)(fstate.form))((function () {
                  var $33 = Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                      return "account";
                  }))(newtypeForm)()(Data_Symbol.SProxy.value);
                  return function ($34) {
                      return Data_Maybe.Just.create($33($34));
                  };
              })()), errorDisplay(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
                  return "account";
              }))(newtypeForm)()(Data_Symbol.SProxy.value)(fstate.form)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "field" ])) ])([ labelBlock(Passwdinput.value)("The Work"), inputTextForm(Passwdinput.value)(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
                  return "passwd";
              }))(newtypeForm)()(Data_Symbol.SProxy.value)(fstate.form))(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                  return "passwd";
              }))(newtypeForm)()(Data_Symbol.SProxy.value)(fstate.form))((function () {
                  var $35 = Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                      return "passwd";
                  }))(newtypeForm)()(Data_Symbol.SProxy.value);
                  return function ($36) {
                      return Data_Maybe.Just.create($35($36));
                  };
              })()), errorDisplay(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
                  return "passwd";
              }))(newtypeForm)()(Data_Symbol.SProxy.value)(fstate.form)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "field" ])) ])([ labelBlock(NoteTextarea.value)("Description"), textAreaForm(NoteTextarea.value)(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
                  return "note";
              }))(newtypeForm)()(Data_Symbol.SProxy.value)(fstate.form))(Formless_Retrieve.getInput(new Data_Symbol.IsSymbol(function () {
                  return "note";
              }))(newtypeForm)()(Data_Symbol.SProxy.value)(fstate.form))((function () {
                  var $37 = Formless_Action.setValidate(new Data_Symbol.IsSymbol(function () {
                      return "note";
                  }))(newtypeForm)()(Data_Symbol.SProxy.value);
                  return function ($38) {
                      return Data_Maybe.Just.create($37($38));
                  };
              })()), errorDisplay(Formless_Retrieve.getError(new Data_Symbol.IsSymbol(function () {
                  return "note";
              }))(newtypeForm)()(Data_Symbol.SProxy.value)(fstate.form)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "field", "is-grouped" ])) ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "control" ])) ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "button", "is-dark" ])), Halogen_HTML_Events.onClick(function (v) {
                  return new Data_Maybe.Just(Formless_Action.submit);
              }) ])([ Halogen_HTML_Core.text("Save") ]) ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "control" ])) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "button" ])), Halogen_HTML_Properties.href(Mkpasswd_UI_Routing.routeHref(Mkpasswd_UI_Routing.List.value)) ])([ Halogen_HTML_Core.text("Cancel") ]) ]) ]) ]);
          };
          return {
              render: render,
  ...
  var formInput = function (dictMonad) {
      return function (fd) {
          ...
          var isNonEmpty = Formless_Validation.hoistFnE_(dictMonad)(chk(ValueMissing.value)(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraFunction(Data_HeytingAlgebra.heytingAlgebraBoolean))(Data_String_Common["null"])));
          var isUnder100 = Formless_Validation.hoistFnE_(dictMonad)(function (v) {
              return Control_Apply.applySecond(Data_Either.applyEither)(chk(OutOfRange.value)(function (v1) {
                  return v1 <= 100;
              })(Data_String_CodePoints.length(v)))(Control_Applicative.pure(Data_Either.applicativeEither)(v));
          });
          var isUnder1000 = Formless_Validation.hoistFnE_(dictMonad)(function (v) {
              return Control_Apply.applySecond(Data_Either.applyEither)(chk(OutOfRange.value)(function (v1) {
                  return v1 <= 1000;
              })(Data_String_CodePoints.length(v)))(Control_Applicative.pure(Data_Either.applicativeEither)(v));
          });
          return {
              initialInputs: Data_Functor.map(Data_Maybe.functorMaybe)(Formless_Transform_Record.wrapInputFields(newtypeForm)(Heterogeneous_Mapping.hmapRecord()(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                  return "account";
              }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.wrapField(Formless_Types_Form.newtypeInputField)))(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                  return "note";
              }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.wrapField(Formless_Types_Form.newtypeInputField)))(Heterogeneous_Mapping.mapRecordWithIndexCons(new Data_Symbol.IsSymbol(function () {
                  return "passwd";
              }))(Heterogeneous_Mapping.constMapping(Formless_Transform_Record.wrapField(Formless_Types_Form.newtypeInputField)))(Heterogeneous_Mapping.mapRecordWithIndexNil)()())()())()())))(fd),
              validators: {
                  account: Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation(dictMonad))(isNonEmpty)(isUnder100),
                  passwd: Control_Semigroupoid.composeFlipped(Formless_Validation.semigroupoidValidation(dictMonad))(isNonEmpty)(isUnder100),
                  note: isUnder1000
              }
          };
      };
  ...
  var component = function (dictMonadAff) {
      var render = function (state) {
          return Halogen_HTML_Elements.main_([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              ...
              return "formless";
          }))(Data_Ord.ordUnit)(Formless_Types_Component["_formless"])(Data_Unit.unit)(Formless_Component.component(dictMonadAff)()()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
              return "passwd";
          }))(Formless_Types_Form.eqInputField(Data_Eq.eqString)))()(new Data_Symbol.IsSymbol(function () {
              return "note";
          }))(Formless_Types_Form.eqInputField(Data_Eq.eqString)))()(new Data_Symbol.IsSymbol(function () {
              ...
              return "passwd";
          }))(Formless_Class_Initial.initialString)()(Formless_Transform_Row.mkInputFieldsFromRowNil)())())())(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)(newtypeForm)()()()()()()()()()(formInput((dictMonadAff.MonadEffect0()).Monad0()))(spec((dictMonadAff.MonadEffect0()).Monad0())(dictMonadAff)))(state)(function ($39) {
              return Data_Maybe.Just.create(HandleFormless.create($39));
          }) ]) ]);
      };
      var initialState = Control_Category.identity(Control_Category.categoryFn);
      var handleAction = function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Routing_Hash.setHash(Mkpasswd_UI_Routing.routeHref(Mkpasswd_UI_Routing.List.value))))(function () {
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Mkpasswd.UI"] = $PS["Mkpasswd.UI"] || {};
  var exports = $PS["Mkpasswd.UI"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Array = $PS["Data.Array"];
  ...
  var Mkpasswd = (function () {
      function Mkpasswd(value0) {
          this.value0 = value0;
      };
      Mkpasswd.create = function (value0) {
          return new Mkpasswd(value0);
      };
      return Mkpasswd;
  })();
  var _storePage = Data_Symbol.SProxy.value;
  var _listPage = Data_Symbol.SProxy.value;
  var _indexPage = Data_Symbol.SProxy.value;
  var component = function (dictMonadAff) {
      var render = function (v) {
          if (v.route instanceof Mkpasswd_UI_Routing.Index) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "indexPage";
              }))(Data_Ord.ordUnit)(_indexPage)(Data_Unit.unit)(Mkpasswd_UI_Pages_Mkpasswd.component(dictMonadAff))(Data_Unit.unit)(function ($56) {
                  return Data_Maybe.Just.create(Mkpasswd.create($56));
              });
          };
          if (v.route instanceof Mkpasswd_UI_Routing.List) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "listPage";
              }))(Data_Ord.ordUnit)(_listPage)(Data_Unit.unit)(Mkpasswd_UI_Pages_List.component(dictMonadAff.MonadEffect0()))(v.storage)(function ($57) {
                  return Data_Maybe.Just.create(Delete.create($57));
              });
          };
          if (v.route instanceof Mkpasswd_UI_Routing.New) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "storePage";
              }))(Data_Ord.ordUnit)(_storePage)(Data_Unit.unit)(Mkpasswd_UI_Pages_Store.component(dictMonadAff))(Data_Functor.map(Data_Maybe.functorMaybe)(function (v1) {
                  return {
                      passwd: v1,
                      account: Mkpasswd_Data_States.initialForm.account,
                      note: Mkpasswd_Data_States.initialForm.note
                  };
              })(v.passwd))(function ($58) {
                  return Data_Maybe.Just.create(Save.create($58));
              });
          };
          if (v.route instanceof Mkpasswd_UI_Routing.Store) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "storePage";
              }))(Data_Ord.ordUnit)(_storePage)(Data_Unit.unit)(Mkpasswd_UI_Pages_Store.component(dictMonadAff))(Data_Array.index(v.storage)(v.route.value0))(function ($59) {
                  return Data_Maybe.Just.create(Save.create($59));
              });
          };
          throw new Error("Failed pattern match at Mkpasswd.UI (line 75, column 39 - line 79, column 90): " + [ v.route.constructor.name ]);
      };
      var initialState = function (v) {
          return {
      ...
      var handleQuery = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Mkpasswd_UI_Routing.eqRouteHash)(mRoute)(v.value0))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  var $24 = {};
                  for (var $25 in v1) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.eq(Mkpasswd_UI_Routing.eqRouteHash)(v.value0)(Mkpasswd_UI_Routing.List.value))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $27.passwd = Data_Maybe.Nothing.value;
                      return $27;
                  })))(function () {
      ...
      var handleAction = function (v) {
          if (v instanceof Load) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Storage.fetch(Simple_JSON.readArray(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                  return "account";
              }))(Simple_JSON.readString)(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                  return "note";
              }))(Simple_JSON.readString)(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                  return "passwd";
              }))(Simple_JSON.readString)(Simple_JSON.readFieldsNil)()())()())()())))("mkpasswd")))(function (ns) {
                  if (ns instanceof Data_Either.Right) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          var $34 = {};
                          for (var $35 in v1) {
                          ...
                          $34.storage = ns.value0;
                          return $34;
                      });
                  };
                  if (ns instanceof Data_Either.Left) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          var $38 = {};
                          for (var $39 in v1) {
                              if ({}.hasOwnProperty.call(v1, $39)) {
                          ...
                          $38.error = Data_List_Types.toList(ns.value0);
                          return $38;
                      });
                  };
                  throw new Error("Failed pattern match at Mkpasswd.UI (line 88, column 7 - line 90, column 53): " + [ ns.constructor.name ]);
              });
          };
          ...
          if (v instanceof Save) {
              var forcusIdx = function (v1) {
                  if (v1 instanceof Mkpasswd_UI_Routing.Store) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (s) {
                  var st = Data_Maybe.fromMaybe(Data_Array.snoc(s.storage)(v.value0))(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(function (i) {
                      return Data_Array.updateAt(i)(v.value0)(s.storage);
                  })(forcusIdx(s.route)));
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $48 = {};
                      for (var $49 in v1) {
                      ...
                      return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Storage.save(Simple_JSON.writeForeignArray(Simple_JSON.recordWriteForeign()(Simple_JSON.consWriteForeignFields(new Data_Symbol.IsSymbol(function () {
                          return "account";
                      }))(Simple_JSON.writeForeignString)(Simple_JSON.consWriteForeignFields(new Data_Symbol.IsSymbol(function () {
                          return "note";
                      }))(Simple_JSON.writeForeignString)(Simple_JSON.consWriteForeignFields(new Data_Symbol.IsSymbol(function () {
                          return "passwd";
                      }))(Simple_JSON.writeForeignString)(Simple_JSON.nilWriteForeignFields)()()())()()())()()())))("mkpasswd")(st));
                  });
              });
          };
          if (v instanceof Delete) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (s) {
                  var newSt = Data_Array.deleteAt(v.value0)(s.storage);
                  return Data_Maybe.maybe(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit))(function (st) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          var $52 = {};
                          for (var $53 in v1) {
          ...
          throw new Error("Failed pattern match at Mkpasswd.UI (line 85, column 18 - line 111, column 41): " + [ v.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
          initialState: initialState,
          render: render,
...
(function($PS) {
  ...
  var Mkpasswd_UI = $PS["Mkpasswd.UI"];
  var Mkpasswd_UI_Routing = $PS["Mkpasswd.UI.Routing"];                
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Mkpasswd_UI.component(Effect_Aff_Class.monadAffAff))(Data_Unit.unit)(body))(function (app) {
          return Mkpasswd_UI_Routing.routing(app.query)(Mkpasswd_UI.ChangeHash.create);
      });
  }));
  exports["main"] = main;
})(PS);
